...
|---|---|---:|---:|---:|---:|---|
| [`macbook-air-m1/`](macbook-air-m1/human-readable/REPORT.md) | Apple M1 · 8 cores · 16 GB | 8 | **49.62B** | 15.28B | 20.08B | 2026-08-14 |
| [`hp-laptop-linux/`](hp-laptop-linux/human-readable/REPORT.md) | x86_64 · 12 cores · 62.5 GB | 15 | **32.41B** | 8.76B | 15.03B | 2026-08-15 |
| [`dell-latitude-7480-linux/`](dell-latitude-7480-linux/human-readable/REPORT.md) | x86_64 · 4 cores · 31 GB | 10 | **31.76B** | 1.97B | 6.44B | 2026-08-21 |
| [`asus-laptop-linux/`](asus-laptop-linux/human-readable/REPORT.md) | x86_64 · 8 cores · 31.3 GB | 2 | **287.85M** | 133.20M | 133.20M | 2026-08-21 |
| [`dell-inspiron-desktop-linux/`](dell-inspiron-desktop-linux/human-readable/REPORT.md) | x86_64 · 4 cores · 11.6 GB | 2 | **51.96M** | 824.89K | 14.93M | 2026-08-21 |
| `dell-latitude-7480-windows/` | — | — | — | — | — | ❌ never |
| **All computers** | | | **114.13B** | **26.14B** | | |
...
The append-only token ledgers stand behind **59.34B** across the fleet, of which **17.64B** is usage no scan can still see, because the transcripts behind it have been deleted. `LIFETIME.md` counts it; the columns above do not.

_5 of 6 computers scanned; generated by `combine.py` 2026-08-22. Do not edit by hand._
<!-- END OVERVIEW -->
...
|---|---:|---:|---|
| broodierchip@gmail.com | 12.58B | 48.1% | 4 |
| codehunterextreme@gmail.com | 10.78B | 41.3% | 3 |
| alexander.sorrell.it@gmail.com | 2.24B | 8.6% | 3 |
| DeepSeek backend (~/.my-claude) | 520.50M | 2.0% | 1 |
| unknown (Documents) | 10.01M | 0.0% | 1 |
| user:2d4777822844 | 3.49M | 0.0% | 1 |
| API key (org 15a93e14-aabb-4293-8228-8c56a803d972) | 141.21K | 0.0% | 1 |
| user:283b8e5b8e48 | 0 | 0.0% | 1 |

_8 account(s) across 5 scanned computer(s), 26.14B total. Generated by `combine.py`. Do not edit by hand._
<!-- END ACCOUNTS -->
...
| by CLI | | | by company | |
|---|---:|---|---|---:|
| claude | 33.81B | | anthropic | 33.67B |
| gemini | 2.78B | | google | 3.02B |
| codex | 2.31B | | openai | 2.60B |
| copilot | 1.86B | | synthetic | 1.41B |
| bob | 348.40M | | deepseek | 543.65M |
| clawspring | 258.50M | | - | 348.40M |
| antigravity | 224.33M | | xai | 100.23M |
| grok | 100.22M | | copilot | 1.22M |
| kilocode | 7.07M | | mistral | 116.19K |
| copilot-chat | 1.22M | | other | 91.89K |
| lmstudio | 172.93K | | meta | 59 |
| claude-orphans | 0 | | | |

_Generated by `combine.py` from 5 scanned machine(s); 41.70B across 12 CLI(s). Do not edit by hand._
<!-- END CLI -->
