...
_Generated 2026-08-12T18:58:32-05:00 by `stats_page.py`. Do not edit by hand._

**14,817,998,601** tokens of Claude Code across 1 scanned computer(s) · **19,594,450,736** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-12 03:46:33_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 14,817,998,601 | 100.0% | 2026-08-12 03:46:33 |
| **All** | | | **14,817,998,601** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   14,817,998,601
Claude Code, per session (sessions.json):   15,993,250,166
difference                              :   -1,175,251,565
non-Claude-Code CLIs, additional        :    3,601,200,570
```

**These should agree and differ by 1,175,251,565.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

scanned **2026-08-12 03:46:33** · sessions 2026-08-12 03:52:58

`macbook-air-m1/` · 8 account(s) · 4,482 sessions · 64,724 turns · **14,817,998,601 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 9,257,591,144 | 62.5% |
| codehunterextreme@gmail.com | 5,306,443,374 | 35.8% |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 63 | 14,818,825,189 | 2026-05-26 → 2026-08-12 |
...
| xAI Grok CLI | cli | yes | 7 | 99,062,873 | 2026-07-21 → 2026-08-08 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 19,594,397,577 of the 19,594,450,736 total was billed to someone.

---

## The floor: the most defensible figure per machine

**49,129,681,020 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 45,528,480,450 | 3,601,200,570 | **49,129,681,020** | 19,594,450,736 |
| **All** | | | **49,129,681,020** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 6,775,080,845 | 35,608,271,209 |
| codehunterextreme@gmail.com | 6,946,344,675 | 2026-07-30 | 2,392,095,897 | 9,338,440,572 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 9,257,591,144 |
| `.claude` | codehunterextreme@gmail.com | 6,946,344,675 | 2026-05-26 → 2026-07-30 | 5,306,443,374 |
...
**241 Claude Code sessions have existed across the scanned machines. 163 of them — 68% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| broodierchip@gmail.com | 174 | 125 | 2026-05-26 → 2026-08-12 |
| codehunterextreme@gmail.com | 61 | 36 | 2026-02-11 → 2026-08-12 |
...
|---|---|---|
| MacBook Air M1 | 14.82B | **14,817,998,601** |
| **All** | **14.82B** | **14,817,998,601** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 15.99B | 1.63B | 995.36M | 497.70M | 240.31M | 135.11M | 99.06M | 53.16K | — | — | — | — | **19,594,450,736** |
| **All** | **15.99B** | **1.63B** | **995.36M** | **497.70M** | **240.31M** | **135.11M** | **99.06M** | **53.16K** | **0** | **0** | **0** | **0** | **19,594,450,736** |

---

## Sessions

296 sessions · 622h 27m active · 19,594,450,736 tokens
...
**The 15 minutes is a judgement call.** On the 292 session(s) measured both ways, counting only gaps under one minute gives **272h 05m** against **622h 27m**. The 350h 23m between is where reading output and walking away look identical. Read it as a range. The other 4 predate this and are counted only at fifteen minutes.
...
| 2026-08-08 | MacBook Air M1 | claude | 34h 32m | 1,316,174,192 | 5,872 | `claude-opus-5` |
...
| 2026-08-08 | 1,329,510,602 | 35h 25m |
