...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 15,251,673,339 | 100.0% | ████████████████████████████ |
...
|---|---:|---:|---:|---|
| Anthropic | 100 | 536h 44m | 16,864,152,791 | claude 16.43B, copilot 437.66M |
...
**15,251,673,339 tokens** (100.0% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 8,920,301,426 |
| `claude-opus-4-8` | 5,449,117,719 |
...
| Computer | Tokens |
|---|---:|
| MacBook Air M1 | 15,251,673,339 |

| Account | Tokens |
|---|---:|
| broodierchip@gmail.com | 9,686,425,191 |
...
**15,251,673,339 tokens** from 1 company(s)
