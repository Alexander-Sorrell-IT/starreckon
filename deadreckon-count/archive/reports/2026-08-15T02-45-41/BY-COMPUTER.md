...
_Generated 2026-08-15T02:45:40-05:00 by `stats_page.py`. Do not edit by hand._

**15,394,215,401** tokens of Claude Code across 1 scanned computer(s) · **20,204,454,646** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-15 02:37:42_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 15,394,215,401 | 100.0% | 2026-08-15 02:37:42 |
| **All** | | | **15,394,215,401** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   15,394,215,401
Claude Code, per session (sessions.json):   16,569,787,961
difference                              :   -1,175,572,560
non-Claude-Code CLIs, additional        :    3,634,666,685
```

**These should agree and differ by 1,175,572,560.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

scanned **2026-08-15 02:37:42** · sessions 2026-08-15 02:44:46

`macbook-air-m1/` · 8 account(s) · 4,482 sessions · 65,973 turns · **15,394,215,401 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 9,818,952,339 | 63.8% |
| codehunterextreme@gmail.com | 5,321,298,979 | 34.6% |
...
|---|---:|---:|
| Anthropic | 15,394,215,401 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 82 | 498h 54m | 16,569,787,961 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 63 | 15,395,362,984 | 2026-05-26 → 2026-08-15 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 20,204,401,487 of the 20,204,454,646 total was billed to someone.

---

## The floor: the most defensible figure per machine

**49,739,363,935 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 46,104,697,250 | 3,634,666,685 | **49,739,363,935** | 20,204,454,646 |
| **All** | | | **49,739,363,935** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 7,336,442,040 | 36,169,632,404 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 9,818,952,339 |
...
|---|---:|---:|---|
| broodierchip@gmail.com | 174 | 125 | 2026-05-26 → 2026-08-15 |
...
|---|---|---|
| MacBook Air M1 | 15.39B | **15,394,215,401** |
| **All** | **15.39B** | **15,394,215,401** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 16.57B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **20,204,454,646** |
| **All** | **16.57B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **20,204,454,646** |

---

## Sessions

298 sessions · 641h 50m active · 20,204,454,646 tokens
...
| 2026-08-08 | MacBook Air M1 | claude | 48h 28m | 1,762,076,216 | 6,757 | `claude-opus-5` |
...
| 2026-08-08 | 1,892,352,241 | 53h 40m |
