...
_Generated 2026-08-15T09:34:14-05:00 by `stats_page.py`. Do not edit by hand._

**15,520,438,308** tokens of Claude Code across 1 scanned computer(s) · **20,329,529,970** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-15 09:28:21_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 15,520,438,308 | 100.0% | 2026-08-15 09:28:21 |
| **All** | | | **15,520,438,308** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   15,520,438,308
Claude Code, per session (sessions.json):   16,694,863,285
...
scanned **2026-08-15 09:28:21** · sessions 2026-08-15 09:33:21

`macbook-air-m1/` · 8 account(s) · 4,483 sessions · 66,159 turns · **15,520,438,308 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 9,945,175,246 | 64.1% |
| codehunterextreme@gmail.com | 5,321,298,979 | 34.3% |
...
|---|---:|---:|
| Anthropic | 15,520,438,308 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 83 | 501h 51m | 16,694,863,285 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 64 | 15,520,438,308 | 2026-05-26 → 2026-08-15 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 20,329,476,811 of the 20,329,529,970 total was billed to someone.

---

## The floor: the most defensible figure per machine

**49,865,586,842 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 46,230,920,157 | 3,634,666,685 | **49,865,586,842** | 20,329,529,970 |
| **All** | | | **49,865,586,842** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 7,462,664,947 | 36,295,855,311 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 9,945,175,246 |
...
**242 Claude Code sessions have existed across the scanned machines. 163 of them — 67% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| broodierchip@gmail.com | 175 | 125 | 2026-05-26 → 2026-08-15 |
...
|---|---|---|
| MacBook Air M1 | 15.52B | **15,520,438,308** |
| **All** | **15.52B** | **15,520,438,308** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 16.69B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **20,329,529,970** |
| **All** | **16.69B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **20,329,529,970** |

---

## Sessions

299 sessions · 644h 46m active · 20,329,529,970 tokens
...
**The 15 minutes is a judgement call.** On the 294 session(s) measured both ways, counting only gaps under one minute gives **280h 39m** against **644h 46m**. The 364h 07m between is where reading output and walking away look identical. Read it as a range. The other 5 predate this and are counted only at fifteen minutes.
...
| 2026-08-08 | MacBook Air M1 | claude | 50h 54m | 1,874,041,772 | 6,914 | `claude-opus-5` |
...
| 2026-08-08 | 2,017,220,462 | 56h 36m |
