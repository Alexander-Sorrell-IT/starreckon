...
_Generated 2026-08-15T15:54:08-05:00 by `stats_page.py`. Do not edit by hand._

**15,641,987,270** tokens of Claude Code across 1 scanned computer(s) · **20,452,406,764** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-15 15:45:05_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 15,641,987,270 | 100.0% | 2026-08-15 15:45:05 |
| **All** | | | **15,641,987,270** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   15,641,987,270
Claude Code, per session (sessions.json):   16,817,740,079
difference                              :   -1,175,752,809
non-Claude-Code CLIs, additional        :    3,634,666,685
```

**These should agree and differ by 1,175,752,809.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

scanned **2026-08-15 15:45:05** · sessions 2026-08-15 15:50:24

`macbook-air-m1/` · 8 account(s) · 4,485 sessions · 66,725 turns · **15,641,987,270 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 10,066,724,208 | 64.4% |
| codehunterextreme@gmail.com | 5,321,298,979 | 34.0% |
...
|---|---:|---:|
| Anthropic | 15,641,987,270 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 84 | 505h 24m | 16,817,740,079 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 65 | 15,643,315,102 | 2026-05-26 → 2026-08-15 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 20,452,353,605 of the 20,452,406,764 total was billed to someone.

---

## The floor: the most defensible figure per machine

**49,987,135,804 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 46,352,469,119 | 3,634,666,685 | **49,987,135,804** | 20,452,406,764 |
| **All** | | | **49,987,135,804** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 7,584,213,909 | 36,417,404,273 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 10,066,724,208 |
...
|---|---:|---:|---|
| broodierchip@gmail.com | 176 | 125 | 2026-05-26 → 2026-08-15 |
...
|---|---|---|
| MacBook Air M1 | 15.64B | **15,641,987,270** |
| **All** | **15.64B** | **15,641,987,270** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 16.82B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **20,452,406,764** |
| **All** | **16.82B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **20,452,406,764** |

---

## Sessions

300 sessions · 648h 19m active · 20,452,406,764 tokens
...
| 2026-08-08 | MacBook Air M1 | claude | 53h 39m | 1,954,049,785 | 7,113 | `claude-opus-5` |
...
| 2026-08-08 | 2,097,831,658 | 59h 22m |
