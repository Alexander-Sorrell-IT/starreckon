...
**50,531,994,621 tokens** · 281 sessions · 103,903 turns · 27d 12h 15m
...
| | tokens | share |
|---|---:|---:|
| MacBook Air M1 | 50,531,994,621 | 100.0% |

## By model

| | tokens | share |
|---|---:|---:|
| claude-opus-5 | 10,054,332,418 |  19.9% |
...
**19,792,305,807 tokens** · 281 sessions · 103,903 turns · 27d 12h 15m

_2025-07-03 .. 2026-08-16_

| CLI | tokens | share |
|---|---:|---:|
| claude | 16,157,639,122 |  81.6% |
...
**19,792,305,807** of the headline is on disk now. **29,206,965** is not on disk: it is work whose transcripts have been deleted, held only by the append-only `token_ledger.jsonl` in each machine folder. The session and turn counts above cover the scanned part only — a vanished session is one row of arithmetic, not a session anyone can still open — and no month below includes any of it, because a vanished session's last observation may carry no date.

| computer | scanned | ledger | beyond the scan | ledger file |
|---|---:|---:|---:|---|
| MacBook Air M1 | 20,966,730,784 | 20,995,937,749 | +29,206,965 | yes |
...
| | tokens | share |
|---|---:|---:|
| re-read from cache | 15,612,303,985 |  96.6% |
| written to cache | 469,987,992 |   2.9% |
| sent fresh | 4,275,109 |   0.0% |
| **generated** | 71,072,036 |   0.4% |
