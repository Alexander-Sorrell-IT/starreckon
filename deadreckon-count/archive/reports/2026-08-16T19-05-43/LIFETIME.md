...
**50,773,964,189 tokens** · 281 sessions · 104,690 turns · 27d 18h 44m
...
| | tokens | share |
|---|---:|---:|
| MacBook Air M1 | 50,773,964,189 | 100.0% |

## By model

| | tokens | share |
|---|---:|---:|
| claude-opus-5 | 10,296,301,986 |  20.3% |
| claude-opus-4-8 | 5,363,938,900 |  10.6% |
...
**20,034,275,375 tokens** · 281 sessions · 104,690 turns · 27d 18h 44m

_2025-07-03 .. 2026-08-16_

| CLI | tokens | share |
|---|---:|---:|
| claude | 16,399,608,690 |  81.9% |
| codex | 1,633,604,881 |   8.2% |
| gemini | 995,360,683 |   5.0% |
...
**20,034,275,375** of the headline is on disk now. **29,206,965** is not on disk: it is work whose transcripts have been deleted, held only by the append-only `token_ledger.jsonl` in each machine folder. The session and turn counts above cover the scanned part only — a vanished session is one row of arithmetic, not a session anyone can still open — and no month below includes any of it, because a vanished session's last observation may carry no date.

| computer | scanned | ledger | beyond the scan | ledger file |
|---|---:|---:|---:|---|
| MacBook Air M1 | 21,208,700,352 | 21,019,923,242 | +29,206,965 | yes |
