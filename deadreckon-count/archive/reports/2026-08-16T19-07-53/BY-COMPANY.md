...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 16,399,608,690 | 100.0% | ████████████████████████████ |
...
|---|---:|---:|---:|---|
| Anthropic | 107 | 566h 22m | 18,011,697,214 | claude 17.57B, copilot 437.66M |
...
**16,399,608,690 tokens** (100.0% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 10,061,927,252 |
...
| Computer | Tokens |
|---|---:|
| MacBook Air M1 | 16,399,608,690 |

| Account | Tokens |
|---|---:|
| broodierchip@gmail.com | 10,824,345,628 |
...
**16,399,608,690 tokens** from 1 company(s)
