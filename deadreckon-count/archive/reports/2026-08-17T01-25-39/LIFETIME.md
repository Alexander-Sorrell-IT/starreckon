...
**50,968,248,902 tokens** · 281 sessions · 105,295 turns · 28d 0h 34m
...
| | tokens | share |
|---|---:|---:|
| MacBook Air M1 | 50,968,248,902 | 100.0% |

## By model

| | tokens | share |
|---|---:|---:|
| claude-opus-5 | 10,490,586,699 |  20.6% |
...
**20,228,560,088 tokens** · 281 sessions · 105,295 turns · 28d 0h 34m

_2025-07-03 .. 2026-08-17_

| CLI | tokens | share |
|---|---:|---:|
| claude | 16,593,893,403 |  82.0% |
| codex | 1,633,604,881 |   8.1% |
...
**20,228,560,088** of the headline is on disk now. **29,206,965** is not on disk: it is work whose transcripts have been deleted, held only by the append-only `token_ledger.jsonl` in each machine folder. The session and turn counts above cover the scanned part only — a vanished session is one row of arithmetic, not a session anyone can still open — and no month below includes any of it, because a vanished session's last observation may carry no date.

| computer | scanned | ledger | beyond the scan | ledger file |
|---|---:|---:|---:|---|
| MacBook Air M1 | 21,402,985,065 | 21,237,907,317 | +29,206,965 | yes |
...
| | tokens | share |
|---|---:|---:|
| re-read from cache | 16,038,690,125 |  96.7% |
| written to cache | 478,487,423 |   2.9% |
| sent fresh | 4,287,109 |   0.0% |
| **generated** | 72,428,746 |   0.4% |
