...
_Generated 2026-08-17T01:27:44-05:00 by `stats_page.py`. Do not edit by hand._

**16,593,893,403** tokens of Claude Code across 1 scanned computer(s) · **21,402,985,065** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-17 01:18:13_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 16,593,893,403 | 100.0% | 2026-08-17 01:18:13 |
| **All** | | | **16,593,893,403** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   16,593,893,403
Claude Code, per session (sessions.json):   17,768,318,380
...
scanned **2026-08-17 01:18:13** · sessions 2026-08-17 01:24:37

`macbook-air-m1/` · 8 account(s) · 4,486 sessions · 69,585 turns · **16,593,893,403 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 11,018,630,341 | 66.4% |
| codehunterextreme@gmail.com | 5,321,298,979 | 32.1% |
...
|---|---:|---:|
| Anthropic | 16,593,893,403 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 84 | 529h 39m | 17,768,318,380 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 65 | 16,593,893,403 | 2026-05-26 → 2026-08-17 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 21,402,931,906 of the 21,402,985,065 total was billed to someone.

---

## The floor: the most defensible figure per machine

**50,939,041,937 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 47,304,375,252 | 3,634,666,685 | **50,939,041,937** | 21,402,985,065 |
| **All** | | | **50,939,041,937** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 8,536,120,042 | 37,369,310,406 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 11,018,630,341 |
...
**244 Claude Code sessions have existed across the scanned machines. 164 of them — 67% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| broodierchip@gmail.com | 176 | 125 | 2026-05-26 → 2026-08-17 |
...
|---|---|---|
| MacBook Air M1 | 16.59B | **16,593,893,403** |
| **All** | **16.59B** | **16,593,893,403** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 17.77B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **21,402,985,065** |
| **All** | **17.77B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **21,402,985,065** |

---

## Sessions

300 sessions · 672h 34m active · 21,402,985,065 tokens
...
| 2026-08-08 | MacBook Air M1 | claude | 8h 42m | 261,988,333 | 593 | `claude-opus-5` |
...
| 2026-08-08 | 2,928,168,980 | 79h 37m |
