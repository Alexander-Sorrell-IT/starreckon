...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 16,752,983,518 | 100.0% | ████████████████████████████ |
...
|---|---:|---:|---:|---|
| Anthropic | 107 | 576h 09m | 18,367,333,024 | claude 17.93B, copilot 437.66M |
...
**16,752,983,518 tokens** (100.0% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 10,415,302,080 |
...
| Computer | Tokens |
|---|---:|
| MacBook Air M1 | 16,752,983,518 |

| Account | Tokens |
|---|---:|
| broodierchip@gmail.com | 11,177,720,456 |
...
**16,752,983,518 tokens** from 1 company(s)
