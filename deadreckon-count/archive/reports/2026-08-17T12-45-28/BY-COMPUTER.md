...
_Generated 2026-08-17T12:45:26-05:00 by `stats_page.py`. Do not edit by hand._
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 16,752,983,518 | 100.0% | 2026-08-17 10:27:49 |
| **All** | | | **16,752,983,518** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   16,752,983,518
Claude Code, per session (sessions.json):   17,929,669,477
difference                              :   -1,176,685,959
non-Claude-Code CLIs, additional        :    3,634,666,685
```

**These should agree and differ by 1,176,685,959.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

scanned **2026-08-17 10:27:49** · sessions 2026-08-17 12:40:06

`macbook-air-m1/` · 8 account(s) · 4,486 sessions · 70,374 turns · **16,752,983,518 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| Anthropic | 16,752,983,518 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 84 | 533h 36m | 17,929,669,477 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 65 | 16,755,244,500 | 2026-05-26 → 2026-08-17 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 21,564,283,003 of the 21,564,336,162 total was billed to someone.

---

## The floor: the most defensible figure per machine

**51,098,132,052 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 47,463,465,367 | 3,634,666,685 | **51,098,132,052** | 21,564,336,162 |
| **All** | | | **51,098,132,052** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 8,695,210,157 | 37,528,400,521 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 11,177,720,456 |
...
|---|---|---|
| MacBook Air M1 | 16.75B | **16,752,983,518** |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 17.93B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **21,564,336,162** |
| **All** | **17.93B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **21,564,336,162** |

---

## Sessions

300 sessions · 676h 32m active · 21,564,336,162 tokens
...
| 2026-08-08 | MacBook Air M1 | claude | 8h 53m | 268,337,143 | 601 | `claude-opus-5` |
...
| 2026-08-08 | 3,089,520,077 | 83h 34m |
