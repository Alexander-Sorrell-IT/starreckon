...
_Generated 2026-08-17T19:20:45-05:00 by `stats_page.py`. Do not edit by hand._

**16,996,554,236** tokens of Claude Code across 1 scanned computer(s) · **21,805,645,898** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-17 18:59:10_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 16,996,554,236 | 100.0% | 2026-08-17 18:59:10 |
| **All** | | | **16,996,554,236** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   16,996,554,236
Claude Code, per session (sessions.json):   18,170,979,213
...
scanned **2026-08-17 18:59:10** · sessions 2026-08-17 19:17:58

`macbook-air-m1/` · 8 account(s) · 4,487 sessions · 71,054 turns · **16,996,554,236 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 11,421,291,174 | 67.2% |
| codehunterextreme@gmail.com | 5,321,298,979 | 31.3% |
...
|---|---:|---:|
| Anthropic | 16,996,554,236 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 85 | 539h 16m | 18,170,979,213 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 66 | 16,996,554,236 | 2026-05-26 → 2026-08-17 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 21,805,592,739 of the 21,805,645,898 total was billed to someone.

---

## The floor: the most defensible figure per machine

**51,341,702,770 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 47,707,036,085 | 3,634,666,685 | **51,341,702,770** | 21,805,645,898 |
| **All** | | | **51,341,702,770** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 8,938,780,875 | 37,771,971,239 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 11,421,291,174 |
...
|---|---:|---:|---|
| broodierchip@gmail.com | 177 | 125 | 2026-05-26 → 2026-08-17 |
...
|---|---|---|
| MacBook Air M1 | 17.00B | **16,996,554,236** |
| **All** | **17.00B** | **16,996,554,236** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 18.17B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **21,805,645,898** |
| **All** | **18.17B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **21,805,645,898** |

---

## Sessions

301 sessions · 682h 12m active · 21,805,645,898 tokens
...
| 2026-08-08 | MacBook Air M1 | claude | 8h 57m | 273,127,062 | 607 | `claude-opus-5` |
...
| 2026-08-08 | 3,330,743,237 | 89h 14m |
