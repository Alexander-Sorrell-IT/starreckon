...
**51,557,801,995 tokens** · 282 sessions · 107,156 turns · 28d 14h 28m
...
| | tokens | share |
|---|---:|---:|
| MacBook Air M1 | 51,557,801,995 | 100.0% |

## By model

| | tokens | share |
|---|---:|---:|
| claude-opus-5 | 11,080,139,792 |  21.5% |
...
**20,818,113,181 tokens** · 282 sessions · 107,156 turns · 28d 14h 28m

_2025-07-03 .. 2026-08-18_

| CLI | tokens | share |
|---|---:|---:|
| claude | 17,183,446,496 |  82.5% |
...
**20,818,113,181** of the headline is on disk now. **29,206,965** is not on disk: it is work whose transcripts have been deleted, held only by the append-only `token_ledger.jsonl` in each machine folder. The session and turn counts above cover the scanned part only — a vanished session is one row of arithmetic, not a session anyone can still open — and no month below includes any of it, because a vanished session's last observation may carry no date.

| computer | scanned | ledger | beyond the scan | ledger file |
|---|---:|---:|---:|---|
| MacBook Air M1 | 21,992,538,158 | 22,021,745,123 | +29,206,965 | yes |
...
| | tokens | share |
|---|---:|---:|
| re-read from cache | 16,616,524,799 |  96.7% |
| written to cache | 488,361,202 |   2.8% |
| sent fresh | 4,300,341 |   0.0% |
| **generated** | 74,260,154 |   0.4% |
