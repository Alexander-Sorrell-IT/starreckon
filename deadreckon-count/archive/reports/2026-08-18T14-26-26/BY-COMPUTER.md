...
_Generated 2026-08-18T14:26:25-05:00 by `stats_page.py`. Do not edit by hand._

**17,214,802,173** tokens of Claude Code across 1 scanned computer(s) · **22,024,769,365** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-18 14:21:22_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 17,214,802,173 | 100.0% | 2026-08-18 14:21:22 |
| **All** | | | **17,214,802,173** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   17,214,802,173
Claude Code, per session (sessions.json):   18,390,102,680
difference                              :   -1,175,300,507
non-Claude-Code CLIs, additional        :    3,634,666,685
```

**These should agree and differ by 1,175,300,507.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

scanned **2026-08-18 14:21:22** · sessions 2026-08-18 14:25:37

`macbook-air-m1/` · 8 account(s) · 4,488 sessions · 71,483 turns · **17,214,802,173 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| broodierchip@gmail.com | 11,639,539,111 | 67.6% |
| codehunterextreme@gmail.com | 5,321,298,979 | 30.9% |
...
|---|---:|---:|
| Anthropic | 17,214,802,173 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 85 | 544h 10m | 18,390,102,680 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 66 | 17,215,677,703 | 2026-05-26 → 2026-08-18 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 22,024,716,206 of the 22,024,769,365 total was billed to someone.

---

## The floor: the most defensible figure per machine

**51,559,950,707 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 47,925,284,022 | 3,634,666,685 | **51,559,950,707** | 22,024,769,365 |
| **All** | | | **51,559,950,707** | |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 9,157,028,812 | 37,990,219,176 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 11,639,539,111 |
...
**245 Claude Code sessions have existed across the scanned machines. 164 of them — 67% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| broodierchip@gmail.com | 177 | 125 | 2026-05-26 → 2026-08-18 |
| codehunterextreme@gmail.com | 61 | 36 | 2026-02-11 → 2026-08-14 |
| alexander.sorrell.it@gmail.com | 7 | 3 | 2026-06-10 → 2026-08-17 |
...
|---|---|---|
| MacBook Air M1 | 17.21B | **17,214,802,173** |
| **All** | **17.21B** | **17,214,802,173** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | bob | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 18.39B | 1.63B | 995.36M | 497.70M | 272.62M | 135.11M | 100.22M | 53.16K | — | — | — | — | **22,024,769,365** |
| **All** | **18.39B** | **1.63B** | **995.36M** | **497.70M** | **272.62M** | **135.11M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **22,024,769,365** |

---

## Sessions

301 sessions · 687h 06m active · 22,024,769,365 tokens
...
| 2026-08-08 | MacBook Air M1 | claude | 9h 00m | 276,339,210 | 611 | `claude-opus-5` |
...
| Day | Tokens | Active |
|---|---:|---:|
| 2026-08-08 | 3,549,634,043 | 94h 08m |
