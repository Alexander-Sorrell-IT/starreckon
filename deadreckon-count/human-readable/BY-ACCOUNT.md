...
| **alexsorrellyan@gmail.com** | 3,798,899,590 | 220 | codex 1.63B _owner_, gemini 995.36M _owner_, antigravity 579.37M _owner_, copilot 437.70M _owner_, copilot 75.37M _owner_, copilot 59.37M _owner_, antigravity → antigravity 18.12M _owner_ |
| **alexander.sorrell.it@gmail.com** | 322,280,256 | 7 | claude 322.28M |
| **nefabious@gmail.com** | 100,222,322 | 8 | grok 100.22M _owner_ |
| **All attributed** | **23,557,358,344** | | |
...
> ⚠️ **806,951,836 tokens have no account.** These tools record no identity on disk and none is declared for them yet:

| CLI | Company that served it | Sessions | Tokens |
|---|---|---:|---:|
| bob | None | 25 | 802,946,395 |
