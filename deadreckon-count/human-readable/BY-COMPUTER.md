...
_Generated 2026-08-27T18:17:15-05:00 by `stats_page.py`. Do not edit by hand._

**18,487,763,737** tokens of Claude Code across 1 scanned computer(s) · **24,364,310,180** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-27 18:12:33_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 18,487,763,737 | 100.0% | 2026-08-27 18:12:33 |
...
non-Claude-Code CLIs, additional        :    4,702,121,466
```
...
scanned **2026-08-27 18:12:33** · sessions 2026-08-27 18:16:40

`macbook-air-m1/` · 8 account(s) · 4,498 sessions · 74,818 turns · **18,487,763,737 tokens** (100.0% of all Claude Code)
...
| bob | 25 | 0m | 802,946,395 |
| antigravity | 53 | 31h 26m | 597,487,937 |
...
| Bob CLI | cli | yes | 25 | 802,946,395 | 2026-08-11 → 2026-08-25 |
| Antigravity CLI | cli | yes | 53 | 597,487,937 | 2026-06-02 → 2026-08-27 |
...
| GitHub Copilot Chat | agent | yes | 0 | 0 | ? → ? |
...
| LM Studio | runtime | yes | 3 | 53,159 | 2025-07-03 → 2025-07-04 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 24,364,257,021 of the 24,364,310,180 total was billed to someone.

---

## The floor: the most defensible figure per machine

**54,712,497,902 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 50,010,376,436 | 4,702,121,466 | **54,712,497,902** | 24,364,310,180 |
| **All** | | | **54,712,497,902** | |
...
|---|---|---|
| MacBook Air M1 | 18.49B | **18,487,763,737** |
| **All** | **18.49B** | **18,487,763,737** |

### Computer x CLI

| Computer | claude | codex | gemini | bob | antigravity | copilot | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 19.66B | 1.63B | 995.36M | 802.95M | 597.49M | 572.45M | 100.22M | 53.16K | — | — | — | — | **24,364,310,180** |
| **All** | **19.66B** | **1.63B** | **995.36M** | **802.95M** | **597.49M** | **572.45M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **24,364,310,180** |

---

## Sessions

346 sessions · 741h 11m active · 24,364,310,180 tokens
...
**The 15 minutes is a judgement call.** On the 321 session(s) measured both ways, counting only gaps under one minute gives **324h 20m** against **741h 11m**. The 416h 50m between is where reading output and walking away look identical. Read it as a range. The other 25 predate this and are counted only at fifteen minutes.
...
| 2026-08-18 | MacBook Air M1 | claude | 27h 21m | 1,101,155,152 | 2,920 | `claude-opus-5` |
...
| 2026-08-08 | MacBook Air M1 | claude | 10h 21m | 336,410,173 | 682 | `claude-opus-5` |
...
| 2026-08-18 | 1,101,159,286 | 27h 21m |
