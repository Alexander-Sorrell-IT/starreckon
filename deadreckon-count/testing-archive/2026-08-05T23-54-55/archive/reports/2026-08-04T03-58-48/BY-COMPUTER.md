...
_Generated 2026-08-04T03:58:48-05:00 by `stats_page.py`. Do not edit by hand._

**41,744,091,773** tokens of Claude Code across 5 scanned computer(s) · **43,219,938,291** across every CLI on the 4 that ran `sessions.py`.
...
| Computer | Folder | Accounts | Tokens | Share | |
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,004,982,986 | 67.1% | ███████████████████········· |
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 9,605,960,154 | 23.0% | ██████······················ |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 5 | 3,864,871,344 | 9.3% | ███························· |
| **ASUS Laptop Linux** | `asus-laptop-linux/` | 1 | 266,146,676 | 0.6% | █··························· |
| **Dell Inspiron Desktop Linux** | `dell-inspiron-desktop-linux/` | 1 | 2,130,613 | 0.0% | █··························· |
| **All** | | | **41,744,091,773** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   37,879,220,429
Claude Code, per session (sessions.json):   38,071,609,939
difference                              :     -192,389,510
non-Claude-Code CLIs, additional        :    5,148,328,352
```

**These should agree and differ by 192,389,510.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

`macbook-air-m1/` · 3 account(s) · 53 sessions · 131,394 turns · **28,004,982,986 tokens** (67.1% of all Claude Code)
...
`hp-laptop-linux/` · 5 account(s) · 131 sessions · 51,284 turns · **9,605,960,154 tokens** (23.0% of all Claude Code)

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 5,547,678,789 | 57.8% |
| codehunterextreme@gmail.com | 2,564,843,440 | 26.7% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 14.7% |
| alexander.sorrell.it@gmail.com | 83,212,683 | 0.9% |
...
| Company | Tokens | Share |
|---|---:|---:|
| Anthropic | 8,160,008,138 | 84.9% |
| DeepSeek | 1,445,952,016 | 15.1% |
| — (no API call) | 0 | 0.0% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 131 | 225h 32m | 9,718,344,564 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 131 | 9,718,344,564 | 2026-05-04 → 2026-08-04 |
...
`dell-latitude-7480-linux/` · 5 account(s) · 16,514 sessions · 42,199 turns · **3,864,871,344 tokens** (9.3% of all Claude Code)
...
**It accounts for 15,618,881,451 tokens the transcripts can no longer see.**
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2,564,843,440 | +8,876,074,903 | 2026-06-09 → 2026-07-11 |
...
What the comparison does establish is a floor with a known shortfall: the transcript totals elsewhere in these reports are low by at least 15,618,881,451 on the scanned machines, and that figure is measured rather than estimated.
...
| HP Laptop Linux | 8.16B | 1.45B | **9,605,960,154** |
...
| **All** | **40.30B** | **1.45B** | **41,744,091,773** |

### Computer x CLI

| Computer | claude | gemini | codex | copilot | antigravity | grok | kilocode | Total |
|---|---|---|---|---|---|---|---|---|
| ASUS Laptop Linux | 266.15M | 4.84M | 670.07K | — | 1.59M | — | — | **273,246,771** |
| Dell Inspiron Desktop Linux | 2.13M | 402.03K | — | — | 3.08M | — | — | **5,610,873** |
| HP Laptop Linux | 9.72B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | **11,517,994,758** |
| MacBook Air M1 | 28.08B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | **31,423,085,889** |
| **All** | **38.07B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **43,219,938,291** |

---

## Sessions

530 sessions · 895h 21m active · 43,219,938,291 tokens
...
**The 15 minutes is a judgement call.** On the 488 session(s) measured both ways, counting only gaps under one minute gives **355h 55m** against **881h 15m**. The 525h 20m between is where reading output and walking away look identical. Read it as a range. The other 42 predate this and are counted only at fifteen minutes.
...
| 2026-07-30 | HP Laptop Linux | claude | 9h 45m | 820,350,103 | 2,614 | `claude-opus-5` |
...
| 2026-07-30 | 823,412,832 | 10h 06m |
