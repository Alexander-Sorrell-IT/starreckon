...
_Generated 2026-08-04T04:29:29-05:00 by `stats_page.py`. Do not edit by hand._

**41,943,331,123** tokens of Claude Code across 5 scanned computer(s) · **43,307,401,581** across every CLI on the 4 that ran `sessions.py`.
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,004,982,986 | 66.8% | ███████████████████········· |
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 9,805,199,504 | 23.4% | ███████····················· |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 5 | 3,864,871,344 | 9.2% | ███························· |
...
| **All** | | | **41,943,331,123** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   38,078,459,779
Claude Code, per session (sessions.json):   38,158,953,455
difference                              :      -80,493,676
non-Claude-Code CLIs, additional        :    5,148,448,126
```

**These should agree and differ by 80,493,676.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

`macbook-air-m1/` · 3 account(s) · 53 sessions · 131,394 turns · **28,004,982,986 tokens** (66.8% of all Claude Code)
...
`hp-laptop-linux/` · 5 account(s) · 131 sessions · 52,097 turns · **9,805,199,504 tokens** (23.4% of all Claude Code)

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 5,547,678,789 | 56.6% |
| codehunterextreme@gmail.com | 2,764,082,790 | 28.2% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 14.4% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 131 | 226h 52m | 9,805,688,080 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 131 | 9,805,688,080 | 2026-05-04 → 2026-08-04 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 43,307,281,807 of the 43,307,401,581 total was billed to someone.
...
**It accounts for 15,419,642,101 tokens the transcripts can no longer see.**
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2,764,082,790 | +8,676,835,553 | 2026-06-09 → 2026-07-11 |
...
What the comparison does establish is a floor with a known shortfall: the transcript totals elsewhere in these reports are low by at least 15,419,642,101 on the scanned machines, and that figure is measured rather than estimated.
...
| HP Laptop Linux | 8.36B | 1.45B | **9,805,199,504** |
...
| **All** | **40.50B** | **1.45B** | **41,943,331,123** |
...
| HP Laptop Linux | 9.81B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **11,605,458,048** |
| MacBook Air M1 | 28.08B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | — | **31,423,085,889** |
| **All** | **38.16B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **119.77K** | **43,307,401,581** |

---

## Sessions

537 sessions · 896h 42m active · 43,307,401,581 tokens
...
| 2026-07-30 | HP Laptop Linux | claude | 10h 23m | 889,763,000 | 3,193 | `claude-opus-5` |
...
| 2026-07-30 | 892,825,729 | 10h 44m |
