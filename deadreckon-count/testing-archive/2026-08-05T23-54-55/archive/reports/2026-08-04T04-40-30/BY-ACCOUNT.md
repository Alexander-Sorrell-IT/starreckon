...
| **codehunterextreme@gmail.com** | 12,762,692,511 | 30.4% | 3 | 61 | 42,518 | █████████··················· |
...
| codehunterextreme@gmail.com | 9.95B | 2.79B | 26.78M | — | — | **12,762,692,511** |
...
| **All** | **28.00B** | **9.83B** | **3.86B** | **266.15M** | **2.13M** | **41,966,209,135** |
...
**12,762,692,511 tokens** (30.4%) · 61 sessions · 42,518 turns · 39 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 9,948,955,645 | 78.0% |
| HP Laptop Linux | 2,786,960,802 | 21.8% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 12,762,692,511 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,141,635 |
| `claude-opus-5` | 3,253,355,913 |
| `claude-fable-5` | 971,230,311 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,654,575 | 451,450,849 | 12,259,250,570 | 47,336,517 |
