...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,520,257,119 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 187 | 591h 37m | 37,173,054,422 | claude 36.74B, copilot 437.66M |
...
**40,520,257,119 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,625,907,201 |
| `claude-opus-5` | 13,787,562,500 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,094,711,954 |
...
| codehunterextreme@gmail.com | 12,762,692,511 |
