...
_Generated 2026-08-04T05:29:15-05:00 by `stats_page.py`. Do not edit by hand._

**41,985,410,380** tokens of Claude Code across 5 scanned computer(s) · **43,350,591,122** across every CLI on the 4 that ran `sessions.py`.
...
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 9,847,278,761 | 23.5% | 2026-08-04 04:45:03 |
...
| **All** | | | **41,985,410,380** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   38,120,539,036
Claude Code, per session (sessions.json):   38,202,142,996
difference                              :      -81,603,960
non-Claude-Code CLIs, additional        :    5,148,448,126
```

**These should agree and differ by 81,603,960.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.
...
scanned **2026-08-04 04:45:03** · sessions 2026-08-04 04:45:44

`hp-laptop-linux/` · 5 account(s) · 131 sessions · 52,166 turns · **9,847,278,761 tokens** (23.5% of all Claude Code)
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 131 | 227h 24m | 9,848,877,621 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 131 | 9,848,877,621 | 2026-05-04 → 2026-08-04 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 43,350,471,348 of the 43,350,591,122 total was billed to someone.

---

## The floor: the most defensible figure per machine

**66,015,186,527 tokens across 5 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 28,004,982,986 | 3,338,097,803 | **31,343,080,789** | 31,423,085,889 |
| HP Laptop Linux | 28,728,606,782 | 1,799,769,968 | **30,528,376,750** | 11,648,647,589 |
...
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 2,039,412,621 | 13,480,330,964 |
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 2,806,162,047 |
...
| HP Laptop Linux | 8.40B | 1.45B | **9,847,278,761** |
...
| **All** | **40.54B** | **1.45B** | **41,985,410,380** |
...
| HP Laptop Linux | 9.85B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **11,648,647,589** |
| MacBook Air M1 | 28.08B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | — | **31,423,085,889** |
| **All** | **38.20B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **119.77K** | **43,350,591,122** |

---

## Sessions

537 sessions · 897h 13m active · 43,350,591,122 tokens
...
| 2026-07-30 | HP Laptop Linux | claude | 10h 39m | 912,633,362 | 3,222 | `claude-opus-5` |
...
| 2026-07-30 | 915,696,091 | 11h 00m |
