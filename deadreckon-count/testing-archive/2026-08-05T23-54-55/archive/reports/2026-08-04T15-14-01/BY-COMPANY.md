...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,882,084,973 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 189 | 595h 56m | 37,537,761,193 | claude 37.10B, copilot 437.66M |
...
**40,882,084,973 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,626,010,471 |
| `claude-opus-5` | 13,971,109,009 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,272,890,029 |
...
| codehunterextreme@gmail.com | 13,124,520,365 |
