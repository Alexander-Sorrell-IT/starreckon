...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,943,445,049 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 189 | 596h 32m | 37,596,242,352 | claude 37.16B, copilot 437.66M |
...
**40,943,445,049 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,626,010,471 |
| `claude-opus-5` | 14,030,302,547 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,275,056,567 |
...
| Account | Tokens |
|---|---:|
| broodierchip@gmail.com | 24,775,412,250 |
| codehunterextreme@gmail.com | 13,185,880,441 |
