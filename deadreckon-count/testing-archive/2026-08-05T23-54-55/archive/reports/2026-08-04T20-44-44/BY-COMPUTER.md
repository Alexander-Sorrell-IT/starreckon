...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,492,335,565 | 66.5% | 2026-08-04 20:44:23 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 10,251,265,446 | 23.9% | 2026-08-04 17:30:52 |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 5 | 3,864,871,344 | 9.0% | ⚠️ not recorded |
...
```
Claude Code, per account (totals.json)  :   39,011,878,300
Claude Code, per session (sessions.json):   39,091,883,400
difference                              :      -80,005,100
non-Claude-Code CLIs, additional        :    5,148,501,285
```
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 132,114 turns · **28,492,335,565 tokens** (66.5% of all Claude Code)
...
`hp-laptop-linux/` · 5 account(s) · 133 sessions · 53,993 turns · **10,251,265,446 tokens** (23.9% of all Claude Code)
...
`dell-latitude-7480-linux/` · 5 account(s) · 16,514 sessions · 42,199 turns · **3,864,871,344 tokens** (9.0% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 44,240,211,752 of the 44,240,384,685 total was billed to someone.

---

## The floor: the most defensible figure per machine

**89,745,698,786 tokens across 5 scanned computer(s).**
...
**796 Claude Code sessions have existed across the scanned machines. 654 of them — 82% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| broodierchip@gmail.com | 479 | 411 | 2026-01-14 → 2026-08-05 |
| codehunterextreme@gmail.com | 277 | 226 | 2026-02-11 → 2026-08-05 |
| user:73ae64bf180b | 31 | 14 | 2026-05-12 → 2026-07-18 |
| alexander.sorrell.it@gmail.com | 8 | 3 | 2026-06-09 → 2026-08-04 |
...
| **All** | **41.43B** | **1.45B** | **42,876,749,644** |
...
| **All** | **39.09B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **172.93K** | **44,240,384,685** |

---

## Sessions

542 sessions · 907h 34m active · 44,240,384,685 tokens
...
**The 15 minutes is a judgement call.** On the 500 session(s) measured both ways, counting only gaps under one minute gives **361h 37m** against **893h 28m**. The 531h 51m between is where reading output and walking away look identical. Read it as a range. The other 42 predate this and are counted only at fifteen minutes.
...
| 2026-08-04 | 951,116,531 | 13h 23m |
