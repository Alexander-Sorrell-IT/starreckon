...
_Generated 2026-08-05T00:25:26-05:00 by `stats_page.py`. Do not edit by hand._

**42,738,054,280** tokens of Claude Code across 5 scanned computer(s) · **49,886,207,183** across every CLI on the 5 that ran `sessions.py`.
...
_scans taken 2026-08-04 01:46:32 .. 2026-08-05 00:24:51_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,492,335,565 | 66.7% | 2026-08-04 20:44:23 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 10,251,265,446 | 24.0% | 2026-08-04 17:30:52 |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 5 | 3,726,175,980 | 8.7% | 2026-08-05 00:24:51 |
...
| **All** | | | **42,738,054,280** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   42,738,054,280
Claude Code, per session (sessions.json):   42,820,299,571
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 132,114 turns · **28,492,335,565 tokens** (66.7% of all Claude Code)
...
scanned **2026-08-04 17:30:52** · sessions 2026-08-04 17:31:02

`hp-laptop-linux/` · 5 account(s) · 133 sessions · 53,993 turns · **10,251,265,446 tokens** (24.0% of all Claude Code)

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 5,547,678,789 | 54.1% |
| codehunterextreme@gmail.com | 3,210,148,732 | 31.3% |
...
| Company | Tokens | Share |
|---|---:|---:|
| Anthropic | 8,805,313,430 | 85.9% |
| DeepSeek | 1,445,952,016 | 14.1% |
| — (no API call) | 0 | 0.0% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 133 | 232h 10m | 10,251,265,446 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 133 | 10,251,265,446 | 2026-05-04 → 2026-08-04 |
...
`dell-latitude-7480-linux/` · 5 account(s) · 16,515 sessions · 41,509 turns · **3,726,175,980 tokens** (8.7% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 49,886,034,250 of the 49,886,207,183 total was billed to someone.

---

## The floor: the most defensible figure per machine

**116,160,249,109 tokens across 5 scanned computer(s).**
...
| HP Laptop Linux | 29,132,593,467 | 1,799,769,968 | **30,932,363,435** | 12,051,035,414 |
...
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 2,443,399,306 | 13,884,317,649 |
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 3,210,148,732 |
...
| HP Laptop Linux | 8.81B | 1.45B | **10,251,265,446** |
...
| **All** | **41.29B** | **1.45B** | **42,738,054,280** |
...
| HP Laptop Linux | 10.25B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **12,051,035,414** |
| MacBook Air M1 | 28.57B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | 53.16K | **31,910,491,627** |
| **All** | **42.82B** | **2.60B** | **2.31B** | **1.86B** | **215.30M** | **76.72M** | **7.07M** | **172.93K** | **49,886,207,183** |

---

## Sessions

17,094 sessions · 1,090h 03m active · 49,886,207,183 tokens
...
| 2026-07-30 | HP Laptop Linux | claude | 13h 03m | 1,134,828,907 | 3,497 | `claude-opus-5` |
...
| 2026-07-30 | 1,137,891,636 | 13h 24m |
| 2026-05-24 | 1,103,839,029 | 23h 57m |
| 2026-08-04 | 962,053,801 | 13h 37m |
