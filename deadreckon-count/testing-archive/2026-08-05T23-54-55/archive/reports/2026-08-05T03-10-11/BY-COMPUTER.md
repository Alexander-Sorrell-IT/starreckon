...
_Generated 2026-08-05T03:10:11-05:00 by `stats_page.py`. Do not edit by hand._

**43,313,519,008** tokens of Claude Code across 5 scanned computer(s) · **43,859,211,447** across every CLI on the 4 that ran `sessions.py`.
...
_scans taken 2026-08-04 01:46:32 .. 2026-08-05 03:09:57 · 1 machine(s) with no recorded scan time_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,004,982,986 | 64.7% | 2026-08-04 03:07:29 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,175,387,389 | 25.8% | 2026-08-05 03:09:57 |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 5 | 3,864,871,344 | 8.9% | ⚠️ not recorded |
...
| **All** | | | **43,313,519,008** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   39,448,647,664
Claude Code, per session (sessions.json):   38,710,763,321
difference                              :     +737,884,343
non-Claude-Code CLIs, additional        :    5,148,448,126
```

**These should agree and differ by 737,884,343.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 131,394 turns · **28,004,982,986 tokens** (64.7% of all Claude Code)
...
`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 62,574 turns · **11,175,387,389 tokens** (25.8% of all Claude Code)
...
`dell-latitude-7480-linux/` · 5 account(s) · 16,514 sessions · 42,199 turns · **3,864,871,344 tokens** (8.9% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 43,859,091,673 of the 43,859,211,447 total was billed to someone.

---

## The floor: the most defensible figure per machine

**116,585,241,603 tokens across 5 scanned computer(s).**
...
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 488,276,416 | 12,778,761,753 |
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 329,613,027 | 12,620,098,364 |
...
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 0 | 12,290,485,337 |
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 0 | 12,290,485,337 |
...
| codehunterextreme@gmail.com | 220 | 183 | 2026-02-26 → 2026-08-05 |
...
| **All** | **41.87B** | **1.45B** | **43,313,519,008** |
...
| **All** | **38.71B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **119.77K** | **43,859,211,447** |

---

## Sessions

539 sessions · 903h 46m active · 43,859,211,447 tokens
