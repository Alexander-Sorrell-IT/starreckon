...
_Generated 2026-08-05T03:47:29-05:00 by `stats_page.py`. Do not edit by hand._

**43,662,176,223** tokens of Claude Code across 5 scanned computer(s) · **49,992,439,683** across every CLI on the 5 that ran `sessions.py`.
...
_scans taken 2026-08-04 01:46:32 .. 2026-08-05 03:09:57_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,492,335,565 | 65.3% | 2026-08-04 20:44:23 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,175,387,389 | 25.6% | 2026-08-05 03:09:57 |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 5 | 3,726,175,980 | 8.5% | 2026-08-05 00:24:51 |
...
| **All** | | | **43,662,176,223** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   43,662,176,223
Claude Code, per session (sessions.json):   42,926,532,071
difference                              :     +735,644,152
non-Claude-Code CLIs, additional        :    7,065,907,612
```

**These should agree and differ by 735,644,152.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

scanned **2026-08-04 20:44:23** · sessions 2026-08-04 20:44:43

`macbook-air-m1/` · 3 account(s) · 53 sessions · 132,114 turns · **28,492,335,565 tokens** (65.3% of all Claude Code)

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 17,484,791,342 | 61.4% |
| codehunterextreme@gmail.com | 10,435,790,468 | 36.6% |
...
|---|---:|---:|---:|
| claude | 50 | 392h 34m | 28,572,340,665 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 50 | 28,572,340,665 | 2026-05-26 → 2026-08-05 |
...
scanned **2026-08-05 03:09:57** · sessions 2026-08-05 03:10:09

`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 62,574 turns · **11,175,387,389 tokens** (25.6% of all Claude Code)

> ⚠️ scanner `9e05d864b460`, fleet is on `abaab905ae4c`. These figures are a floor for this machine, not a total. `update.py` on it settles it.

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 6,365,568,232 | 57.0% |
| codehunterextreme@gmail.com | 3,316,381,232 | 29.7% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 12.6% |
...
| Company | Tokens | Share |
|---|---:|---:|
| Anthropic | 9,729,435,373 | 87.1% |
| DeepSeek | 1,445,952,016 | 12.9% |
| — (no API call) | 0 | 0.0% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 133 | 233h 57m | 10,357,497,946 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 133 | 10,357,497,946 | 2026-05-04 → 2026-08-05 |
...
scanned **2026-08-05 00:24:51** · sessions 2026-08-05 00:25:24

`dell-latitude-7480-linux/` · 5 account(s) · 16,515 sessions · 41,509 turns · **3,726,175,980 tokens** (8.5% of all Claude Code)

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| alexander.sorrell.it@gmail.com | 2,180,771,071 | 58.5% |
| broodierchip@gmail.com | 1,511,346,979 | 40.6% |
| codehunterextreme@gmail.com | 26,776,064 | 0.7% |
| user:2d4777822844 | 7,281,866 | 0.2% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 16,491 | 59h 08m | 3,728,416,171 |
| copilot | 24 | 80h 36m | 1,062,300,519 |
| codex | 20 | 28h 57m | 677,851,186 |
| gemini | 12 | 10h 45m | 128,662,488 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 16,491 | 3,728,416,171 | 2026-04-24 → 2026-08-05 |
...
| Google Gemini CLI | cli | yes | 12 | 128,662,488 | 2026-04-24 → 2026-05-05 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 49,992,266,750 of the 49,992,439,683 total was billed to someone.

---

## The floor: the most defensible figure per machine

**117,084,371,052 tokens across 5 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 51,331,455,401 | 3,338,150,962 | **54,669,606,363** | 31,910,491,627 |
| HP Laptop Linux | 30,056,715,410 | 1,799,769,968 | **31,856,485,378** | 12,157,267,914 |
| Dell Latitude 7480 Linux | 28,362,015,340 | 1,917,406,327 | **30,279,421,667** | 5,645,822,498 |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 28,833,190,364 | 2026-07-21 | 11,410,715,714 | 40,243,906,078 |
| codehunterextreme@gmail.com | 6,946,344,675 | 2026-07-30 | 2,837,892,190 | 10,515,795,568 |
...
| Account | Counter | Counter ends | Transcripts after | Floor |
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 2,282,241,999 | 14,572,727,336 |
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 2,549,631,806 | 13,990,550,149 |
...
| alexander.sorrell.it@gmail.com | 2,442,457,035 | 2026-07-26 | 419,824,736 | 2,862,281,771 |
...
|---|---|---:|---|---:|
| `.claude-main` | broodierchip@gmail.com | 28,833,190,364 | 2026-05-26 → 2026-07-21 | 17,484,791,342 |
| `.claude` | broodierchip@gmail.com | 25,359,992,209 | 2026-02-26 → 2026-07-26 | 1,511,346,979 |
| `.claude` | broodierchip@gmail.com | 12,290,485,337 | 2026-01-14 → 2026-05-17 | 6,365,568,232 |
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 3,316,381,232 |
| `.claude` | codehunterextreme@gmail.com | 6,946,344,675 | 2026-05-26 → 2026-07-30 | 10,435,790,468 |
| `.claude-it` | alexander.sorrell.it@gmail.com | 2,442,457,035 | 2026-06-10 → 2026-07-26 | 2,180,771,071 |
...
**1,107 Claude Code sessions have existed across the scanned machines. 937 of them — 85% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| broodierchip@gmail.com | 570 | 499 | 2026-01-14 → 2026-08-05 |
| codehunterextreme@gmail.com | 468 | 415 | 2026-02-11 → 2026-08-05 |
| alexander.sorrell.it@gmail.com | 35 | 9 | 2026-06-09 → 2026-08-05 |
...
|---|---|---|---|
| MacBook Air M1 | 28.49B | — | **28,492,335,565** |
| HP Laptop Linux | 9.73B | 1.45B | **11,175,387,389** |
| Dell Latitude 7480 Linux | 3.73B | — | **3,726,175,980** |
| ASUS Laptop Linux | 266.15M | — | **266,146,676** |
| Dell Inspiron Desktop Linux | 2.13M | — | **2,130,613** |
| **All** | **42.22B** | **1.45B** | **43,662,176,223** |
...
| Dell Latitude 7480 Linux | 3.73B | 128.66M | 677.85M | 1.06B | 48.59M | — | — | — | **5,645,822,498** |
| HP Laptop Linux | 10.36B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **12,157,267,914** |
| MacBook Air M1 | 28.57B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | 53.16K | **31,910,491,627** |
| **All** | **42.93B** | **2.60B** | **2.31B** | **1.86B** | **215.30M** | **76.72M** | **7.07M** | **172.93K** | **49,992,439,683** |

---

## Sessions

17,094 sessions · 1,091h 50m active · 49,992,439,683 tokens
...
**The 15 minutes is a judgement call.** On the 17,052 session(s) measured both ways, counting only gaps under one minute gives **452h 40m** against **1,077h 44m**. The 625h 04m between is where reading output and walking away look identical. Read it as a range. The other 42 predate this and are counted only at fifteen minutes.
...
| 2026-07-30 | HP Laptop Linux | claude | 13h 50m | 1,165,557,252 | 3,689 | `claude-opus-5` |
...
| 2026-04-26 | Dell Latitude 7480 Linux | codex | 10h 51m | 190,809,720 | 1,389 | `gpt-5.4-mini` |
...
| 2026-08-04 | MacBook Air M1 | claude | 8h 25m | 604,338,014 | 1,152 | `claude-opus-5` |
| 2026-06-18 | MacBook Air M1 | claude | 19h 08m | 571,753,755 | 2,328 | `claude-sonnet-4-6` |
...
| 2026-07-05 | 4,313,273,984 | 67h 54m |
...
| 2026-07-30 | 1,168,619,981 | 14h 11m |
| 2026-05-24 | 1,103,839,029 | 23h 57m |
| 2026-08-04 | 1,037,557,956 | 14h 37m |
