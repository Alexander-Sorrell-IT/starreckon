...
_Generated 2026-08-05T04:13:30-05:00 by `stats_page.py`. Do not edit by hand._
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,492,335,565 | 65.2% | 2026-08-04 20:44:23 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,233,397,382 | 25.7% | 2026-08-05 04:13:10 |
...
```
Claude Code, per account (totals.json)  :   43,720,186,216
Claude Code, per session (sessions.json):   42,984,542,064
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 132,114 turns · **28,492,335,565 tokens** (65.2% of all Claude Code)
...
scanned **2026-08-05 04:13:10** · sessions 2026-08-05 04:13:28

`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 62,730 turns · **11,233,397,382 tokens** (25.7% of all Claude Code)

> ⚠️ scanner `9222d18e1270`, fleet is on `abaab905ae4c`. These figures are a floor for this machine, not a total. `update.py` on it settles it.

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 6,365,868,577 | 56.7% |
| codehunterextreme@gmail.com | 3,374,090,880 | 30.0% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 12.5% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 133 | 235h 00m | 10,415,507,939 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 133 | 10,415,507,939 | 2026-05-04 → 2026-08-05 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 50,050,276,743 of the 50,050,449,676 total was billed to someone.

---

## The floor: the most defensible figure per machine

**117,142,381,045 tokens across 5 scanned computer(s).**
...
| HP Laptop Linux | 30,114,725,403 | 1,799,769,968 | **31,914,495,371** | 12,215,277,907 |
...
| Account | Counter | Counter ends | Transcripts after | Floor |
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 2,282,542,344 | 14,573,027,681 |
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 2,607,341,454 | 14,048,259,797 |
...
| `.claude` | broodierchip@gmail.com | 12,290,485,337 | 2026-01-14 → 2026-05-17 | 6,365,868,577 |
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 3,374,090,880 |
...
| HP Laptop Linux | 9.79B | 1.45B | **11,233,397,382** |
...
| **All** | **42.27B** | **1.45B** | **43,720,186,216** |
...
| HP Laptop Linux | 10.42B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **12,215,277,907** |
| MacBook Air M1 | 28.57B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | 53.16K | **31,910,491,627** |
| **All** | **42.98B** | **2.60B** | **2.31B** | **1.86B** | **215.30M** | **76.72M** | **7.07M** | **172.93K** | **50,050,449,676** |

---

## Sessions

17,094 sessions · 1,092h 53m active · 50,050,449,676 tokens
...
| 2026-07-30 | HP Laptop Linux | claude | 14h 36m | 1,196,590,208 | 3,806 | `claude-opus-5` |
...
| 2026-07-30 | 1,199,652,937 | 14h 57m |
| 2026-07-18 | 1,177,431,546 | 21h 00m |
| 2026-05-24 | 1,103,839,029 | 23h 57m |
| 2026-08-04 | 1,064,534,993 | 14h 53m |
