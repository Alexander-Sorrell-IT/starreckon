# Claude Code token usage — ASUS Laptop Linux

_Generated 2026-08-04T01:46:32-05:00_

## Total for this computer: 266,146,676 tokens (266.15M)

Across 1 account(s), 28 sessions, 1,574 assistant turns.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| broodierchip@gmail.com | 28 | 1,574 | 96.22K | 19.57M | 244.59M | 1.89M | **266.15M** |
...
**Anthropic-only total: 266,146,676 tokens (266.15M)**
...
|---|---|---:|---|
| Gemini CLI | `/home/phantom-eternal/.gemini` | 627 | **no — not countable** |
| GitHub Copilot CLI | `/home/phantom-eternal/.copilot` | 64 | **no — not countable** |
| OpenAI Codex CLI | `/home/phantom-eternal/.codex` | 2 | yes — countable |
...
**266,146,676 tokens** (266.15M) — `/home/phantom-eternal/.claude`

userID `7fbbc8d797e00cb20a8a68001f1ddb9c3c575dd4af0d085a235e62e5af7a364d`

| Transcript | Files | Tokens | Share |
|---|---:|---:|---:|
| main | 28 | 252.03M | 95% |
| subagent | 28 | 14.11M | 5% |

| Model | Total |
|---|---:|
| claude-opus-4-7 | 255.68M |
| claude-haiku-4-5-20251001 | 9.47M |
| claude-opus-4-5-20251101 | 996.93K |
| <synthetic> | 0 |

Active 2026-01-17 → 2026-05-05 (10 days). Busiest day 2026-05-04 at 106.77M.

| Project | Total |
|---|---:|
| `-media-phantom-eternal-GamesAndMods-Project-ai-shit-5-model-system` | 256.40M |
| `-media-phantom-eternal-Games---Mods1-Project-ai-shit-5-model-system` | 4.73M |
| `-tmp` | 2.77M |
| `-home-phantom-eternal` | 2.24M |
