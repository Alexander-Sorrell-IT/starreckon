...
_Generated 2026-08-05T23:58:10-05:00 by `stats_page.py`. Do not edit by hand._

**44,042,604,991** tokens of Claude Code across 5 scanned computer(s) · **51,190,757,894** across every CLI on the 5 that ran `sessions.py`.
...
_scans taken 2026-08-04 01:46:32 .. 2026-08-05 23:57:43_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,492,335,565 | 64.7% | 2026-08-04 20:44:23 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,555,816,157 | 26.2% | 2026-08-05 23:57:43 |
...
| **All** | | | **44,042,604,991** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   44,042,604,991
Claude Code, per session (sessions.json):   44,124,850,282
difference                              :      -82,245,291
non-Claude-Code CLIs, additional        :    7,065,907,612
```

**These should agree and differ by 82,245,291.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 132,114 turns · **28,492,335,565 tokens** (64.7% of all Claude Code)
...
scanned **2026-08-05 23:57:43** · sessions 2026-08-05 23:58:08

`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,323 turns · **11,555,816,157 tokens** (26.2% of all Claude Code)

> ⚠️ scanner `a8105fb5e7a5`, fleet is on `abaab905ae4c`. These figures are a floor for this machine, not a total. `update.py` on it settles it.

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 6,365,568,232 | 55.1% |
| codehunterextreme@gmail.com | 3,696,810,000 | 32.0% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 12.2% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 155 | 251h 01m | 11,555,816,157 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 155 | 11,555,816,157 | 2026-05-04 → 2026-08-06 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 51,190,584,961 of the 51,190,757,894 total was billed to someone.

---

## The floor: the most defensible figure per machine

**117,464,799,820 tokens across 5 scanned computer(s).**
...
| HP Laptop Linux | 30,437,144,178 | 1,799,769,968 | **32,236,914,146** | 13,355,586,125 |
...
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 2,930,060,574 | 14,370,978,917 |
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 3,696,810,000 |
...
**1,107 Claude Code sessions have existed across the scanned machines. 924 of them — 83% — no longer have a transcript on disk.**
...
| codehunterextreme@gmail.com | 468 | 402 | 2026-02-11 → 2026-08-06 |
...
| HP Laptop Linux | 10.11B | 1.45B | **11,555,816,157** |
...
| **All** | **42.60B** | **1.45B** | **44,042,604,991** |
...
| HP Laptop Linux | 11.56B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **13,355,586,125** |
| MacBook Air M1 | 28.57B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | 53.16K | **31,910,491,627** |
| **All** | **44.12B** | **2.60B** | **2.31B** | **1.86B** | **215.30M** | **76.72M** | **7.07M** | **172.93K** | **51,190,757,894** |

---

## Sessions

17,116 sessions · 1,108h 54m active · 51,190,757,894 tokens
...
**The 15 minutes is a judgement call.** On the 17,074 session(s) measured both ways, counting only gaps under one minute gives **460h 53m** against **1,094h 48m**. The 633h 55m between is where reading output and walking away look identical. Read it as a range. The other 42 predate this and are counted only at fifteen minutes.
...
| 2026-07-30 | HP Laptop Linux | claude | 17h 58m | 1,517,556,365 | 4,397 | `claude-opus-5` |
...
| 2026-07-30 | 1,520,619,094 | 18h 19m |
...
| 2026-08-04 | 1,065,987,611 | 14h 54m |
