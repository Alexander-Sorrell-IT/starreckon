...
_Generated 2026-08-06T00:07:03-05:00 by `stats_page.py`. Do not edit by hand._
...
|---|---|---:|---:|---:|---|
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,576,825,537 | 100.0% | 2026-08-06 00:06:37 |
| **All** | | | **11,576,825,537** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   11,576,825,537
Claude Code, per session (sessions.json):   11,576,825,537
difference                              :               +0
...
`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,349 turns · **11,576,825,537 tokens** (100.0% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 13,376,475,731 of the 13,376,595,505 total was billed to someone.

---

## The floor: the most defensible figure per machine

**32,257,923,526 tokens across 1 scanned computer(s).**
...
**565 Claude Code sessions have existed across the scanned machines. 456 of them — 81% — no longer have a transcript on disk.**
...
| **All** | **10.13B** | **1.45B** | **11,576,825,537** |
...
| **All** | **11.58B** | **1.47B** | **295.83M** | **26.93M** | **7.07M** | **1.45M** | **119.77K** | **0** | **13,376,595,505** |

---

## Sessions

264 sessions · 379h 29m active · 13,376,595,505 tokens
...
**The 15 minutes is a judgement call.** On the 264 session(s) measured both ways, counting only gaps under one minute gives **137h 25m** against **379h 29m**. The 242h 04m between is where reading output and walking away look identical. Read it as a range.
...
| 2026-05-16 | HP Laptop Linux | claude | 5h 08m | 76,757,926 | 731 | `deepseek-v4-pro` |
...
| 2026-08-04 | HP Laptop Linux | claude | 3h 02m | 196,623,750 | 648 | `claude-fable-5` |
