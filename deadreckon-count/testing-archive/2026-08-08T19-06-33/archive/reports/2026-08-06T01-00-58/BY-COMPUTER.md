...
_Generated 2026-08-06T01:00:57-05:00 by `stats_page.py`. Do not edit by hand._
...
difference                              :               +0
non-Claude-Code CLIs, additional        :    1,817,769,833
```
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 13,662,752,885 of the 13,662,872,659 total was billed to someone.

---

## The floor: the most defensible figure per machine

**32,728,304,594 tokens across 3 scanned computer(s).**
...
| **All** | **11.85B** | **1.47B** | **295.83M** | **39.02M** | **7.07M** | **2.12M** | **119.77K** | **0** | **13,662,872,659** |

---

## Sessions

308 sessions · 394h 31m active · 13,662,872,659 tokens
...
**The 15 minutes is a judgement call.** On the 308 session(s) measured both ways, counting only gaps under one minute gives **141h 22m** against **394h 31m**. The 253h 08m between is where reading output and walking away look identical. Read it as a range.
