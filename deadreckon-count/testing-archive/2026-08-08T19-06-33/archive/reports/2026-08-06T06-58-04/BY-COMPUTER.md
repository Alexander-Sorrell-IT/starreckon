...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 4 | 29,170,327,621 | 62.7% | 2026-08-06 03:30:07 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,725,240,493 | 25.2% | 2026-08-06 01:29:54 |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 6 | 5,324,610,556 | 11.5% | 2026-08-06 06:17:15 |
...
```
Claude Code, per account (totals.json)  :   46,488,455,959
Claude Code, per session (sessions.json):   46,491,126,455
...
`macbook-air-m1/` · 4 account(s) · 2,180 sessions · 134,345 turns · **29,170,327,621 tokens** (62.7% of all Claude Code)
...
`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,516 turns · **11,725,240,493 tokens** (25.2% of all Claude Code)
...
`dell-latitude-7480-linux/` · 6 account(s) · 16,549 sessions · 61,252 turns · **5,324,610,556 tokens** (11.5% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 53,770,245,207 of the 53,770,418,140 total was billed to someone.

---

## The floor: the most defensible figure per machine

**118,688,898,254 tokens across 5 scanned computer(s).**
...
**1,125 Claude Code sessions have existed across the scanned machines. 926 of them — 82% — no longer have a transcript on disk.**
...
| **All** | **45.04B** | **1.45B** | **46,488,455,959** |
...
| **All** | **46.49B** | **2.79B** | **2.31B** | **1.86B** | **222.72M** | **90.21M** | **7.07M** | **172.93K** | **53,770,418,140** |

---

## Sessions

17,187 sessions · 1,234h 48m active · 53,770,418,140 tokens
...
**The 15 minutes is a judgement call.** On the 17,187 session(s) measured both ways, counting only gaps under one minute gives **502h 55m** against **1,234h 48m**. The 731h 53m between is where reading output and walking away look identical. Read it as a range.
...
| 2026-08-04 | 1,671,248,116 | 28h 18m |
