...
|---|---:|---:|---:|---:|---:|---|
| **broodierchip@gmail.com** | 26,424,614,505 | 53.6% | 5 | 19,304 | 177,429 | ███████████████············· |
| **codehunterextreme@gmail.com** | 17,338,936,493 | 35.2% | 3 | 2,176 | 58,849 | ██████████·················· |
| **alexander.sorrell.it@gmail.com** | 2,894,443,336 | 5.9% | 3 | 79 | 12,419 | ██·························· |
| **DeepSeek backend (~/.my-claude)** | 1,409,787,623 | 2.9% | 1 | 6 | 14,797 | █··························· |
| **unknown (Desktop_standout_clean_.claude)** | 731,855,322 | 1.5% | 1 | 420 | 4,976 | █··························· |
| **unknown (Desktop_standout_full_.claude)** | 483,526,465 | 1.0% | 1 | 805 | 7,395 | █··························· |
| **user:2d4777822844** | 7,281,866 | 0.0% | 1 | 1 | 111 | █··························· |
| **unknown (.claude-alt)** | 1,706,026 | 0.0% | 1 | 27 | 2 | █··························· |
...
| **unknown (Desktop_standout_max_.claude)** | 0 | 0.0% | 1 | 805 | 0 | ···························· |
| **unknown (Desktop_standout_sandbox_.claude)** | 0 | 0.0% | 1 | 576 | 0 | ···························· |
| **unknown (claude)** | 0 | 0.0% | 1 | 84 | 0 | ···························· |
...
|---|---:|---:|---|
| **broodierchip@gmail.com** | 29,216,773,801 | 16,682 | claude 26.39B, gemini 2.79B _file_, claude → DeepSeek 36.16M |
| **codehunterextreme@gmail.com** | 17,340,642,519 | 49 | claude 17.34B |
| **alexander.sorrell.it@gmail.com** | 2,894,658,464 | 79 | claude 2.89B |
| **nefabious@gmail.com** | 90,209,318 | 6 | grok 90.21M _owner_ |
| **All attributed** | **49,542,284,102** | | |
...
> ⚠️ **7,032,267,334 tokens have no account.** These tools record no identity on disk and none is declared for them yet:

| CLI | Company that served it | Sessions | Tokens |
|---|---|---:|---:|
| codex | OpenAI | 148 | 2,313,579,758 |
| claude ⚠️ | DeepSeek | 17 | 1,409,787,623 |
| claude | Anthropic | 43 | 1,223,101,272 |
...
|---|---|---|---|---|---|---|
| broodierchip@gmail.com | 17.56B | 5.55B | 3.05B | 266.15M | 2.13M | **26,424,614,505** |
| codehunterextreme@gmail.com | 11.04B | 6.27B | 26.78M | — | — | **17,338,936,493** |
| alexander.sorrell.it@gmail.com | 571.75M | 83.21M | 2.24B | — | — | **2,894,443,336** |
| DeepSeek backend (~/.my-claude) | — | 1.41B | — | — | — | **1,409,787,623** |
| unknown (Desktop_standout_clean_.claude) | — | 731.86M | — | — | — | **731,855,322** |
| unknown (Desktop_standout_full_.claude) | — | 483.53M | — | — | — | **483,526,465** |
| user:2d4777822844 | — | — | 7.28M | — | — | **7,281,866** |
| unknown (.claude-alt) | — | 1.71M | — | — | — | **1,706,026** |
| API key (org 15a93e14-aabb-4293-8228-8c56a803d972) | — | 437.62K | — | — | — | **437,619** |
| unknown (.claude-alt-api) | — | — | — | — | — | **0** |
| unknown (.claude-it) | — | — | — | — | — | **0** |
| unknown (.my-claude) | — | — | — | — | — | **0** |
| unknown (Desktop_standout_max_.claude) | — | — | — | — | — | **0** |
...
| unknown (my-claude) | — | — | — | — | — | **0** |
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **29.17B** | **14.53B** | **5.32B** | **266.15M** | **2.13M** | **49,292,589,255** |

---

## broodierchip@gmail.com

**26,424,614,505 tokens** (53.6%) · 19,304 sessions · 177,429 turns · 80 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 17,557,582,699 | 66.4% |
| HP Laptop Linux | 5,547,678,789 | 21.0% |
| Dell Latitude 7480 Linux | 3,051,075,728 | 11.5% |
| ASUS Laptop Linux | 266,146,676 | 1.0% |
| Dell Inspiron Desktop Linux | 2,130,613 | 0.0% |

| Company | Tokens |
|---|---:|
| Anthropic | 26,388,450,112 |
| DeepSeek | 36,164,393 |
| — (no API call) | 0 |
...
|---:|---:|---:|---:|
| 337,266,343 | 1,225,770,022 | 24,751,331,052 | 110,247,088 |
...
**17,338,936,493 tokens** (35.2%) · 2,176 sessions · 58,849 turns · 35 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 11,040,991,167 | 63.7% |
| HP Laptop Linux | 6,271,169,262 | 36.2% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 17,338,936,493 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,160,200,883 |
| `claude-opus-5` | 7,869,716,446 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 3,265,582 | 594,507,101 | 16,683,741,524 | 57,422,286 |
...
**731,855,322 tokens** (1.5%) · 420 sessions · 4,976 turns · 13 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| HP Laptop Linux | 731,855,322 | 100.0% |

| Company | Tokens |
|---|---:|
| Anthropic | 731,855,322 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 634,324,891 |
| `claude-fable-5` | 97,530,431 |
| `<synthetic>` | 0 |

| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 1,741,299 | 37,545,939 | 688,721,802 | 3,846,282 |
...
**483,526,465 tokens** (1.0%) · 805 sessions · 7,395 turns · 13 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| HP Laptop Linux | 483,526,465 | 100.0% |

| Company | Tokens |
|---|---:|
| Anthropic | 483,526,465 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 476,607,014 |
| `claude-haiku-4-5-20251001` | 4,499,071 |
| `claude-fable-5` | 2,420,380 |
| `<synthetic>` | 0 |

| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 2,590,129 | 50,628,264 | 426,414,898 | 3,893,174 |
...
**1,706,026 tokens** (0.0%) · 27 sessions · 2 turns · 1 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| HP Laptop Linux | 1,706,026 | 100.0% |
...
| Model | Tokens |
|---|---:|
| `claude-opus-5` | 1,706,026 |

| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4 | 1,324 | 1,703,990 | 708 |
...
**0 tokens** (0.0%) · 805 sessions · 0 turns · 0 active days
...
**0 tokens** (0.0%) · 84 sessions · 0 turns · 0 active days
...
**14,529,373,789 tokens** across 18 login(s)
...
| unknown (Desktop_standout_max_.claude) | 0 |   0.0% |
