...
**2,955,032,999 tokens** (2.96B) — `/home/phantomcore/.claude-alt`
...
| Project | Total |
|---|---:|
| `-media-phantomcore-AI-DRIVE-AI-Shit-mining-Quest-coder-Claude-Code` | 2.28B |
...
**913,256 tokens** (913.26K) — `/home/phantomcore/.ai-logs-archive/claude/.claude-alt`
...
| Project | Total |
|---|---:|
| `-media-phantomcore-AI-DRIVE-AI-Shit-mining-Quest-coder-Claude-Code` | 913.26K |
