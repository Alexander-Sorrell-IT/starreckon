...
| **broodierchip@gmail.com** | 2,584,957,850 | 38.4% | 1 | 2,774 | 7,912 | ███████████················· |
...
|---|---:|---:|---|
| **broodierchip@gmail.com** | 4,057,029,009 | 121 | claude 2.57B, gemini 1.47B _file_, claude → DeepSeek 14.17M, claude → — (no API call) 49.99K |
| **codehunterextreme@gmail.com** | 3,092,285,937 | 25 | claude 3.09B |
| **alexander.sorrell.it@gmail.com** | 44,111,412 | 2 | claude 44.11M |
| **All attributed** | **7,193,426,358** | | |
...
> ⚠️ **1,341,510,881 tokens have no account.** These tools record no identity on disk and none is declared for them yet:
...
| broodierchip@gmail.com | 2.58B | **2,584,957,850** |
...
**2,584,957,850 tokens** (38.4%) · 2,774 sessions · 7,912 turns · 20 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| HP Laptop Linux | 2,584,957,850 | 100.0% |

| Company | Tokens |
|---|---:|
| Anthropic | 2,570,784,490 |
| DeepSeek | 14,173,360 |
...
| `claude-haiku-4-5-20251001` | 3,314,851 |
| `deepseek-v4-flash` | 11,001 |

| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 1,544,330 | 58,262,093 | 2,515,835,734 | 9,315,693 |
...
**520,497,793 tokens** (7.7%) · 6 sessions · 5,101 turns · 22 active days
...
**321,101,727 tokens** (4.8%) · 420 sessions · 2,098 turns · 13 active days
...
**167,829,804 tokens** (2.5%) · 805 sessions · 2,477 turns · 11 active days
