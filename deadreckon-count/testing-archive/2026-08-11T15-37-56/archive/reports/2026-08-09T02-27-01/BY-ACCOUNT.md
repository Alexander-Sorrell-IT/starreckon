...
> ⚠️ **1,351,576,186 tokens have no account.** These tools record no identity on disk and none is declared for them yet:
...
| antigravity | Google | 22 | 36,992,864 |
...
| unknown (claude-it) | — | — | **0** |
| unknown (my-claude) | — | — | **0** |
| **All** | **6.73B** | **824.89K** | **6,735,125,840** |
...
| `claude-haiku-4-5-20251001` | 4,139,737 |
| `deepseek-v4-flash` | 11,001 |

| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 1,548,145 | 58,410,636 | 2,516,508,117 | 9,315,838 |
...
**0 tokens** (0.0%) · 85 sessions · 0 turns · 0 active days
