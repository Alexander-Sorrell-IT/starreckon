...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 14,766,838,204 | 100.0% | ████████████████████████████ |
...
|---|---:|---:|---:|---|
| Anthropic | 105 | 520h 46m | 16,378,926,728 | claude 15.94B, copilot 437.66M |
...
**14,766,838,204 tokens** (100.0% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 8,429,156,766 |
...
**14,766,838,204 tokens** from 1 company(s)
