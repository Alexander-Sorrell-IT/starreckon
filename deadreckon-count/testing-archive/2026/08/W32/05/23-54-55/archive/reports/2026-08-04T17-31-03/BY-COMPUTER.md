...
_Generated 2026-08-04T17:31:03-05:00 by `stats_page.py`. Do not edit by hand._

**42,389,397,065** tokens of Claude Code across 5 scanned computer(s) · **43,752,978,947** across every CLI on the 4 that ran `sessions.py`.
...
_scans taken 2026-08-04 01:46:32 .. 2026-08-04 17:30:52 · 1 machine(s) with no recorded scan time_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,004,982,986 | 66.1% | 2026-08-04 03:07:29 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 10,251,265,446 | 24.2% | 2026-08-04 17:30:52 |
...
| **All** | | | **42,389,397,065** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   38,524,525,721
Claude Code, per session (sessions.json):   38,604,530,821
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 131,394 turns · **28,004,982,986 tokens** (66.1% of all Claude Code)
...
`hp-laptop-linux/` · 5 account(s) · 133 sessions · 53,993 turns · **10,251,265,446 tokens** (24.2% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 43,752,859,173 of the 43,752,978,947 total was billed to someone.

---

## The floor: the most defensible figure per machine

**66,499,178,312 tokens across 5 scanned computer(s).**
...
| **All** | **40.94B** | **1.45B** | **42,389,397,065** |
...
| **All** | **38.60B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **119.77K** | **43,752,978,947** |

---

## Sessions

539 sessions · 901h 59m active · 43,752,978,947 tokens
