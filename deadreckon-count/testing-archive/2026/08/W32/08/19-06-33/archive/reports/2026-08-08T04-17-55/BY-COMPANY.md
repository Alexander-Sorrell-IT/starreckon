...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 47,608,297,307 | 97.1% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,527 | 810h 45m | 48,053,084,461 | claude 47.61B, copilot 442.12M |
...
**47,608,297,307 tokens** (97.1% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 18,256,344,130 |
...
| HP Laptop Linux | 12,845,081,841 |
...
| Account | Tokens |
|---|---:|
| broodierchip@gmail.com | 27,603,831,899 |
| codehunterextreme@gmail.com | 17,102,302,587 |
| alexander.sorrell.it@gmail.com | 2,894,443,336 |
...
**14,291,033,857 tokens** from 3 company(s)
