...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 47,691,776,139 | 97.1% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,527 | 811h 34m | 48,136,563,293 | claude 47.69B, copilot 442.12M |
...
**47,691,776,139 tokens** (97.1% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 18,339,822,962 |
...
| HP Laptop Linux | 12,928,560,673 |
...
| codehunterextreme@gmail.com | 17,185,781,419 |
...
**14,374,512,689 tokens** from 3 company(s)
