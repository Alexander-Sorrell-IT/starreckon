...
_Generated 2026-08-08T15:30:18-05:00_

## Total for this computer: 6,615,634,312 tokens (6.62B)

Across 23 account(s), 5,572 sessions, 31,890 assistant turns.
...
**Anthropic-only total: 6,080,963,159 tokens (6.08B)**
...
**2,971,668,539 tokens** (2.97B) — `/home/phantomcore/.claude-alt`
...
| Project | Total |
|---|---:|
| `-media-phantomcore-AI-DRIVE-AI-Shit-mining-Quest-coder-Claude-Code` | 2.30B |
| `-media-phantomcore-AI-DRIVE-Transcribing` | 182.82M |
| `-media-phantomcore-AI-DRIVE-VORTEX-SYSTEM` | 167.91M |
| `-home-phantomcore` | 146.00M |
| `-media-phantomcore-AI-DRIVE-AI-Shit-mining-Quest-coder` | 101.39M |
...
**2,584,957,850 tokens** (2.58B) — `/home/phantomcore/.claude`
...
| `-media-phantomcore-AI-DRIVE-hackathons-mind` | 126.49M |
...
**321,101,727 tokens** (321.10M) — `/home/phantomcore/.ai-logs-archive/claude/Desktop_standout_clean_.claude`
...
| Project | Total |
|---|---:|
| `alt__-media-phantomcore-AI-DRIVE-pip` | 160.18M |
| `alt__-media-phantomcore-AI-DRIVE-hackathons-mantle` | 73.79M |
| `alt__-media-phantomcore-AI-DRIVE-pip__c9b9dba0-12af-4bbc-975b-6a4dc2996eaa__subagents` | 36.42M |
| `alt__-home-phantomcore` | 23.05M |
| `alt__-media-phantomcore-AI-DRIVE-pip__314e21c5-cdf8-4a5b-a667-2d2f2b44eb05__subagents` | 15.48M |
| `alt__-media-phantomcore-AI-DRIVE-hackathons-tierva` | 5.36M |
| `alt__-media-phantomcore-AI-DRIVE` | 5.05M |
| `alt__-home-phantomcore--claude-meta-teams-smoke-mixed-workdirs-t-claude` | 1.34M |

### unknown (Desktop_standout_full_.claude)

**167,829,804 tokens** (167.83M) — `/home/phantomcore/.ai-logs-archive/claude/Desktop_standout_full_.claude`
...
| Project | Total |
|---|---:|
| `alt__-media-phantomcore-AI-DRIVE-hackathons-CodeCrusher__00e1fa7b-fc1e-48a9-b4a6-1f1eff13e305__subagents__workflows__wf_c2496bae-446` | 48.24M |
| `alt__-media-phantomcore-AI-DRIVE-VORTEX-SYSTEM` | 45.80M |
| `alt__-media-phantomcore-AI-DRIVE-VORTEX-SYSTEM__db6723e4-a658-4a0e-8977-7e7758b27be5__subagents__workflows__wf_4f331da5-c25` | 26.45M |
| `alt__-media-phantomcore-AI-DRIVE-VORTEX-SYSTEM__6e61c0f7-6283-4005-b056-8aacc175c5d3__subagents__workflows__wf_480a8ff7-e32` | 15.18M |
| `alt__-media-phantomcore-AI-DRIVE-hackathons-CodeCrusher__bcd58245-691e-490c-950b-c2bc992ebe2a__subagents__workflows__wf_30d16dcc-5ca` | 7.76M |
| `alt__-media-phantomcore-AI-DRIVE-hackathons-CodeCrusher` | 6.93M |
| `alt__-media-phantomcore-AI-DRIVE-VORTEX-SYSTEM__db6723e4-a658-4a0e-8977-7e7758b27be5__subagents__workflows__wf_1ba5b953-248` | 4.85M |
| `alt__-media-phantomcore-AI-DRIVE-VORTEX-SYSTEM__c2b6343a-e599-421c-8d80-0c91fff7a15d__subagents` | 3.21M |

### alexander.sorrell.it@gmail.com

**43,831,821 tokens** (43.83M) — `/home/phantomcore/.claude-it`
...
**936,209 tokens** (936.21K) — `/home/phantomcore/.ai-logs-archive/claude/.claude-alt`
...
| Model | Total |
|---|---:|
| claude-opus-5 | 936.21K |

Active 2026-08-08 → 2026-08-08 (1 days). Busiest day 2026-08-08 at 936.21K.

| Project | Total |
|---|---:|
| `-media-phantomcore-AI-DRIVE-AI-Shit-mining-Quest-coder-Claude-Code` | 936.21K |
...
**0 tokens** (0) — `/home/phantomcore/.ai-logs-archive/claude/Desktop_standout_sandbox_.claude`
...
**0 tokens** (0) — `/home/phantomcore/Desktop/standout_clean/.claude`

userID `9fe225ab991233bf703aa663b6bf06bb04ddab782025753b968e194eeb2b0173`

### broodierchip@gmail.com

**0 tokens** (0) — `/home/phantomcore/Desktop/standout_full/.claude`
