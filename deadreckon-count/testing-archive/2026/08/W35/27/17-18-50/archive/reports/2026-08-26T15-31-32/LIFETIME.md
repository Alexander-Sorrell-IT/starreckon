...
**54,623,771,219 tokens** · 298 sessions · 118,011 turns · 32d 2h 58m
...
| | tokens | share | |
|---|---:|---:|---|
| claude | 50,010,376,436 |  91.6% | ★ |
| codex | 1,633,604,881 |   3.0% | † |
| antigravity | 1,039,090,314 |   1.9% | † |
...
| | tokens | share |
|---|---:|---:|
| MacBook Air M1 | 54,623,771,219 | 100.0% |
...
| gemini-3.7-flash-safety-le | 764,627,724 |   1.4% |
...
| gemini-antigravity-root.is_record | 127,726,723 |   0.2% |
...
**23,101,158,520 tokens** · 298 sessions · 118,011 turns · 32d 2h 58m

_2025-07-03 .. 2026-08-26_

| CLI | tokens | share |
|---|---:|---:|
| claude | 18,487,763,737 |  80.0% |
| codex | 1,633,604,881 |   7.1% |
| antigravity | 1,039,090,314 |   4.5% |
...
**23,101,158,520** of the headline is on disk now. **0** is not on disk: it is work whose transcripts have been deleted, held only by the append-only `token_ledger.jsonl` in each machine folder. The session and turn counts above cover the scanned part only — a vanished session is one row of arithmetic, not a session anyone can still open — and no month below includes any of it, because a vanished session's last observation may carry no date.

| computer | scanned | ledger | beyond the scan | ledger file |
|---|---:|---:|---:|---|
| MacBook Air M1 | 24,275,583,497 | 17,354,720,610 | +0 | yes |
