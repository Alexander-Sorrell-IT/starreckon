...
_Generated 2026-08-26T17:05:56-05:00 by `stats_page.py`. Do not edit by hand._

**18,487,763,737** tokens of Claude Code across 1 scanned computer(s) · **24,313,592,846** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-26 16:48:38_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1 (Darwin ARM64)** | `macbookair-attlocal-net/` | 8 | 18,487,763,737 | 100.0% | 2026-08-26 16:48:38 |
| **All** | | | **18,487,763,737** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   18,487,763,737
Claude Code, per session (sessions.json):   19,662,188,714
difference                              :   -1,174,424,977
non-Claude-Code CLIs, additional        :    4,651,404,132
```
...
scanned **2026-08-26 16:48:38** · sessions 2026-08-26 17:03:53

`macbookair-attlocal-net/` · 8 account(s) · 4,498 sessions · 74,818 turns · **18,487,763,737 tokens** (100.0% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 24,313,539,687 of the 24,313,592,846 total was billed to someone.

---

## The floor: the most defensible figure per machine

**54,661,780,568 tokens across 1 scanned computer(s).**
...
| Computer | claude | codex | antigravity | gemini | copilot | bob | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 (Darwin ARM64) | 19.66B | 1.63B | 1.08B | 995.36M | 572.45M | 272.62M | 100.22M | 53.16K | — | — | — | — | **24,313,592,846** |
| **All** | **19.66B** | **1.63B** | **1.08B** | **995.36M** | **572.45M** | **272.62M** | **100.22M** | **53.16K** | **0** | **0** | **0** | **0** | **24,313,592,846** |

---

## Sessions

317 sessions · 771h 29m active · 24,313,592,846 tokens
...
**The 15 minutes is a judgement call.** On the 312 session(s) measured both ways, counting only gaps under one minute gives **342h 58m** against **771h 29m**. The 428h 31m between is where reading output and walking away look identical. Read it as a range. The other 5 predate this and are counted only at fifteen minutes.
...
| 2026-03-03 | MacBook Air M1 (Darwin ARM64) | copilot | 29h 55m | 1,404,767 | 11,231 | `unknown` |
...
| 2026-08-04 | MacBook Air M1 (Darwin ARM64) | claude | 25h 42m | 688,981,050 | 1,262 | `claude-opus-5` |
| 2026-08-21 | MacBook Air M1 (Darwin ARM64) | antigravity | 24h 32m | 551,815,242 | 4,820 | `gemini-3.7-flash-safety-le` |
| 2026-06-18 | MacBook Air M1 (Darwin ARM64) | claude | 19h 08m | 243,949,169 | 1,121 | `claude-sonnet-4-6` |
| 2026-07-26 | MacBook Air M1 (Darwin ARM64) | claude | 16h 49m | 659,873,265 | 1,563 | `claude-opus-5` |
| 2026-07-26 | MacBook Air M1 (Darwin ARM64) | claude | 15h 08m | 608,598,364 | 2,011 | `claude-opus-5` |
| 2026-07-07 | MacBook Air M1 (Darwin ARM64) | claude | 14h 01m | 273,850,474 | 3,980 | `claude-fable-5` |
| 2026-07-29 | MacBook Air M1 (Darwin ARM64) | claude | 13h 49m | 682,530,474 | 4,133 | `claude-opus-5` |
| 2026-07-22 | MacBook Air M1 (Darwin ARM64) | claude | 11h 29m | 338,816,596 | 3,644 | `claude-opus-4-8` |
| 2026-08-06 | MacBook Air M1 (Darwin ARM64) | claude | 11h 11m | 291,931,582 | 1,779 | `claude-opus-5` |
| 2026-05-21 | MacBook Air M1 (Darwin ARM64) | copilot | 10h 50m | 171,418,535 | 1,178 | `claude-sonnet-4.6` |
| 2026-08-08 | MacBook Air M1 (Darwin ARM64) | claude | 10h 21m | 336,410,173 | 682 | `claude-opus-5` |
| 2026-07-14 | MacBook Air M1 (Darwin ARM64) | claude | 10h 08m | 218,545,136 | 608 | `claude-opus-4-8` |
...
| 2026-07-22 | MacBook Air M1 (Darwin ARM64) | claude | 11h 29m | 338,816,596 | 3,644 | `claude-opus-4-8` |
| 2026-08-08 | MacBook Air M1 (Darwin ARM64) | claude | 10h 21m | 336,410,173 | 682 | `claude-opus-5` |
| ? | MacBook Air M1 (Darwin ARM64) | claude | 0m | 317,059,214 | 0 | `claude-opus-4-8[1m]` |
| ? | MacBook Air M1 (Darwin ARM64) | claude | 0m | 306,861,442 | 0 | `claude-opus-4-8` |
| 2026-07-10 | MacBook Air M1 (Darwin ARM64) | claude | 9h 10m | 293,110,132 | 2,664 | `claude-opus-4-8` |
| 2026-08-06 | MacBook Air M1 (Darwin ARM64) | claude | 11h 11m | 291,931,582 | 1,779 | `claude-opus-5` |
| 2026-07-07 | MacBook Air M1 (Darwin ARM64) | claude | 14h 01m | 273,850,474 | 3,980 | `claude-fable-5` |
...
| Day | Tokens | Active |
|---|---:|---:|
| 2026-08-08 | 3,642,233,838 | 96h 22m |
...
| 2026-08-18 | 1,101,155,152 | 27h 21m |
...
| 2026-08-21 | 598,562,632 | 29h 48m |
