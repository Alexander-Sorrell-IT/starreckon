...
export declare class MutationTestReportHelper {
    ...
    private readonly partialResults;
    private reportCompleted;
    static inject: ["reporter", "options", "project", "logger", "testCoverage", "fs", "requireFromCwd", "unexpectedExitRegistry"];
    constructor(reporter: Required<Reporter>, options: StrykerOptions, project: Project, log: Logger, testCoverage: I<TestCoverage>, fs: I<FileSystem>, requireFromCwd: typeof requireResolve, unexpectedExitHandler: I<UnexpectedExitHandler>);
    ...
    private writeIncrementalReport;
...
export declare function normalizeReportFileName(fileName: string | undefined): string;
