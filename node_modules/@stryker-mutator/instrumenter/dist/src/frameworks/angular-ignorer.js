...
export class AngularIgnorer {
    ...
    #isInputModelOrOutputConfigurationObject(path) {
        ...
        if (isRequiredSignalIOFunction || isOutput) {
            ...
            return (callExpression.node.arguments.length >= 1 &&
        ...
        if (isSignalIOFunction) {
            ...
            return (callExpression.node.arguments.length >= 2 &&
...
//# sourceMappingURL=angular-ignorer.js.map