import { LitElement as e, html as t, isServer as n, nothing as r, svg as i, unsafeCSS as a } from "lit";
...
import { AsyncDirective as f } from "lit-html/async-directive.js";
import { directive as p } from "lit-html/directive.js";
import { isServer as m } from "lit-html/is-server.js";
import { classMap as h } from "lit/directives/class-map.js";
import { map as g } from "lit/directives/map.js";
import { repeat as _ } from "lit/directives/repeat.js";
import { unsafeHTML as v } from "lit/directives/unsafe-html.js";
//#region \0rolldown/runtime.js
var y = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), b = "/";
function x(e, t, n) {
	let r = Object.keys(e), i = C(r);
	return r.reduce((r, a) => {
		let o = S(a.startsWith(t) ? a.slice(t.length) : a);
		return r[S(a.slice(i.length))] = n(e[a], o), r;
	}, Object.create(null));
}
function S(e) {
...
function C(e) {
	let t = e.map((e) => e.split(/\/|\\/).slice(0, -1));
	if (e.length) return t.reduce(n).join(b);
	return "";
	function n(e, t) {
		for (let n = 0; n < e.length; n++) if (e[n] !== t[n]) return e.splice(0, n);
		return e;
	}
}
function w(e, t) {
	let n = (e) => e.file ? `1${e.name}` : `0${e.name}`;
	return n(e).localeCompare(n(t));
}
//#endregion
//#region ../metrics/dist/src/helpers/is-not-nullish.js
function T(e) {
	return e != null;
}
//#endregion
//#region ../metrics/dist/src/helpers/text.js
var E = {
...
function ee(e) {
	return e === E.lineFeed || e === E.carriageReturn || e === E.lineSeparator || e === E.paragraphSeparator;
}
function te(e) {
	let t = [], n = 0, r = 0;
	function i(e) {
	...
	for (i(0); n < e.length;) {
		...
		switch (n++, t) {
			case E.carriageReturn:
				e.charCodeAt(n) === E.lineFeed && n++, i(n);
				break;
			case E.lineFeed:
				i(n);
				break;
			default:
				t > E.maxAsciiCharacter && ee(t) && i(n);
				break;
		}
	}
	return t.push(r), t;
...
//#endregion
//#region ../metrics/dist/src/helpers/group-by.js
function D(e, t) {
	return Object.groupBy ? Object.groupBy(e, t) : e.reduce((e, n) => {
		let r = t(n);
		return e[r] ??= [], e[r].push(n), e;
	}, Object.create(null));
}
//#endregion
//#region ../metrics/dist/src/model/mutant-model.js
function O(e) {
	if (e === void 0) throw Error("mutant.sourceFile was not defined");
}
var ne = class {
	coveredBy;
	description;
	...
	testsCompleted;
	get coveredByTests() {
		return this.#n(this.coveredBy);
	}
	set coveredByTests(e) {
		this.coveredBy = e.map((e) => e.id), e.forEach((e) => this.#t(e));
	}
	get killedByTests() {
		return this.#n(this.killedBy);
	}
	set killedByTests(e) {
		this.killedBy = e.map((e) => e.id), e.forEach((e) => this.#t(e));
	}
	#e;
	constructor(e) {
	...
	addCoveredBy(e) {
		this.#t(e), this.coveredBy ??= [], this.coveredBy.includes(e.id) || this.coveredBy.push(e.id);
	}
	addKilledBy(e) {
		this.#t(e), this.killedBy ??= [], this.killedBy.includes(e.id) || this.killedBy.push(e.id);
	}
	#t(e) {
		(this.#e ??= /* @__PURE__ */ new Map()).set(e.id, e);
	}
	#n(e) {
		if (!e?.length || !this.#e?.size) return;
		let t = [], n = /* @__PURE__ */ new Set();
		for (let r of e) if (!n.has(r)) {
			n.add(r);
			let e = this.#e.get(r);
			e && t.push(e);
		}
	...
	getMutatedLines() {
		return O(this.sourceFile), this.sourceFile.getMutationLines(this);
	}
	getOriginalLines() {
		return O(this.sourceFile), this.sourceFile.getLines(this.location);
	}
	get fileName() {
		return O(this.sourceFile), this.sourceFile.name;
	}
	update() {
...
//#endregion
//#region ../metrics/dist/src/model/source-file.js
function re(e) {
	if (e === void 0) throw Error("sourceFile.source is undefined");
}
var ie = class {
	#e;
	getLineMap() {
		return re(this.source), this.#e ??= te(this.source);
	}
	getLines(e) {
		re(this.source);
		let t = this.getLineMap();
	...
	name;
	constructor(e, t) {
		super(), this.language = e.language, this.source = e.source, this.name = t, this.mutants = e.mutants.map((e) => {
			let t = new ne(e);
			return t.sourceFile = this, t;
		});
	}
	getMutationLines(e) {
		let t = this.getLineMap(), n = t[e.location.start.line], r = t[e.location.end.line], i = t[e.location.end.line + 1];
		return `${this.source.substring(n, n + e.location.start.column - 1)}${e.replacement ?? e.description ?? e.mutatorName}${this.source.substring(r + e.location.end.column - 1, i)}`;
	}
};
//#endregion
//#region ../metrics/dist/src/model/metrics-result.js
function oe(e) {
	return typeof e == "object" && !!e && "notCovering" in e;
}
var se = class {
	parent;
	name;
	...
	metrics;
	constructor(e, t, n, r) {
		this.name = e, this.childResults = t, this.metrics = n, this.file = r;
	}
	updateParent(e) {
		this.parent = e, this.childResults.forEach((e) => e.updateParent(this));
	}
	updateAllMetrics() {
	...
	updateMetrics() {
		if (this.file === void 0) {
			if (this.childResults.length === 0) return;
			this.childResults.forEach((e) => {
				e.updateMetrics();
			});
			let e = this.childResults.map((e) => e.metrics);
			oe(e[0]) ? this.metrics = Se(e) : this.metrics = we(e);
			return;
		}
		this.file.tests ? this.metrics = xe([this.file]) : this.metrics = Ce([this.file]);
	}
};
//#endregion
//#region ../metrics/dist/src/model/test-model.js
function ce(e) {
	if (e === void 0) throw Error("test.sourceFile was not defined");
}
function le(e) {
	if (e === void 0) throw Error("test.location was not defined");
}
var k = {
	Killing: "Killing",
	Covering: "Covering",
	...
	location;
	get killedMutants() {
		if (this.#e?.length) return [...this.#e];
	}
	get coveredMutants() {
		if (this.#t?.length) return [...this.#t];
	}
	#e;
	#t;
	addCovered(e) {
		this.#t ??= [], this.#t.some(({ id: t }) => t === e.id) || this.#t.push(e);
	}
	addCoveredUnchecked(e) {
		(this.#t ??= []).push(e);
	}
	addKilled(e) {
		this.#e ??= [], this.#e.some(({ id: t }) => t === e.id) || this.#e.push(e);
	}
	addKilledUnchecked(e) {
		(this.#e ??= []).push(e);
	}
	constructor(e) {
	...
	getLines() {
		return ce(this.sourceFile), le(this.location), this.sourceFile.getLines(this.location);
	}
	get fileName() {
		return ce(this.sourceFile), this.sourceFile.name;
	}
	get status() {
		return this.#e?.length ? k.Killing : this.#t?.length ? k.Covering : k.NotCovering;
	}
	update() {
		this.sourceFile?.result?.file && this.sourceFile.result.updateAllMetrics();
	}
	...
	name;
	constructor(e, t) {
		super(), this.name = t, this.source = e.source, this.tests = e.tests.map((e) => {
			let t = new ue(e);
			return t.sourceFile = this, t;
		});
	}
}, fe = NaN, pe = "All files", me = "All tests";
function he(e) {
	let { files: t, testFiles: n, projectRoot: r = "" } = e, i = x(t, r, (e, t) => new ae(e, t));
	if (n && Object.keys(n).length) {
		let e = x(n, r, (e, t) => new de(e, t));
		return be(Object.values(i).flatMap((e) => e.mutants), Object.values(e).flatMap((e) => e.tests)), {
			systemUnderTestMetrics: ge(pe, i, Ce, we),
			testMetrics: ge(me, e, xe, Se)
		};
	}
	return {
		systemUnderTestMetrics: ge(pe, i, Ce, we),
...
function ge(e, t, n, r) {
	let i = Object.keys(t);
	return i.length === 1 && i[0] === "" ? ve(e, t[i[0]], n) : _e(e, t, n, r);
}
function _e(e, t, n, r) {
	let i = ye(t, n, r);
	return new se(e, i, r(i.map((e) => e.metrics)));
}
function ve(e, t, n) {
	return new se(e, [], n([t]), t);
}
function ye(e, t, n) {
	let r = D(Object.entries(e), (e) => e[0].split("/")[0]);
	return Object.keys(r).map((e) => {
		if (r[e].length > 1 || r[e]?.[0][0] !== e) return _e(e, r[e].reduce((t, [n, r]) => (t[n.slice(e.length + 1)] = r, t), {}), t, n);
		{
			let [n, i] = r[e][0];
			return ve(n, i, t);
		}
...
function be(e, t) {
	...
	for (let t of e) {
		t.relateTests(n);
		let { coveredBy: e, killedBy: r } = t;
		if (e) for (let r = 0; r < e.length; r++) {
			let i = n.get(e[r]);
			i && (e[r] = i.id, i.addCoveredUnchecked(t));
		}
		if (r) for (let e = 0; e < r.length; e++) {
			let i = n.get(r[e]);
			i && (r[e] = i.id, i.addKilledUnchecked(t));
		}
	}
}
function xe(e) {
	...
	for (let n of e) for (let e of n.tests) switch (t.total++, e.status) {
		case k.Killing:
			t.killing++;
			break;
		case k.Covering:
...
function Se(e) {
	...
	for (let n of e) t.total += n.total, t.killing += n.killing, t.covering += n.covering, t.notCovering += n.notCovering;
	return t;
}
function Ce(e) {
	let t = {
	...
	for (let n of e) for (let e of n.mutants) t[e.status]++;
	return Te(t.Pending, t.Killed, t.Timeout, t.Survived, t.NoCoverage, t.RuntimeError, t.CompileError, t.Ignored);
}
function we(e) {
	let t = 0, n = 0, r = 0, i = 0, a = 0, o = 0, s = 0, c = 0;
	for (let l of e) t += l.pending, n += l.killed, r += l.timeout, i += l.survived, a += l.noCoverage, o += l.runtimeErrors, s += l.compileErrors, c += l.ignored;
	return Te(t, n, r, i, a, o, s, c);
}
function Te(e, t, n, r, i, a, o, s) {
	let c = n + t, l = r + i, u = c + r, d = l + c, f = a + o;
	return {
		pending: e,
		killed: t,
		timeout: n,
		...
		totalValid: d,
		totalInvalid: f,
		mutationScore: d > 0 ? c / d * 100 : fe,
		totalMutants: d + f + s + e,
		mutationScoreBasedOnCoveredCode: d > 0 ? c / u * 100 || 0 : fe
	};
}
//#endregion
//#region ../../node_modules/.pnpm/tslib@2.8.1/node_modules/tslib/tslib.es6.mjs
var Ee = function(e, t) {
	return Ee = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(e, t) {
		e.__proto__ = t;
	} || function(e, t) {
...
function Me(e, t, n) {
	...
	function l(e) {
		e.value instanceof je ? Promise.resolve(e.value.v).then(u, d) : f(a[0][2], e);
	}
	function u(e) {
		c("next", e);
	}
...
function Ne(e) {
	...
	return t ? t.call(e) : (e = typeof ke == "function" ? ke(e) : e[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
		return this;
	}, n);
	function r(t) {
		n[t] = e[t] && function(n) {
	...
	return e.prototype.unsubscribe = function() {
		...
		if (!this.closed) {
			...
			if (M(c)) try {
				...
				i = e instanceof Fe ? e.errors : [e];
			}
			var l = this._finalizers;
			if (l) {
				this._finalizers = null;
				try {
					for (var u = ke(l), d = u.next(); !d.done; d = u.next()) {
						var f = d.value;
						try {
							Be(f);
						} catch (e) {
							i ??= [], e instanceof Fe ? i = Ae(Ae([], j(i)), j(e.errors)) : i.push(e);
						}
					}
				} catch (e) {
					n = { error: e };
		...
		if (t && t !== this) if (this.closed) Be(t);
		else {
			if (t instanceof e) {
		...
		var t = this._parentage;
		t === e ? this._parentage = null : Array.isArray(t) && Ie(t, e);
...
function ze(e) {
	return e instanceof Le || e && "closed" in e && M(e.remove) && M(e.add) && M(e.unsubscribe);
}
function Be(e) {
	M(e) ? e() : e.unsubscribe();
}
...
var Ve = {
	...
	setTimeout: function(e, t) {
		var n = [...arguments].slice(2), r = He.delegate;
		return r?.setTimeout ? r.setTimeout.apply(r, Ae([e, t], j(n))) : setTimeout.apply(void 0, Ae([e, t], j(n)));
	},
	clearTimeout: function(e) {
		return (He.delegate?.clearTimeout || clearTimeout)(e);
	},
	delegate: void 0
};
//#endregion
...
var Ge = (function() {
	return Je("C", void 0, void 0);
})();
function Ke(e) {
	return Je("E", void 0, e);
}
function qe(e) {
	return Je("N", e, void 0);
}
function Je(e, t, n) {
	return {
		kind: e,
...
function Xe(e) {
	if (Ve.useDeprecatedSynchronousErrorHandling) {
		...
		if (t && (Ye = {
			...
			var n = Ye, r = n.errorThrown, i = n.error;
			if (Ye = null, r) throw i;
		}
	} else e();
}
function Ze(e) {
	Ve.useDeprecatedSynchronousErrorHandling && Ye && (Ye.errorThrown = !0, Ye.error = e);
}
//#endregion
...
var Qe = function(e) {
	...
	function t(t) {
		...
		return n.isStopped = !1, t ? (n.destination = t, ze(t) && t.add(n)) : n.destination = ot, n;
	}
	return t.create = function(e, t, n) {
		return new nt(e, t, n);
	}, t.prototype.next = function(e) {
		this.isStopped ? at(qe(e), this) : this._next(e);
	}, t.prototype.error = function(e) {
		this.isStopped ? at(Ke(e), this) : (this.isStopped = !0, this._error(e));
	}, t.prototype.complete = function() {
		this.isStopped ? at(Ge, this) : (this.isStopped = !0, this._complete());
...
var tt = function() {
	...
	function t(t, n, r) {
		...
		if (M(t) || !t) a = {
			...
			var o;
			i && Ve.useDeprecatedNextContext ? (o = Object.create(t), o.unsubscribe = function() {
				return i.unsubscribe();
			}, a = {
				next: t.next && et(t.next, o),
				error: t.error && et(t.error, o),
				complete: t.complete && et(t.complete, o)
			}) : a = t;
		}
		return i.destination = new tt(a), i;
	}
	return t;
}(Qe);
function rt(e) {
	Ve.useDeprecatedSynchronousErrorHandling ? Ze(e) : Ue(e);
}
function it(e) {
	throw e;
}
function at(e, t) {
	var n = Ve.onStoppedNotification;
...
function lt(e) {
	return e.length === 0 ? ct : e.length === 1 ? e[0] : function(t) {
...
var N = function() {
	...
	return e.prototype.lift = function(t) {
		...
		var r = this, i = ft(e) ? e : new nt(e, t, n);
		return Xe(function() {
		...
		var n = this;
		return t = ut(t), new t(function(t, r) {
			var i = new nt({
				next: function(t) {
					try {
						e(t);
		...
		return lt([...arguments])(this);
	}, e.prototype.toPromise = function(e) {
		var t = this;
		return e = ut(e), new e(function(e, n) {
			var r;
...
function ut(e) {
	return e ?? Ve.Promise ?? Promise;
}
function dt(e) {
	return e && M(e.next) && M(e.error) && M(e.complete);
}
function ft(e) {
	return e && e instanceof Qe || dt(e) && ze(e);
}
//#endregion
...
function mt(e) {
	return function(t) {
		if (pt(t)) return t.lift(function(t) {
			try {
				return e(t, this);
			} catch (e) {
				this.error(e);
...
var ht = function(e) {
	...
	return t.prototype.lift = function(e) {
		var t = new vt(this, this);
		return t.operator = e, t;
	}, t.prototype._throwIfClosed = function() {
		if (this.closed) throw new gt();
	}, t.prototype.next = function(e) {
		var t = this;
		Xe(function() {
			var n, r;
			if (t._throwIfClosed(), !t.isStopped) {
				...
				try {
					for (var i = ke(t.currentObservers), a = i.next(); !a.done; a = i.next()) a.value.next(e);
				} catch (e) {
					n = { error: e };
				} finally {
					try {
		...
		return r || i ? Re : (this.currentObservers = null, a.push(e), new Le(function() {
			t.currentObservers = null, Ie(a, e);
		}));
	...
	setInterval: function(e, t) {
		var n = [...arguments].slice(2), r = xt.delegate;
		return r?.setInterval ? r.setInterval.apply(r, Ae([e, t], j(n))) : setInterval.apply(void 0, Ae([e, t], j(n)));
	},
	clearInterval: function(e) {
		return (xt.delegate?.clearInterval || clearInterval)(e);
	},
	delegate: void 0
}, St = function(e) {
	A(t, e);
	...
	return t.prototype.schedule = function(e, t) {
		...
		return n === void 0 && (n = 0), xt.setInterval(e.flush.bind(e, this), n);
	}, t.prototype.recycleAsyncId = function(e, t, n) {
		if (n === void 0 && (n = 0), n != null && this.delay === n && this.pending === !1) return t;
		t != null && xt.clearInterval(t);
		...
		if (!this.closed) {
			...
			this.work = this.state = this.scheduler = null, this.pending = !1, Ie(i, this), n != null && (this.id = this.recycleAsyncId(r, n, null)), this.delay = null, e.prototype.unsubscribe.call(this);
		}
	}, t;
}(bt), Ct = function() {
	function e(t, n) {
...
}(Ct))(St), Tt = wt, Et = new N(function(e) {
	return e.complete();
});
//#endregion
...
function kt(e) {
	return Dt(Ot(e)) ? e.pop() : void 0;
}
function At(e, t) {
	return typeof Ot(e) == "number" ? e.pop() : t;
}
//#endregion
	...
	return Me(this, arguments, function() {
		...
		return Oe(this, function(a) {
			switch (a.label) {
				...
				case 2: return [4, je(t.read())];
				case 3: return n = a.sent(), r = n.value, i = n.done, i ? [4, je(void 0)] : [3, 5];
				case 4: return [2, a.sent()];
				case 5: return [4, je(r)];
...
function Wt(e) {
	return new N(function(t) {
		var n, r;
		try {
			for (var i = ke(e), a = i.next(); !a.done; a = i.next()) {
				var o = a.value;
...
function Jt(e, t) {
	return t === void 0 && (t = 0), mt(function(n, r) {
...
function nn(e, t) {
	if (e != null) {
		if (Nt(e)) return Xt(e, t);
		if (jt(e)) return Qt(e, t);
		if (Mt(e)) return Zt(e, t);
		if (Pt(e)) return en(e, t);
		if (Rt(e)) return $t(e, t);
		if (Bt(e)) return tn(e, t);
	}
	throw Ft(e);
}
//#endregion
...
function ln(e, t) {
	return cn(t) ? e.apply(void 0, Ae([], j(t))) : e(t);
}
function un(e) {
...
function dn(e, t, n, r, i, a, o, s) {
	var c = [], l = 0, u = 0, d = !1, f = function() {
		...
		a && t.next(e), l++;
		var s = !1;
		F(n(e, u++)).subscribe(P(t, function(e) {
			i?.(e), a ? p(e) : t.next(e);
		}, function() {
			s = !0;
		}, void 0, function() {
...
function fn(e, t, n) {
	return n === void 0 && (n = Infinity), M(t) ? fn(function(n, r) {
		return sn(function(e, i) {
			return t(n, e, r, i);
		})(F(e(n, r)));
	}, n) : (typeof t == "number" && (n = t), mt(function(t, r) {
		return dn(t, r, e, n);
	}));
}
//#endregion
...
function pn(e) {
	return e === void 0 && (e = Infinity), fn(ct, e);
}
//#endregion
//#region ../../node_modules/.pnpm/rxjs@7.8.2/node_modules/rxjs/dist/esm5/internal/observable/fromEvent.js
var mn = ["addListener", "removeListener"], hn = ["addEventListener", "removeEventListener"], gn = ["on", "off"];
function _n(e, t, n, r) {
	if (M(n) && (r = n, n = void 0), r) return _n(e, t, n).pipe(un(r));
	var i = j(xn(e) ? hn.map(function(r) {
		return function(i) {
			return e[r](t, i, n);
		};
	}) : yn(e) ? mn.map(vn(e, t)) : bn(e) ? gn.map(vn(e, t)) : [], 2), a = i[0], o = i[1];
	if (!a && jt(e)) return fn(function(e) {
		return _n(e, t, n);
	})(F(e));
...
function Sn(e, t, n) {
	e === void 0 && (e = 0), n === void 0 && (n = Tt);
	var r = -1;
	return t != null && (Dt(t) ? n = t : r = t), new N(function(t) {
		var i = on(e) ? +e - n.now() : e;
		i < 0 && (i = 0);
		var a = 0;
...
//#endregion
//#region ../../node_modules/.pnpm/rxjs@7.8.2/node_modules/rxjs/dist/esm5/internal/observable/interval.js
function Cn(e, t) {
	return e === void 0 && (e = 0), t === void 0 && (t = wt), e < 0 && (e = 0), Sn(e, e, t);
}
//#endregion
//#region ../../node_modules/.pnpm/rxjs@7.8.2/node_modules/rxjs/dist/esm5/internal/observable/merge.js
function wn() {
	var e = [...arguments], t = kt(e), n = At(e, Infinity), r = e;
	return r.length ? r.length === 1 ? F(r[0]) : pn(n)(rn(r, t)) : Et;
}
//#endregion
//#region ../../node_modules/.pnpm/rxjs@7.8.2/node_modules/rxjs/dist/esm5/internal/operators/distinctUntilChanged.js
function Tn(e, t) {
	return t === void 0 && (t = ct), e ??= En, mt(function(n, r) {
		var i, a = !0;
		n.subscribe(P(r, function(n) {
			var o = t(n);
...
//#endregion
//#region ../../node_modules/.pnpm/rxjs@7.8.2/node_modules/rxjs/dist/esm5/internal/operators/sample.js
function Dn(e) {
	return mt(function(t, n) {
		var r = !1, i = null;
		t.subscribe(P(n, function(e) {
			r = !0, i = e;
		})), F(e).subscribe(P(n, function() {
			if (r) {
				r = !1;
				var e = i;
				i = null, n.next(e);
...
//#endregion
//#region ../../node_modules/.pnpm/rxjs@7.8.2/node_modules/rxjs/dist/esm5/internal/operators/sampleTime.js
function On(e, t) {
	return t === void 0 && (t = wt), Dn(Cn(e, t));
}
//#endregion
...
//#endregion
//#region src/lib/custom-events.ts
function L(e, t, n) {
...
//#endregion
//#region ../../node_modules/.pnpm/@lit-labs+observers@2.1.0/node_modules/@lit-labs/observers/resize-controller.js
var jn = class {
	constructor(e, { target: t, config: n, callback: r, skipInitial: i }) {
		this.t = /* @__PURE__ */ new Set(), this.o = !1, this.i = !1, this.h = e, t !== null && this.t.add(t ?? e), this.l = n, this.o = i ?? this.o, this.callback = r, m || (window.ResizeObserver ? (this.u = new ResizeObserver((e) => {
...
}, Mn = p(class extends f {
	constructor() {
		super(...arguments), this.observing = !1;
	}
	render(e, t) {}
	update(e, [t, n]) {
		this.controller = t, this.part = e, this.observe = n, !1 === n ? (t.unobserve(e.element), this.observing = !1) : !1 === this.observing && (t.observe(e.element), this.observing = !0);
	}
	disconnected() {
		this.controller?.unobserve(this.part.element), this.observing = !1;
	}
	reconnected() {
		!1 !== this.observe && !1 === this.observing && (this.controller?.observe(this.part.element), this.observing = !0);
	}
}), Nn = (/* @__PURE__ */ y(((e, t) => {
	var n = function(e) {
					...
					for (var x = h.pattern || h, S = r.next, C = c; S !== t.tail && !(d && C >= d.reach); C += S.value.length, S = S.next) {
						...
						if (!(w instanceof a)) {
							...
							if (v) {
								...
								var ee = E.index, te = E.index + E[0].length, D = C;
								for (D += S.value.length; ee >= D;) S = S.next, D += S.value.length;
								if (D -= S.value.length, C = D, S.value instanceof a) continue;
								for (var O = S; O !== t.tail && (D < te || typeof O.value == "string"); O = O.next) T++, D += O.value.length;
								T--, w = e.slice(C, D), E.index -= C;
							} else if (E = o(x, 0, w, _), !E) continue;
							var ee = E.index, ne = E[0], re = w.slice(0, ee), ie = w.slice(ee + ne.length), ae = C + w.length;
							d && ae > d.reach && (d.reach = ae);
							var oe = S.prev;
							re && (oe = l(t, oe, re), C += re.length), u(t, oe, T);
							var se = new a(f, g ? i.tokenize(ne, g) : ne, y, ne);
							if (S = l(t, oe, se), ie && l(t, S, ie), T > 1) {
								var ce = {
									cause: f + "," + m,
									reach: ae
								};
								s(e, t, n, S.prev, C, ce), d && ce.reach > d.reach && (d.reach = ce.reach);
							}
						}
					}
				}
...
Prism.languages.clike = {
	...
	var ee = ":[^}\\r\\n]+", te = r(t("[^\"'/()]|<<0>>|\\(<<self>>*\\)", [C]), 2), D = t("\\{(?!\\{)(?:(?![}:])<<0>>)*<<1>>?\\}", [te, ee]), O = r(t("[^\"'/()]|\\/(?!\\*)|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|<<0>>|\\(<<self>>*\\)", [S]), 2), ne = t("\\{(?!\\{)(?:(?![}:])<<0>>)*<<1>>?\\}", [O, ee]);
	function re(t, r) {
		return {
			interpolation: {
				pattern: n("((?:^|[^{])(?:\\{\\{)*)<<0>>", [t]),
...
} }), delete Prism.languages.scala["class-name"], delete Prism.languages.scala.function, delete Prism.languages.scala.constant, (function(e) {
	var t = "(?:\\r?\\n|\\r)[ \\t]*\\|.+\\|(?:(?!\\|).)*";
	e.languages.gherkin = {
		pystring: {
			pattern: /("""|''')[\s\S]+?\1/,
...
})(Prism), Prism.languages.svelte = Prism.languages.extend("markup", {
	each: {
		pattern: /* @__PURE__ */ RegExp("{[#/]each(?:(?:\\{(?:(?:\\{(?:[^{}])*\\})|(?:[^{}]))*\\})|(?:[^{}]))*}"),
		inside: {
			"language-javascript": [
				{
	...
	block: {
		pattern: /* @__PURE__ */ RegExp("{[#:/@]/s(if|else if|await|then|catch|each|html|debug)(?:(?:\\{(?:(?:\\{(?:[^{}])*\\})|(?:[^{}]))*\\})|(?:[^{}]))*}"),
		inside: {
			punctuation: /^{|}$/,
			keyword: [
				/* @__PURE__ */ RegExp("[#:/@](if|else if|await|then|catch|each|html|debug)( )*"),
				/as/,
				/then/
			],
			"language-javascript": {
...
}), Prism.languages.svelte.tag.inside["attr-value"].inside.entity = Prism.languages.svelte.entity, Prism.hooks.add("wrap", (e) => {
	e.type === "entity" && (e.attributes.title = e.content.replace(/&amp;/, "&"));
}), Object.defineProperty(Prism.languages.svelte.tag, "addInlined", { value: function(e, t) {
	let n = {};
	n["language-" + t] = {
		pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,
		lookbehind: !0,
...
} }), Prism.languages.svelte.tag.addInlined("style", "css"), Prism.languages.svelte.tag.addInlined("script", "javascript"), (function() {
...
var z = class extends e {
	static styles = [R];
}, In = (e, n) => t`<li title=${e.trim() || r} class="my-3 rounded-sm bg-white px-2 py-3 shadow-sm">${n}</li>`, Ln = (e, n) => t`<p title=${n?.trim() || r}>${e}</p>`, Rn = (e) => t`<div class="mt-2 mr-6 mb-6 flex flex-col gap-4">${e}</div>`, B = (e, n) => t`<span role="img" aria-label=${n}>${e}</span>`, zn = ":host([mode=closed]){height:0}:host([mode=half]){height:var(--spacing-drawer-half-open)}:host([mode=open]){height:50%}";
//#endregion
...
//#endregion
//#region src/components/drawer/drawer.component.ts
var Bn = class extends z {
	static styles = [a(zn), R];
	get toggleMoreLabel() {
		switch (this.mode) {
			case "half": return t`${B("🔼", "up arrow")} More`;
			case "open": return t`${B("🔽", "down arrow")} Less`;
			case "closed": return r;
		}
	}
	#e;
	#t;
	constructor() {
		super(), this.mode = "closed", this.hasDetail = !1, this.#t = new AbortController(), this.#e = new jn(this, { callback: (e) => (e[0]?.contentRect.height ?? 0) - (this.header?.clientHeight ?? 0) });
	}
	toggleReadMore = (e) => {
		this.mode === "open" ? this.mode = "half" : this.mode = "open", e.preventDefault(), e.stopImmediatePropagation();
	};
	connectedCallback() {
		super.connectedCallback(), window.addEventListener("keydown", this.#n, { signal: this.#t.signal });
	}
	disconnectedCallback() {
		this.#t.abort(), super.disconnectedCallback();
	}
	#n = (e) => {
		e.key === "Escape" && (this.mode = "closed");
	};
	render() {
		let e = this.mode === "open", n = this.#e.value;
		return t`<aside @click=${(e) => e.stopPropagation()} class="mr-4 ml-6">
      <header class="w-full py-4">
        <h2>
          <slot name="header"></slot>
          ${d(this.hasDetail, () => t`<button data-testId="btnReadMoreToggle" class="ml-2 cursor-pointer align-middle" @click=${this.toggleReadMore}>
                ${this.toggleMoreLabel}
              </button>`)}
        </h2>
      </header>
      <div
        style=${n && e ? `height: ${n}px;` : r}
        class=${h({
      ...
      >
        ...
        ${d(this.hasDetail && this.mode === "open", () => t`<slot name="detail"></slot>`)}
      </div>
    </aside>`;
	}
};
V([s({ reflect: !0 })], Bn.prototype, "mode", void 0), V([s({
	reflect: !0,
	type: Boolean,
	attribute: "has-detail"
})], Bn.prototype, "hasDetail", void 0), V([s({ attribute: !1 })], Bn.prototype, "toggleMoreLabel", null), V([c("header")], Bn.prototype, "header", void 0), Bn = V([o("mte-drawer")], Bn);
//#endregion
//#region src/lib/html-helpers.ts
function Vn(e) {
	switch (e) {
		case "Killed": return "success";
		case "NoCoverage": return "caution";
		case "Survived": return "danger";
		case "Timeout": return "warning";
		case "Ignored":
		case "RuntimeError":
		case "Pending":
		case "CompileError": return "secondary";
	}
}
function Hn(e) {
	switch (e) {
		case k.Killing: return "success";
		case k.Covering: return "warning";
		case k.NotCovering: return "caution";
	}
}
function Un(e) {
	switch (e) {
		case k.Killing: return B("✅", e);
		case k.Covering: return B("☂", e);
		case k.NotCovering: return B("🌧", e);
	}
}
function Wn(e) {
	switch (e) {
		case "Killed": return B("✅", e);
		case "NoCoverage": return B("🙈", e);
		case "Ignored": return B("🤥", e);
		case "Survived": return B("👽", e);
		case "Timeout": return B("⏰", e);
		case "Pending": return B("⌛", e);
		case "RuntimeError":
		case "CompileError": return B("💥", e);
	}
}
function Gn(e) {
...
function Jn({ fileName: e, location: t }) {
	return e ? `${e}${t ? `:${t.start.line}:${t.start.column}` : ""}` : "";
}
function Yn(e) {
	e && !Xn(e) && e.scrollIntoView({
		block: "center",
...
function Xn(e) {
	...
	return t >= 0 && n <= (window.innerHeight || document.documentElement.clientHeight) - 120;
}
//#endregion
//#region src/lib/mutant-changes.ts
var Zn = new _t(), Qn = n ? Et : wn(an(1), window.navigation ? _n(window.navigation, "navigatesuccess") : Et, _n(window, "hashchange").pipe(kn((e) => e.preventDefault()))).pipe(sn(() => window.location.hash.slice(1)), Tn(), sn((e) => e.split("/").filter(Boolean).map(decodeURIComponent))), H = {
	mutant: "mutant",
	test: "test"
}, U = class extends z {
	shouldReactivate() {
	...
	constructor() {
		super(), this.context = {
			view: H.mutant,
			path: []
		}, this.path = [], this.#u = new Le(), this.#d = new Le(), this.#u.add(this.#d);
	}
	firstUpdated() {
		(this.path.length === 0 || this.path[0] !== H.mutant && this.path[0] !== H.test) && window.location.replace(Kn(`${H.mutant}`));
	}
	async #t() {
		if (this.src) try {
	...
	willUpdate(e) {
		this.report && (this.theme ??= this.#a(), e.has("report") && this.#o(this.report), (e.has("path") || e.has("report")) && (this.#s(), this.#c())), e.has("src") && this.#t();
	}
	#n = /* @__PURE__ */ new Map();
	#r = /* @__PURE__ */ new Map();
	updated(e) {
		e.has("theme") && this.theme && this.dispatchEvent(L("theme-changed", {
			theme: this.theme,
	...
	#a() {
		return An() && localStorage.getItem("mutation-testing-elements-theme") || (n || window.matchMedia?.("(prefers-color-scheme: dark)")?.matches ? "dark" : "light");
	}
	#o(e) {
		this.rootModel = he(e), t((e, t) => {
			e.result = t, e.mutants.forEach((e) => this.#n.set(e.id, e));
		})(this.rootModel?.systemUnderTestMetrics), t((e, t) => {
			e.result = t, e.tests.forEach((e) => this.#r.set(e.id, e));
		})(this.rootModel?.testMetrics), this.rootModel.systemUnderTestMetrics.updateParent(), this.rootModel.testMetrics?.updateParent();
		function t(e) {
			return function t(n) {
				n?.file && e(n.file, n), n?.childResults.forEach((e) => {
					t(e);
				});
			};
		}
	...
	#s() {
		if (this.rootModel) {
			let e = (e, t) => t.reduce((e, t) => e?.childResults.find((e) => e.name === t), e), t = this.path.slice(1);
			this.path[0] === H.test && this.rootModel.testMetrics ? this.context = {
				view: H.test,
				path: t,
	...
	#c() {
		n || (document.title = this.title);
	}
	themeSwitch = (e) => {
		this.theme = e.detail, An() && localStorage.setItem("mutation-testing-elements-theme", this.theme);
	};
	static styles = [a($n), R];
	connectedCallback() {
		super.connectedCallback(), window.matchMedia("(prefers-color-scheme: dark)").addEventListener?.("change", this.#i, { signal: this.#e.signal }), this.#u.add(Qn.subscribe((e) => this.path = e)), this.#m();
	}
	#l;
	#u;
	#d;
	...
	#m() {
		if (!this.sse) return;
		this.#l = new EventSource(this.sse);
		let e = _n(this.#l, "mutant-tested").subscribe((e) => {
			let t = JSON.parse(e.data);
			if (!this.report) return;
			let n = this.#n.get(t.id);
			if (n !== void 0) {
				this.#f = n;
				for (let [e, n] of Object.entries(t)) this.#f[e] = n;
				t.killedBy && t.killedBy.forEach((e) => {
					let t = this.#r.get(e);
					t !== void 0 && (this.#p = t, t.addKilled(this.#f), this.#f.addKilledBy(t));
				}), t.coveredBy && t.coveredBy.forEach((e) => {
					let t = this.#r.get(e);
					t !== void 0 && (this.#p = t, t.addCovered(this.#f), this.#f.addCoveredBy(t));
				});
			}
		}), t = _n(this.#l, "mutant-tested").pipe(On(er)).subscribe(() => {
			this.#h();
		});
		this.#d.add(e), this.#d.add(t), this.#l.addEventListener("finished", () => {
			this.#l?.close(), this.#h(), this.#d.unsubscribe();
		}, { signal: this.#e.signal });
	}
	#h() {
		this.#f?.update(), this.#p?.update(), Zn.next();
	}
	disconnectedCallback() {
		super.disconnectedCallback(), this.#e.abort(), this.#u.unsubscribe(), this.#l?.close();
	}
	#g() {
		return d(this.context.result, (e) => t`<h1 class="mt-4 text-5xl font-bold tracking-tight">
          ${e.name}${d(this.titlePostfix, (e) => t`<small class="text-light-muted ml-4 font-light">${e}</small>`)}
        </h1>`);
	}
	render() {
		return d(this.context.result ?? this.errorMessage, () => t`<mte-file-picker .rootModel=${this.rootModel}></mte-file-picker>
          <div class="container space-y-4 bg-white pb-4 font-sans text-gray-800 transition-colors motion-safe:transition-max-width">
            ...
            <mte-result-status-bar
              detected=${u(this.rootModel?.systemUnderTestMetrics.metrics.totalDetected)}
              no-coverage=${u(this.rootModel?.systemUnderTestMetrics.metrics.noCoverage)}
              pending=${u(this.rootModel?.systemUnderTestMetrics.metrics.pending)}
              survived=${u(this.rootModel?.systemUnderTestMetrics.metrics.survived)}
              total=${u(this.rootModel?.systemUnderTestMetrics.metrics.totalValid)}
            ></mte-result-status-bar>
            ${d(this.context.view === "mutant" && this.context.result, () => t`<mte-mutant-view
                  id="mte-mutant-view"
                  .result=${this.context.result}
                  .thresholds=${this.report.thresholds}
                  .path=${this.path}
                ></mte-mutant-view>`)}
            ${d(this.context.view === "test" && this.context.result, () => t`<mte-test-view id="mte-test-view" .result=${this.context.result} .path=${this.path}></mte-test-view>`)}
          </div>`);
	}
	#_() {
		return d(this.errorMessage, (e) => t`<div class="my-4 rounded-lg bg-red-100 p-4 text-sm text-red-700" role="alert">${e}</div>`);
	}
	#v() {
		return d(this.rootModel?.testMetrics, () => {
			let e = this.context.view === "mutant", n = this.context.view === "test";
			return t`<nav class="border-b border-gray-200 text-center text-sm font-medium text-gray-600">
        <ul class="-mb-px flex flex-wrap" role="tablist">
          ${[{
				...
				isActive: n,
				text: "🧪 Tests"
			}].map(({ type: e, isActive: n, text: r }) => t`<li class="mr-2" role="presentation">
                <a
...
V([s({ attribute: !1 })], W.prototype, "report", void 0), V([s({ attribute: !1 })], W.prototype, "rootModel", void 0), V([s()], W.prototype, "src", void 0), V([s()], W.prototype, "sse", void 0), V([s({ attribute: !1 })], W.prototype, "errorMessage", void 0), V([s({ attribute: !1 })], W.prototype, "context", void 0), V([s({ type: Array })], W.prototype, "path", void 0), V([s({ attribute: "title-postfix" })], W.prototype, "titlePostfix", void 0), V([s({ reflect: !0 })], W.prototype, "theme", void 0), V([s({ attribute: !1 })], W.prototype, "themeBackgroundColor", null), V([c("mte-file-picker")], W.prototype, "filePicker", void 0), V([s()], W.prototype, "title", null), W = V([o("mutation-test-report-app")], W);
//#endregion
//#region src/lib/code-helpers.ts
var G = {
	csharp: "cs",
	java: "java",
...
function tr(e) {
	return e.slice(e.lastIndexOf(".") + 1).toLocaleLowerCase();
}
function nr(e) {
	switch (tr(e)) {
		case "cs": return G.csharp;
		case "html": return G.html;
		case "java": return G.java;
		case "js":
		case "cjs":
		case "mjs": return G.javascript;
		case "ts":
		case "tsx":
		case "cts":
		case "mts": return G.typescript;
		case "sc":
		case "sbt":
		case "scala": return G.scala;
		case "php": return G.php;
		case "vue": return G.vue;
		case "feature": return G.gherkin;
		case "svelte": return G.svelte;
		case "rs": return G.rust;
		case "py": return G.python;
		default: return;
	}
}
function rr(e, t) {
	let n = nr(t) ?? "plain", r = n;
	return n === G.vue && (r = G.html), (0, Nn.highlight)(e, Nn.languages[r], r);
}
function ir(e, t) {
	let n = [], r = [], i = {
		column: 0,
	...
	for (; s < e.length;) {
		switch (o && !ar(e[s]) && (l(), o = !1), e[s]) {
			case K.CarriageReturn:
				i.offset++;
				break;
			case K.NewLine:
				f(), i.offset++, i.line++, i.column = 0, o = !0;
				break;
			case K.LT: {
				let e = m();
				e.isClosing ? g(e) : h(e);
	...
	function d({ attributes: e, elementName: t, isClosing: n }) {
		return n ? `</${t}>` : `<${t}${Object.entries(e ?? {}).reduce((e, [t, n]) => n === void 0 ? `${e} ${t}` : `${e} ${t}="${n}"`, "")}>`;
	}
	function f() {
		u(), r.push(n.join("")), n = [];
	}
	function p(e) {
		if (i.column++, i.offset++, t) for (let e of t(i)) e.isClosing ? g(e) : (c(d(e)), a.push(e));
		c(e);
	}
	function m() {
		s++;
		...
		t && s++;
		let n = s;
		for (; !ar(e[s]) && e[s] !== K.GT;) s++;
		return {
			elementName: e.substring(n, s),
			attributes: _(),
			isClosing: t
		};
	}
	...
	function g(e) {
		...
		for (t = a.length - 1; t >= 0; t--) {
			let n = a[t];
			if (e.elementName === n.elementName && n.id === e.id) {
				c(d(e)), a.splice(t, 1);
				for (let e = t; e < a.length; e++) c(d(a[e]));
				break;
			}
			c(d({
				...n,
		...
		if (t === -1) throw Error(`Cannot find corresponding opening tag for ${d(e)}`);
	}
	function _() {
		...
		for (; s < e.length;) {
			...
			if (n === K.GT) return t;
			if (!ar(n)) {
				let { name: e, value: n } = v();
				t[e] = n;
			}
			s++;
		}
		throw Error(`Missing closing tag near ${e.substring(Math.max(0, s - 10))}`);
	}
	function v() {
		let t = s;
		for (; e[s] !== "=";) s++;
	...
	function b() {
		let t = s;
		for (; e[s] !== K.Semicolon;) s++;
		return e.substring(t, s + 1);
	}
}
function ar(e) {
	return e === K.NewLine || e === K.Space || e === K.Tab;
}
var K = {
	CarriageReturn: "\r",
	NewLine: "\n",
...
function or(e, t) {
	...
	for (; e[n] === t[n] && n < t.length;) n++;
	let i = e.length - t.length;
	for (; e[r + i] === t[r] && r > n;) r--;
	r === n && (ar(t[n - 1]) || n--), r++;
	let a = t.substring(n, r);
	return ["true", "false"].forEach((e) => {
		a === e.slice(0, e.length - 1) && e.endsWith(t[r]) && r++, a === e.slice(1) && e.startsWith(t[n - 1]) && n--;
	}), [n, r];
}
function sr(e, t) {
...
var vr = "diff-old", yr = "diff-new", q = class extends U {
	...
	#e;
	constructor() {
		super(), this.filters = [], this.selectedMutantStates = [], this.lines = [], this.mutants = [], this.#e = new AbortController();
	}
	connectedCallback() {
		super.connectedCallback(), window.addEventListener("keydown", this.#t, { signal: this.#e.signal });
	}
	disconnectedCallback() {
		this.#e.abort(), super.disconnectedCallback();
	}
	#t = (e) => {
		e.key === "Escape" && this.selectedMutant && this.#s(this.selectedMutant);
	};
	#n = (e) => {
	...
	#r = (e) => {
		if (e.stopPropagation(), e.target instanceof Element) {
			...
			for (; t instanceof Element; t = t.parentElement) {
				let e = t.getAttribute("data-mutant-id"), r = this.mutants.find(({ id: t }) => t.toString() === e);
				r && n.push(r);
			}
			let r = (this.selectedMutant ? n.indexOf(this.selectedMutant) : -1) + 1;
			n[r] ? (this.#s(n[r]), xr()) : this.selectedMutant && (this.#s(this.selectedMutant), xr());
		}
	};
	render() {
		let e = Map.groupBy(this.mutants, (e) => e.location.start.line), n = this.#o(Array.from(e.entries()).filter(([e]) => e > this.lines.length).flatMap(([, e]) => e));
		return t`<mte-state-filter
        allow-toggle-all
      ...
      >
        <code class="flex language-${this.model.language}">
          <table>${g(this.lines, (t, i) => {
			let a = i + 1;
			return ur(t, lr(this.#o(e.get(a)), this.lines.length === a ? n : r));
		})}</table>
          </code>
          </pre>`;
	}
	#i = () => {
		let e = this.selectedMutant ? (this.mutants.indexOf(this.selectedMutant) + 1) % this.mutants.length : 0;
		this.mutants[e] && this.#s(this.mutants[e]);
	};
	#a = () => {
		let e = this.selectedMutant ? (this.mutants.indexOf(this.selectedMutant) + this.mutants.length - 1) % this.mutants.length : this.mutants.length - 1;
		this.mutants[e] && this.#s(this.mutants[e]);
	};
	#o(e) {
		return d(e?.length, () => _(e, (e) => e.id, (e) => i`<svg
              data-mutant-id="${e.id}"
            ...
            >
              <title>${br(e)}</title>
              ${this.selectedMutant?.id === e.id ? hr : gr}
            </svg>`), () => r);
	}
	#s(e) {
		if (this.#c(), this.#f(e), this.selectedMutant === e) {
			this.selectedMutant = void 0, this.dispatchEvent(L("mutant-selected", {
				selected: !1,
				mutant: e
			}));
			return;
		} else this.selectedMutant && this.#f(this.selectedMutant);
		this.selectedMutant = e;
		let t = this.code.querySelectorAll("tr.line");
		for (let n = e.location.start.line - 1; n < e.location.end.line; n++) t.item(n).classList.add(vr);
		let n = this.#d(e), r = t.item(e.location.end.line - 1);
		r.insertAdjacentHTML("afterend", n), Yn(r), this.dispatchEvent(L("mutant-selected", {
			selected: !0,
			mutant: e
		}));
	}
	#c() {
		let e = this.code;
		e.querySelectorAll(`.${vr}`).forEach((e) => e.classList.remove(vr)), e.querySelectorAll(`.${yr}`).forEach((e) => e.remove());
	}
	reactivate() {
		super.reactivate(), this.#l();
	}
	update(e) {
		e.has("model") && this.model && this.#l(), (e.has("model") && this.model || e.has("selectedMutantStates")) && (this.mutants = this.model.mutants.filter((e) => this.selectedMutantStates.includes(e.status)).sort((e, t) => sr(e.location.start, t.location.start) ? 1 : -1), this.selectedMutant && !this.mutants.includes(this.selectedMutant) && e.has("selectedMutantStates") && this.#u(e.get("selectedMutantStates") ?? []) && this.#s(this.selectedMutant)), super.update(e);
	}
	#l() {
		this.filters = [
			"Killed",
			...
			"CompileError",
			"RuntimeError"
		].filter((e) => this.model.mutants.some((t) => t.status === e)).map((e) => ({
			enabled: [
			...
			count: this.model.mutants.filter((t) => t.status === e).length,
			status: e,
			label: t`${Wn(e)} ${e}`,
			context: Vn(e)
		}));
		let e = rr(this.model.source, this.model.name), n = /* @__PURE__ */ new Set(), r = new Set(this.model.mutants);
		this.lines = ir(e, function* (e) {
			for (let t of n) sr(e, t.location.end) && (n.delete(t), yield {
				elementName: "span",
				id: t.id,
				isClosing: !0
			});
			for (let t of r) sr(e, t.location.start) && (n.add(t), r.delete(t), yield {
				elementName: "span",
				id: t.id,
				attributes: {
					class: Gn(`mutant border-none ${t.status}`),
					title: Gn(br(t)),
					"data-mutant-id": Gn(t.id.toString())
				}
			});
		});
	}
	#u(e) {
		return e.length === this.selectedMutantStates.length ? !e.every((e, t) => this.selectedMutantStates[t] === e) : !0;
	}
	#d(e) {
		let t = e.getMutatedLines().trimEnd(), [n, r] = or(e.getOriginalLines().trimEnd(), t), i = ir(rr(t, this.model.name), function* ({ offset: e }) {
			e === n ? yield {
				elementName: "span",
				id: "diff-focus",
		...
		}), a = `<tr class="${yr}"><td class="empty-line-number"></td><td class="line-marker"></td><td class="code">`;
		return i.map((e) => `${a}${e}</td></tr>`).join("");
	}
	#f(e) {
		_r(this.code, "data-mutant-id", e.id);
	}
};
V([l()], q.prototype, "filters", void 0), V([s({ attribute: !1 })], q.prototype, "model", void 0), V([l()], q.prototype, "selectedMutantStates", void 0), V([l()], q.prototype, "selectedMutant", void 0), V([l()], q.prototype, "lines", void 0), V([l()], q.prototype, "mutants", void 0), V([c("code")], q.prototype, "code", void 0), q = V([o("mte-file")], q);
function br(e) {
...
//#endregion
//#region ../../node_modules/.pnpm/fuzziersort@4.0.2/node_modules/fuzziersort/dist/fuzziersort.js
var Sr = (e, t, n) => {
	if (!e) return n?.all ? Pr(t, n) : ei;
	var r = Nr(e), i = r.bitflags, a = r.containsSpace, o = Ar(n?.threshold || 0), s = n?.limit || $r, c = 0, l = 0, u = t.length;
	function d(e) {
		c < s ? (ni.add(e), ++c) : (++l, e._score > ni.peek()._score && ni.replaceTop(e));
	}
	if (n?.key) for (var f = n.key, p = 0; p < u; ++p) {
		var m = t[p], h = Zr(m, f);
		if (h && (Qr(h) || (h = Mr(h)), (i & h._bitflags) === i)) {
			var g = Ir(r, h);
			g !== Z && (g._score < o || (g.obj = m, d(g)));
		}
	}
	else if (n?.keys) {
		var _ = n.keys, v = _.length;
		outer: for (var p = 0; p < u; ++p) {
			for (var m = t[p], y = 0, b = 0; b < v; ++b) {
				var f = _[b], h = Zr(m, f);
				if (!h) {
					Jr[b] = ti;
					continue;
				}
				Qr(h) || (h = Mr(h)), Jr[b] = h, y |= h._bitflags;
			}
			if ((i & y) === i) {
				if (a) for (let e = 0; e < r.spaceSearches.length; e++) Y[e] = X;
				for (var b = 0; b < v; ++b) {
					if (h = Jr[b], h === ti) {
						Yr[b] = ti;
						continue;
					}
					if (Yr[b] = Ir(r, h, !1, a), Yr[b] === Z) {
						Yr[b] = ti;
						continue;
					}
					if (a) for (let e = 0; e < r.spaceSearches.length; e++) {
						if (qr[e] > -1e3 && Y[e] > X) {
							var x = (Y[e] + qr[e]) / 4;
							x > Y[e] && (Y[e] = x);
						}
				...
				if (a) {
					for (let e = 0; e < r.spaceSearches.length; e++) if (Y[e] === X) continue outer;
				} else {
					var S = !1;
					for (let e = 0; e < v; e++) if (Yr[e]._score !== X) {
						S = !0;
						break;
					}
					if (!S) continue;
				...
				var C = new Dr(v);
				for (let e = 0; e < v; e++) C[e] = Yr[e];
				if (a) {
					var w = 0;
					for (let e = 0; e < r.spaceSearches.length; e++) w += Y[e];
				} else {
					var w = X;
					for (let e = 0; e < v; e++) {
						var g = C[e];
						...
						g._score > w && (w = g._score);
					}
				}
				if (C.obj = m, C._score = w, n?.scoreFn) {
					if (w = n.scoreFn(C), !w) continue;
					w = Ar(w), C._score = w;
				}
				w < o || d(C);
			}
		}
	} else for (var p = 0; p < u; ++p) {
		var h = t[p];
		if (h && (Qr(h) || (h = Mr(h)), (i & h._bitflags) === i)) {
			var g = Ir(r, h);
			g !== Z && (g._score < o || d(g));
	...
	if (c === 0) return ei;
	for (var T = Array(c), p = c - 1; p >= 0; --p) T[p] = ni.poll();
	return T.total = c + l, T;
}, Cr = (e, t = "<b>", n = "</b>") => {
	for (var r = typeof t == "function" ? t : void 0, i = e.target, a = i.length, o = e.indexes, s = "", c = 0, l = 0, u = !1, d = [], f = 0; f < a; ++f) {
		var p = i[f];
		if (o[l] === f) {
			if (++l, u || (u = !0, r ? (d.push(s), s = "") : s += t), l === o.length) {
				r ? (s += p, d.push(r(s, c++)), s = "", d.push(i.substr(f + 1))) : s += p + n + i.substr(f + 1);
				break;
			}
		} else u && (u = !1, r ? (d.push(r(s, c++)), s = "") : s += n);
		s += p;
	}
	return r ? d : s;
}, wr = (e) => {
	...
	get score() {
		return kr(this._score);
	}
	set score(e) {
		this._score = Ar(e);
	}
}, Dr = class extends Array {
	get score() {
		return kr(this._score);
	}
	set score(e) {
	...
	let n = new Er();
	return n.target = e, n.obj = t.obj ?? Z, n._score = t._score ?? X, n._indexes = t._indexes ?? [], n._targetLower = t._targetLower ?? "", n._targetLowerCodes = t._targetLowerCodes ?? Z, n._nextBeginningIndexes = t._nextBeginningIndexes ?? Z, n._bitflags = t._bitflags ?? 0, n;
}, kr = (e) => e === X ? 0 : e > 1 ? e : Math.E ** (((-e + 1) ** .04307 - 1) * -2), Ar = (e) => e === 0 ? X : e > 1 ? e : 1 - (Math.log(e) / -2 + 1) ** (1 / .04307), jr = (e) => {
	typeof e == "number" ? e = "" + e : typeof e != "string" && (e = ""), e = e.trim();
	var t = Br(e), n = [];
	if (t.containsSpace) {
		var r = e.split(/\s+/);
		r = [...new Set(r)];
		for (var i = 0; i < r.length; i++) if (r[i] !== "") {
			var a = Br(r[i]);
			n.push({
				lowerCodes: a.lowerCodes,
				_lower: r[i].toLowerCase(),
				containsSpace: !1
			});
		}
	}
	...
	if (e.length > 999) return wr(e);
	var t = Ur.get(e);
	return t === void 0 ? (t = wr(e), Ur.set(e, t), t) : t;
}, Nr = (e) => {
	if (e.length > 999) return jr(e);
	var t = Wr.get(e);
	return t === void 0 ? (t = jr(e), Wr.set(e, t), t) : t;
}, Pr = (e, t) => {
	var n = [];
	n.total = e.length;
	var r = t?.limit || $r;
	if (t?.key) for (var i = 0; i < e.length; i++) {
		var a = e[i], o = Zr(a, t.key);
		if (o != Z) {
			Qr(o) || (o = Mr(o));
			var s = Or(o.target, {
				_score: o._score,
			...
			if (n.push(s), n.length >= r) return n;
		}
	}
	else if (t?.keys) for (var i = 0; i < e.length; i++) {
		for (var a = e[i], c = new Dr(t.keys.length), l = t.keys.length - 1; l >= 0; --l) {
			var o = Zr(a, t.keys[l]);
			if (!o) {
				c[l] = ti;
				continue;
			}
			Qr(o) || (o = Mr(o)), o._score = X, o._indexes.len = 0, c[l] = o;
		}
		if (c.obj = a, c._score = X, n.push(c), n.length >= r) return n;
	}
	else for (var i = 0; i < e.length; i++) {
		var o = e[i];
		if (o != Z && (Qr(o) || (o = Mr(o)), o._score = X, o._indexes.len = 0, n.push(o), n.length >= r)) return n;
	}
	return n;
}, Fr = (e, t, n, r, i, a, o) => {
	for (var s = 0, c = 0, l = 1; l < e; ++l) n[l] - n[l - 1] !== 1 && (s -= n[l], ++c);
	var u = n[e - 1] - n[0] - (e - 1);
	if (s -= (12 + u) * c, n[0] !== 0 && (s -= n[0] * n[0] * .2), !r) s *= 1e3;
	else {
		for (var d = 1, l = i[0]; l < t; l = i[l]) ++d;
		d > 24 && (s *= (d - 24) * 10);
	}
	return s -= (t - e) / 2, a && (s /= 1 + e * e * 1), o && (s /= 1 + e * e * 1), s -= (t - e) / 2, s;
}, Ir = (e, t, n = !1, r = !1) => {
	if (n === !1 && e.containsSpace) return Rr(e, t, r);
	for (var i = e._lower, a = e.lowerCodes, o = a[0], s = t._targetLowerCodes, c = a.length, l = s.length, u = 0, d = 0, f = 0;;) {
		var p = o === s[d];
		if (p) {
			if (J[f++] = d, ++u, u === c) break;
			o = a[u];
		}
		if (++d, d >= l) return Z;
	}
	var u = 0, m = !1, h = 0, g = t._nextBeginningIndexes;
	g === Z && (g = t._nextBeginningIndexes = Hr(t.target)), d = J[0] === 0 ? 0 : g[J[0] - 1];
	var _ = 0;
	if (d !== l) for (;;) if (d >= l) {
		if (u <= 0 || (++_, _ > 200)) break;
		--u;
		var v = Gr[--h];
		d = g[v];
	} else {
	...
	var y = c <= 1 ? -1 : t._targetLower.indexOf(i, J[0]), b = !!~y, x = b ? y === 0 || t._nextBeginningIndexes[y - 1] === y : !1;
	if (b && !x) {
		for (var S = 0; S < g.length; S = g[S]) if (!(S <= y)) {
			for (var C = 0; C < c && a[C] === t._targetLowerCodes[S + C]; C++);
			if (C === c) {
				y = S, x = !0;
				break;
			}
	...
	if (!m) {
		if (b) for (var S = 0; S < c; ++S) J[S] = y + S;
		var w = J, T = Fr(c, l, w, m, g, b, x);
	} else if (x) {
		for (var S = 0; S < c; ++S) J[S] = y + S;
		var w = J, T = Fr(c, l, J, m, g, b, x);
	} else var w = Gr, T = Fr(c, l, Gr, m, g, b, x);
	t._score = T;
	for (var S = 0; S < c; ++S) t._indexes[S] = w[S];
	t._indexes.len = c;
	let E = new Er();
	return E.target = t.target, E._score = t._score, E._indexes = t._indexes, E;
}, Lr = (e, t) => {
	for (let n = t - 1; n >= 0; n--) e._nextBeginningIndexes[Kr[n * 2 + 0]] = Kr[n * 2 + 1];
}, Rr = (e, t, n) => {
	var r = Xr;
	r.clear();
	for (var i = 0, a = Z, o = 0, s = e.spaceSearches, c = s.length, l = 0, u = !1, d = 0; d < c; ++d) {
		qr[d] = X;
		var f = s[d];
		if (a = Ir(f, t), n) {
			if (a === Z) continue;
			u = !0;
		} else if (a === Z) return Lr(t, l), Z;
		if (d !== c - 1) {
			var p = a._indexes, m = !0;
			for (let e = 0; e < p.len - 1; e++) if (p[e + 1] - p[e] !== 1) {
				m = !1;
				break;
			}
			if (m) {
				var h = p[p.len - 1] + 1, g = t._nextBeginningIndexes[h - 1];
				for (let e = h - 1; e >= 0 && g === t._nextBeginningIndexes[e]; e--) t._nextBeginningIndexes[e] = h, Kr[l * 2 + 0] = e, Kr[l * 2 + 1] = g, l++;
			}
		}
		i += a._score / c, qr[d] = a._score / c, a._indexes[0] < o && (i -= (o - a._indexes[0]) * 2), o = a._indexes[0];
		for (var _ = 0; _ < a._indexes.len; ++_) r.add(a._indexes[_]);
	}
	if (n && !u) return Z;
	Lr(t, l);
	var v = Ir(e, t, !0);
	if (v !== Z && v._score > i) {
		if (n) for (var d = 0; d < c; ++d) qr[d] = v._score / c;
		return v;
	}
	n && (a = t), a._score = i;
	var d = 0;
	for (let e of r) a._indexes[d++] = e;
	return a._indexes.len = d, a;
}, zr = (e) => e.replace(/\p{Script=Latin}+/gu, (e) => e.normalize("NFD")).replace(/[\u0300-\u036f]/g, ""), Br = (e) => {
	e = zr(e);
	for (var t = e.length, n = e.toLowerCase(), r = [], i = 0, a = !1, o = 0; o < t; ++o) {
		var s = r[o] = n.charCodeAt(o);
		if (s === 32) {
			a = !0;
			continue;
		}
		var c = s >= 97 && s <= 122 ? s - 97 : s >= 48 && s <= 57 ? 26 : s <= 127 ? 30 : 31;
		i |= 1 << c;
	}
	return {
		lowerCodes: r,
	...
	for (var t = e.length, n = [], r = 0, i = !1, a = !1, o = 0; o < t; ++o) {
		var s = e.charCodeAt(o), c = s >= 65 && s <= 90, l = c || s >= 97 && s <= 122 || s >= 48 && s <= 57, u = c && !i || !a || !l;
		i = c, a = l, u && (n[r++] = o);
	}
	return n;
}, Hr = (e) => {
	e = zr(e);
	for (var t = e.length, n = Vr(e), r = [], i = n[0], a = 0, o = 0; o < t; ++o) i > o ? r[o] = i : (i = n[++a], r[o] = i === void 0 ? t : i);
	return r;
}, Ur = /* @__PURE__ */ new Map(), Wr = /* @__PURE__ */ new Map(), J = [], Gr = [], Kr = [], Y = [], qr = [], Jr = [], Yr = [], Xr = /* @__PURE__ */ new Set(), Zr = (e, t) => {
	var n = e[t];
	if (n !== void 0) return n;
	if (typeof t == "function") return t(e);
	var r = t;
	Array.isArray(t) || (r = t.split("."));
	for (var i = r.length, a = -1; e && ++a < i;) e = e[r[a]];
	return e;
}, Qr = (e) => typeof e == "object" && typeof e._bitflags == "number", $r = Infinity, X = -Infinity, ei = [];
ei.total = 0;
var Z = null, ti = wr(""), ni = ((e) => {
	var t = [], n = 0, r = {}, i = (e) => {
		for (var r = 0, i = t[r], a = 1; a < n;) {
			var o = a + 1;
			r = a, o < n && t[o]._score < t[a]._score && (r = o), t[r - 1 >> 1] = t[r], a = 1 + (r << 1);
		}
		for (var s = r - 1 >> 1; r > 0 && i._score < t[s]._score; s = (r = s) - 1 >> 1) t[r] = t[s];
		t[r] = i;
	};
	return r.add = ((e) => {
		var r = n;
		t[n++] = e;
		for (var i = r - 1 >> 1; r > 0 && e._score < t[i]._score; i = (r = i) - 1 >> 1) t[r] = t[i];
		t[r] = e;
	}), r.poll = ((e) => {
		if (n !== 0) {
			var r = t[0];
	...
	constructor() {
		super(), this.fileIndex = 0, this.filteredFiles = [];
	}
	connectedCallback() {
		super.connectedCallback(), this.#n = document.body.style.overflow, window.addEventListener("keydown", this.#o, { signal: this.#e.signal });
	}
	disconnectedCallback() {
		super.disconnectedCallback(), Tr(), this.#e.abort();
	}
	willUpdate(e) {
		e.has("rootModel") && (this.#a(), this.#m(""));
	}
	updated(e) {
		(e.has("fileIndex") || e.has("filteredFiles")) && this.#s();
	}
	open = () => {
    ...
    >
      <div @click=${(e) => e.stopPropagation()} class="flex h-fit max-h-132 flex-col rounded-lg bg-gray-200/60 p-4 backdrop-blur-lg">
        <div class="mb-3 flex items-center rounded-sm bg-gray-200/60 p-2 text-gray-800 shadow-lg">
          <div class="mx-2 flex items-center">${ai}</div>
	...
	#r() {
		return t`<ul id="files" tabindex="-1" class="flex snap-y flex-col gap-2 overflow-auto" role="listbox" aria-labelledby="file-picker-label">
      ${this.filteredFiles.length === 0 ? t`<li class="text-gray-800">No files found</li>` : _(this.filteredFiles, (e) => e.name, ({ name: e, file: n, template: r }, i) => {
			let a = this.#h(n);
			return t`<li
      ...
      ${d(this.moreFilesMessage, (e) => t`<li class="p-2 text-sm text-gray-800" role="presentation">${e}</li>`)}
    </ul>`;
	}
	#i(e) {
		return e === H.mutant ? oi : si;
	}
	#a() {
		...
		let e = (t, n = null, r) => {
			if (t) {
				...
				t.childResults.forEach((i) => {
					n !== r && n && t.name ? e(i, `${n}/${t.name}`, r) : (n === r || !n) && t.name !== r ? e(i, t.name, r) : e(i, null, r);
				});
			}
		};
	...
	#o = (e) => {
		((e.ctrlKey || e.metaKey) && e.key === "k" || !this.isOpen && e.key === "/") && this.#d(e), this.isOpen && (e.key === "ArrowUp" ? this.#l() : e.key === "ArrowDown" && this.#c(), e.key === "Enter" && this.#u());
	};
	#s() {
	...
	#u() {
		...
		let e = this.filteredFiles[this.fileIndex];
		window.location.href = Kn(this.#h(e.file), e.name), this.close();
	}
	#d = (e = null) => {
		e?.preventDefault(), e?.stopPropagation(), this.isOpen ? this.close() : this.open();
	};
	#f = (e) => {
		e.newState === "closed" ? (this.#m(""), this.filePickerInput.value = "", document.body.style.overflow = this.#n) : e.newState === "open" ? document.body.style.overflow = "hidden" : console.warn("Unknown toggle state in file-picker:", e.newState);
	};
	#p = (e) => {
		this.isOpen && this.#m(e.target.value);
	};
	#m(e) {
		if (!e) this.#t.length > di ? (this.filteredFiles = this.#t.slice(0, di), this.moreFilesMessage = `…and ${this.#t.length - di} more files — type to search`) : (this.filteredFiles = this.#t, this.moreFilesMessage = void 0);
		else {
			let n = Sr(e, this.#t, {
				key: "prepared",
				threshold: .3,
			...
			this.moreFilesMessage = n.length > di ? "More matches available — refine your search" : void 0, this.filteredFiles = n.slice(0, di).map((e) => ({
				file: e.obj.file,
				name: e.obj.name,
				template: e.highlight((e) => t`<mark class="bg-inherit text-primary-500 group-aria-selected:text-primary-50 group-aria-selected:underline">${e}</mark>`)
			}));
		}
		this.fileIndex = 0;
	}
	#h(e) {
		return e instanceof de ? H.test : H.mutant;
	}
};
V([s({ attribute: !1 })], Q.prototype, "rootModel", void 0), V([l()], Q.prototype, "filteredFiles", void 0), V([l()], Q.prototype, "fileIndex", void 0), V([l()], Q.prototype, "moreFilesMessage", void 0), V([c("dialog", !0)], Q.prototype, "dialog", void 0), V([c("#file-picker-input", !0)], Q.prototype, "filePickerInput", void 0), V([c("[aria-selected=\"true\"] a")], Q.prototype, "activeLink", void 0), Q = V([o("mte-file-picker")], Q);
//#endregion
//#region src/components/breadcrumb.ts
var fi = class extends z {
	get rootName() {
		switch (this.view) {
			case H.mutant: return "All files";
			case H.test: return "All tests";
		}
	}
	render() {
		return t`<nav class="my-4 flex rounded-md bg-primary-100 p-3 text-gray-700" aria-label="Breadcrumb">
	...
	#e() {
		if (this.path) {
			let e = this.path;
			return _(e, (e) => e, (t, n) => n === e.length - 1 ? this.#t(t) : this.#n(t, e.slice(0, n + 1)));
		}
	}
	#t(e) {
		return t`<li aria-current="page">
      <span class="ml-1 text-sm font-medium text-gray-800 md:ml-2">${e}</span>
    </li>`;
	}
	#n(e, n) {
		return t`<li class="after:text-gray-800 after:content-['/'] md:after:pl-1">
      <a
        href=${Kn(this.view, ...n)}
	...
	#r() {
		return t`<button @click=${() => this.#i()} class="ml-auto cursor-pointer" title="Open file picker (Ctrl-K)"
      >${ai}</button
    >`;
	}
	#i() {
		this.blur(), this.renderRoot.querySelector("button")?.blur(), this.dispatchEvent(L("mte-file-picker-open", void 0));
	}
};
V([s({
	type: Array,
	attribute: !1
})], fi.prototype, "path", void 0), V([s()], fi.prototype, "view", void 0), fi = V([o("mte-breadcrumb")], fi);
//#endregion
//#region src/components/state-filter/state-filter.component.ts
var pi = class extends U {
	updated(e) {
		e.has("filters") && this.#t();
	}
	#e(e, t) {
		e.enabled = t, this.#t();
	}
	#t() {
		this.dispatchEvent(L("filters-changed", this.filters.filter(({ enabled: e }) => e).map(({ status: e }) => e)));
	}
	#n = (e) => {
		e.stopPropagation(), this.dispatchEvent(L("next", void 0, {
			bubbles: !0,
			composed: !0
		}));
	};
	#r = (e) => {
		e.stopPropagation(), this.dispatchEvent(L("previous", void 0, {
			bubbles: !0,
			composed: !0
		}));
	};
	render() {
		return t`<div class="sticky top-offset z-10 mb-1 flex flex-row gap-5 bg-white py-6 pt-7">
      <div class="flex items-center gap-2">
        ${this.#i(this.#r, li, "Previous", "Select previous mutant")}
        ${this.#i(this.#n, ui, "Next", "Select next mutant")}
      </div>

      ${_(this.filters ?? [], (e) => e.status, (e) => t`<div class="flex items-center gap-2 last:mr-12" data-status=${e.status.toString()}>
            <input
              ?checked=${e.enabled}
              id="filter-${e.status}"
...
var gi = ({ hasDetail: e, mode: n }, r) => t`<mte-drawer
  ...
  >
    ${r}
  </mte-drawer>`, _i = (e) => `${e.name}${e.sourceFile && e.location ? ` (${Jn(e)})` : ""}`, vi = (e) => t`<span class="whitespace-pre-wrap">${e}</span>`, yi = class extends U {
	constructor() {
		super(), this.mode = "closed";
	}
	render() {
		let e = this.mutant?.killedByTests, n = this.mutant?.coveredByTests;
		return gi({
			hasDetail: !!(e?.length || n?.length || this.mutant?.statusReason),
			mode: this.mode
		}, d(this.mutant, (r) => t`<span class="align-middle text-lg" slot="header"
              >${Wn(r.status)} ${r.mutatorName} ${r.status}
              (${r.location.start.line}:${r.location.start.column})</span
            >
            <span slot="summary">${this.#e(e, n)}</span>
            <span slot="detail" class="block">${this.#t(e, n)}</span>`));
	}
	#e(e, n) {
		return Rn(t`${d(e?.[0], (n) => Ln(t`${B("🎯", "killed")} Killed by:
          ${n.name}${e.length > 1 ? `(and ${e.length - 1} more)` : ""}`))}
      ${d(this.mutant?.static, () => Ln(t`${B("🗿", "static")} Static mutant`))}
      ${d(n, (e) => Ln(t`${B("☂️", "umbrella")} Covered by ${e.length}
          test${qn(e)}${this.mutant?.status === "Survived" ? " (yet still survived)" : ""}`))}
      ${d(this.mutant?.statusReason?.trim(), (e) => Ln(t`${B("🕵️", "spy")} ${vi(e)}`, `Reason for the ${this.mutant.status} status`))}
      ${d(this.mutant?.description, (e) => Ln(t`${B("📖", "book")} ${vi(e)}`))}`);
	}
	#t(e, n) {
		let r = new Set(e);
		return t`<ul class="mr-2 mb-6">
      ${g(e, (e) => In("This mutant was killed by this test", t`${B("🎯", "killed")} ${_i(e)}`))}
      ${g(n?.filter((e) => !r.has(e)), (e) => In("This mutant was covered by this test", t`${B("☂️", "umbrella")} ${_i(e)}`))}
    </ul>`;
	}
};
V([s({ attribute: !1 })], yi.prototype, "mutant", void 0), V([s({ reflect: !0 })], yi.prototype, "mode", void 0), yi = V([o("mte-drawer-mutant")], yi);
//#endregion
//#region src/components/mutant-view/mutant-view.ts
var bi = class extends U {
	constructor() {
	...
	render() {
		return t`<main class="pb-drawer-half-open" @click=${this.#e}>
        <mte-metrics-table .columns=${xi} .currentPath=${this.path} .thresholds=${this.thresholds} .model=${this.result}> </mte-metrics-table>
        ${d(this.result.file, (e) => t`<mte-file @mutant-selected=${this.#t} .model=${e}></mte-file>`)}
      </main>
      <mte-drawer-mutant mode=${this.drawerMode} .mutant=${this.selectedMutant}></mte-drawer-mutant>`;
	}
};
V([l()], bi.prototype, "drawerMode", void 0), V([s({ attribute: !1 })], bi.prototype, "selectedMutant", void 0), V([s({ attribute: !1 })], bi.prototype, "result", void 0), V([s({
	attribute: !1,
	reflect: !1
})], bi.prototype, "thresholds", void 0), V([s({
	attribute: !1,
	reflect: !1
})], bi.prototype, "path", void 0), bi = V([o("mte-mutant-view")], bi);
var xi = [
	{
		key: "mutationScore",
		label: "Of total",
	...
	render() {
		return t`<main class="pb-drawer-half-open" @click=${this.#e}>
        <mte-metrics-table .columns=${Ci} .currentPath=${this.path} .model=${this.result}> </mte-metrics-table>
        ${d(this.result.file, (e) => t`<mte-test-file @test-selected=${this.#t} .model=${e}></mte-test-file>`)}
      </main>
      <mte-drawer-test mode=${this.drawerMode} .test=${this.selectedTest}></mte-drawer-test>`;
	}
};
V([l()], Si.prototype, "drawerMode", void 0), V([s({ attribute: !1 })], Si.prototype, "result", void 0), V([s({
	attribute: !1,
	reflect: !1
})], Si.prototype, "path", void 0), V([s({ attribute: !1 })], Si.prototype, "selectedTest", void 0), Si = V([o("mte-test-view")], Si);
var Ci = [
	{
		key: "killing",
		label: "Killing",
	...
	#e = !1;
	willUpdate(e) {
		e.has("columns") && (this.#e = this.columns.some((e) => e.category === "percentage"));
	}
	render() {
		return d(this.model, (e) => t`<div class="overflow-x-auto rounded-md border border-gray-200">
          <table class="w-full table-auto text-left text-sm">${this.#t()}${this.#r(e)} </table>
        </div>`);
	}
	#t() {
		let e = this.columns.filter((e) => e.group !== "Mutation score"), n = this.columns.filter((e) => e.group === "Mutation score");
		return t`<thead class="border-b border-gray-200 text-center text-sm">
      <tr>
        ...
        ${n.length > 0 ? t`<th colspan="4" class="px-2 even:bg-gray-100">Mutation Score</th>` : ""}
        ${_(e, (e) => e.key, (e) => this.#n(e))}
      </tr>
      <tr>
        ${_(n, (e) => e.key, (e) => this.#n(e))}
      </tr>
    </thead>`;
	}
	#n(e) {
		let n = `tooltip-${e.key.toString()}`, r = e.tooltip ? t`<mte-tooltip title=${e.tooltip} id=${n}>${e.label}</mte-tooltip>` : t`<span id=${n}>${e.label}</span>`;
		return e.group ? t`<th colspan="2" class="bg-gray-200 px-2"> ${r} </th>` : t`<th rowspan="2" class="w-24 px-2 even:bg-gray-100 2xl:w-28">
      <div class="inline-block">${r}</div>
    </th>`;
	}
	#r(e) {
		return t`<tbody class="divide-y divide-gray-200">${this.#i(e.name, e)} ${d(!e.file, () => _(e.childResults, (e) => e.name, (e) => {
			let t = [e.name];
			for (; !e.file && e.childResults.length === 1;) e = e.childResults[0], t.push(e.name);
			return this.#i(t.join("/"), e, ...this.currentPath, ...t);
		}))}</tbody>`;
	}
	#i(e, n, ...r) {
		return t`<tr title=${n.name} class="group hover:bg-gray-200">
      <td class="font-semibold">
        <div class="flex items-center justify-start">
          <mte-file-icon file-name=${n.name} ?file=${n.file} class="mx-1 flex items-center"></mte-file-icon> ${r.length > 0 ? t`<a class="mr-auto inline-block w-full py-4 pr-2 hover:text-primary-on hover:underline" href=${Kn(...r)}
                  >${e}</a
                >` : t`<span class="py-4">${n.name}</span>`}
        </div>
      </td>
      ${_(this.columns, (e) => e.key, (e) => this.#a(e, n.metrics))}
    </tr>`;
	}
	#a(e, n) {
		let r = n[e.key], i = this.#e ? "odd:bg-gray-100" : "even:bg-gray-100";
		if (e.category === "percentage") {
			let n = !isNaN(r), a = this.#o(r), o = this.#s(r), s = r.toFixed(2), c = `width: ${r}%`;
			return t`<td class="bg-gray-100 px-4 py-4 group-hover:bg-gray-200!">
          ${n ? t`<div class="h-3 w-full min-w-[24px] rounded-full bg-gray-300">
                  <div
                    ...
                    style=${c}
                  ></div>
                </div>` : t`<span class="text-light-muted font-bold">N/A</span>`}
        </td>
        <td class="${o} ${i} w-12 pr-2 text-center font-bold group-hover:bg-gray-200!"
          >${d(n, () => t`<span class="transition-colors">${s}</span>`)}</td
        >`;
		}
		return t`<td
      class="${h({
...
V([s({ attribute: !1 })], wi.prototype, "model", void 0), V([s({ attribute: !1 })], wi.prototype, "currentPath", void 0), V([s({ type: Array })], wi.prototype, "columns", void 0), V([s({ attribute: !1 })], wi.prototype, "thresholds", void 0), wi = V([o("mte-metrics-table")], wi);
//#endregion
//#region src/components/test-file/test-file.css?inline
var Ti = "#report-code-block{background:var(--prism-background);border:1px solid var(--prism-border);overflow:auto visible}.line-numbers{counter-reset:mte-line-number}.line .line-number{text-align:right;color:var(--mut-line-number);counter-increment:mte-line-number;padding:0 10px 0 15px}.line .line-number:before{content:counter(mte-line-number)}.line-marker:before{content:\" \";padding:0 5px}.Killing{--mut-test-dot-color:var(--color-green-700)}.Covering{--mut-test-dot-color:var(--color-amber-400)}.NotCovering{--mut-test-dot-color:var(--color-orange-500)}svg.test-dot{fill:var(--mut-test-dot-color)}", $ = class extends U {
	static styles = [
		Fn,
		R,
		a(Ti)
	...
	#e;
	constructor() {
		super(), this.filters = [], this.lines = [], this.enabledStates = [], this.tests = [], this.#e = new AbortController();
	}
	connectedCallback() {
		super.connectedCallback(), window.addEventListener("keydown", this.#t, { signal: this.#e.signal });
	}
	...
	#n = (e) => {
		this.enabledStates = e.detail, this.selectedTest && !this.enabledStates.includes(this.selectedTest.status) && this.#r(this.selectedTest);
	};
	#r(e) {
		this.#f(e), this.selectedTest === e ? (this.selectedTest = void 0, this.dispatchEvent(L("test-selected", {
			selected: !1,
			test: e
		}))) : (this.selectedTest && this.#f(this.selectedTest), this.selectedTest = e, this.dispatchEvent(L("test-selected", {
			selected: !0,
			test: e
		})), Yn(this.renderRoot.querySelector(`[data-test-id="${e.id}"]`)));
	}
	#i = () => {
		let e = this.selectedTest ? (this.tests.findIndex(({ id: e }) => e === this.selectedTest.id) + 1) % this.tests.length : 0;
		this.#o(this.tests[e]);
	};
	#a = () => {
		let e = this.selectedTest ? (this.tests.findIndex(({ id: e }) => e === this.selectedTest.id) + this.tests.length - 1) % this.tests.length : this.tests.length - 1;
		this.#o(this.tests[e]);
	};
	#o(e) {
		e && this.#r(e);
	...
	#s() {
		let e = this.tests.filter((e) => !e.location);
		return d(e.length, () => t`<ul class="max-w-6xl">
          ${_(e, (e) => e.id, (e) => t`<li class="my-3">
                <button
                  ...
                  data-test-id=${e.id}
                  @click=${(t) => {
			t.stopPropagation(), this.#r(e);
		}}
                  >${Un(e.status)} ${e.name} [${e.status}]
                </button>
              </li>`)}
        </ul>`, () => r);
	}
	#c() {
		return d(this.model?.source, () => {
			let e = Map.groupBy(this.tests.filter((e) => T(e.location)), (e) => e.location.start.line), n = this.#u(Array.from(e.entries()).filter(([e]) => e > this.lines.length).flatMap(([, e]) => e));
			return t`<pre
          id="report-code-block"
          @click=${this.#l}
          class="line-numbers flex rounded-md p-1"
        ><code class="flex language-${nr(this.model.name)}">
      <table>
        ${g(this.lines, (t, i) => {
				let a = i + 1;
				return ur(t, lr(this.#u(e.get(a)), this.lines.length === a ? n : r));
			})}</table></code></pre>`;
		}, () => r);
	}
	#l = () => {
		this.selectedTest && this.#r(this.selectedTest);
	};
	#u(e) {
		return d(e?.length, () => _(e, (e) => e.id, (e) => i`<svg
              data-test-id="${e.id}"
            ...
            >
              <title>${Ei(e)}</title>
              ${this.selectedTest === e ? hr : gr}
            </svg>`), () => r);
	}
	reactivate() {
		super.reactivate(), this.#d();
	}
	willUpdate(e) {
		e.has("model") && this.#d(), (e.has("model") || e.has("enabledStates")) && this.model && (this.tests = this.model.tests.filter((e) => this.enabledStates.includes(e.status)).sort((e, t) => e.location && t.location ? sr(e.location.start, t.location.start) ? 1 : -1 : this.model.tests.indexOf(e) - this.model.tests.indexOf(t)));
	}
	#d() {
...
var Mi = class {
	...
	#e;
	constructor() {
		super(), this.detected = 0, this.noCoverage = 0, this.pending = 0, this.survived = 0, this.total = 0, this.#e = new Mi(this, { callback: ([e]) => !e.isIntersecting });
	}
	render() {
		return t`${this.#t()}
	...
	#n(e) {
		return _(this.#r(), (e) => e.type, (n) => t`<div
          title=${e ? r : n.tooltip}
          ...
          >${e ? r : t`<span class="ms-3 font-bold text-gray-800">${n.amount}</span>`}
        </div>`);
	}
	#r() {
		return [
	...
	#i(e) {
		switch (e) {
			case "detected": return "bg-green-600";
			case "survived": return "bg-red-600";
			case "no coverage": return "bg-yellow-600";
			default: return "bg-gray-200";
		}
	}
	#a(e) {
		return this.total === 0 ? 0 : 100 * e / this.total;
	}
};
V([s({ type: Number })], Ni.prototype, "detected", void 0), V([s({
	type: Number,
	attribute: "no-coverage"
})], Ni.prototype, "noCoverage", void 0), V([s({ type: Number })], Ni.prototype, "pending", void 0), V([s({ type: Number })], Ni.prototype, "survived", void 0), V([s({ type: Number })], Ni.prototype, "total", void 0), Ni = V([o("mte-result-status-bar")], Ni);
//#endregion
export { W as MutationTestReportAppComponent };
