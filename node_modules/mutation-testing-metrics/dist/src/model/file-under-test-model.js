...
export class FileUnderTestModel extends SourceFile {
    ...
    getMutationLines(mutant) {
        ...
        return `${this.source.substring(start, start + mutant.location.start.column - 1)}${mutant.replacement ?? mutant.description ?? mutant.mutatorName}${this.source.substring(startOfEndLine + mutant.location.end.column - 1, end)}`;
    }
}
