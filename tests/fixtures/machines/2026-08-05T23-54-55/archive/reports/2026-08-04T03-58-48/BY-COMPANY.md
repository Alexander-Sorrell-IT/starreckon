...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,298,139,757 | 96.5% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 187 | 589h 55m | 37,063,321,470 | claude 36.63B, copilot 437.66M |
...
**40,298,139,757 tokens** (96.5% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,625,907,201 |
| `claude-opus-5` | 13,626,862,033 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,033,295,059 |
...
| codehunterextreme@gmail.com | 12,540,575,149 |
