...
| Account | Tokens | Share of machine |
|---|---:|---:|
| second@example.com | 5,547,678,789 | 57.8% |
| third@example.com | 2,564,843,440 | 26.7% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 14.7% |
| owner@example.com | 83,212,683 | 0.9% |
...
| `.claude-alt` | third@example.com | 11,440,918,343 | 2,564,843,440 | +8,876,074,903 | 2026-06-09 → 2026-07-11 |
