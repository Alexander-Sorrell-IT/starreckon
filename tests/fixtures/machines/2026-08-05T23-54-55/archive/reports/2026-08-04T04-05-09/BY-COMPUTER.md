...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,004,982,986 | 66.9% | ███████████████████········· |
| **HP Laptop Linux** | `hp-laptop-linux/` | 5 | 9,743,772,489 | 23.3% | ███████····················· |
...
```
Claude Code, per account (totals.json)  :   38,017,032,764
Claude Code, per session (sessions.json):   38,105,237,133
difference                              :      -88,204,369
non-Claude-Code CLIs, additional        :    5,148,328,352
```

**These should agree and differ by 88,204,369.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.

---

## MacBook Air M1

`macbook-air-m1/` · 3 account(s) · 53 sessions · 131,394 turns · **28,004,982,986 tokens** (66.9% of all Claude Code)
...
`hp-laptop-linux/` · 5 account(s) · 131 sessions · 51,517 turns · **9,743,772,489 tokens** (23.3% of all Claude Code)

### Accounts on this computer

| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 5,547,678,789 | 56.9% |
| codehunterextreme@gmail.com | 2,702,655,775 | 27.7% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 14.5% |
...
| Company | Tokens | Share |
|---|---:|---:|
| Anthropic | 8,297,820,473 | 85.2% |
| DeepSeek | 1,445,952,016 | 14.8% |
| — (no API call) | 0 | 0.0% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 131 | 225h 56m | 9,751,971,758 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 131 | 9,751,971,758 | 2026-05-04 → 2026-08-04 |
...
**It accounts for 15,481,069,116 tokens the transcripts can no longer see.**
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2,702,655,775 | +8,738,262,568 | 2026-06-09 → 2026-07-11 |
...
What the comparison does establish is a floor with a known shortfall: the transcript totals elsewhere in these reports are low by at least 15,481,069,116 on the scanned machines, and that figure is measured rather than estimated.
...
| HP Laptop Linux | 8.30B | 1.45B | **9,743,772,489** |
...
| **All** | **40.44B** | **1.45B** | **41,881,904,108** |
...
| HP Laptop Linux | 9.75B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | **11,551,621,952** |
| MacBook Air M1 | 28.08B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | **31,423,085,889** |
| **All** | **38.11B** | **2.47B** | **1.64B** | **793.53M** | **166.71M** | **76.72M** | **7.07M** | **43,253,565,485** |

---

## Sessions

530 sessions · 895h 46m active · 43,253,565,485 tokens
...
| 2026-07-30 | HP Laptop Linux | claude | 9h 58m | 851,143,353 | 2,765 | `claude-opus-5` |
...
| 2026-07-30 | 854,206,082 | 10h 19m |
