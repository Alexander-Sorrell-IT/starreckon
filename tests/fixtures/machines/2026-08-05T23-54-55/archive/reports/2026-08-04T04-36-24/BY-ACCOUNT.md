...
| **codehunterextreme@gmail.com** | 12,739,814,499 | 30.4% | 3 | 61 | 42,481 | █████████··················· |
...
| codehunterextreme@gmail.com | 9.95B | 2.76B | 26.78M | — | — | **12,739,814,499** |
...
| **All** | **28.00B** | **9.81B** | **3.86B** | **266.15M** | **2.13M** | **41,943,331,123** |
...
**12,739,814,499 tokens** (30.4%) · 61 sessions · 42,481 turns · 39 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 9,948,955,645 | 78.1% |
| HP Laptop Linux | 2,764,082,790 | 21.7% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 12,739,814,499 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,141,635 |
| `claude-opus-5` | 3,240,820,367 |
| `claude-fable-5` | 960,887,845 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,654,511 | 451,408,442 | 12,236,450,337 | 47,301,209 |
