...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,497,379,107 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 187 | 591h 15m | 37,150,664,986 | claude 36.71B, copilot 437.66M |
...
**40,497,379,107 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,625,907,201 |
| `claude-opus-5` | 13,775,026,954 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,084,369,488 |
...
| codehunterextreme@gmail.com | 12,739,814,499 |
