...
| **codehunterextreme@gmail.com** | 12,767,840,316 | 30.4% | 3 | 61 | 42,526 | █████████··················· |
...
| codehunterextreme@gmail.com | 9.95B | 2.79B | 26.78M | — | — | **12,767,840,316** |
...
| **All** | **28.00B** | **9.83B** | **3.86B** | **266.15M** | **2.13M** | **41,971,356,940** |
...
**12,767,840,316 tokens** (30.4%) · 61 sessions · 42,526 turns · 39 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 9,948,955,645 | 77.9% |
| HP Laptop Linux | 2,792,108,607 | 21.9% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 12,767,840,316 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,141,635 |
| `claude-opus-5` | 3,256,520,887 |
| `claude-fable-5` | 973,213,142 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,654,591 | 451,457,834 | 12,264,385,193 | 47,342,698 |
