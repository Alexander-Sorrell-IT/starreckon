...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,525,404,924 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 187 | 591h 41m | 37,179,194,879 | claude 36.74B, copilot 437.66M |
...
**40,525,404,924 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,625,907,201 |
| `claude-opus-5` | 13,790,727,474 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,096,694,785 |
...
| codehunterextreme@gmail.com | 12,767,840,316 |
