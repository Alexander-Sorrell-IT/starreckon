...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,539,458,364 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 187 | 591h 47m | 37,193,854,527 | claude 36.76B, copilot 437.66M |
...
**40,539,458,364 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,625,907,201 |
| `claude-opus-5` | 13,796,298,456 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,105,177,243 |
...
| codehunterextreme@gmail.com | 12,781,893,756 |
