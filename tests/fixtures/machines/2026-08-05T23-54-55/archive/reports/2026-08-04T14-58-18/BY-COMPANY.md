...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 40,791,009,214 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 189 | 595h 14m | 37,446,461,325 | claude 37.01B, copilot 437.66M |
...
**40,791,009,214 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,626,010,471 |
| `claude-opus-5` | 13,885,538,561 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,267,384,718 |
...
| codehunterextreme@gmail.com | 13,033,444,606 |
