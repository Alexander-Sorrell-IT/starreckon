...
|---|---:|---:|---:|---:|---:|---|
| **second@example.com** | 24,812,094,399 | 58.1% | 5 | 16,583 | 157,328 | ████████████████············ |
| **third@example.com** | 13,672,715,264 | 32.0% | 3 | 63 | 45,088 | █████████··················· |
| **owner@example.com** | 2,835,737,509 | 6.6% | 3 | 75 | 11,912 | ██·························· |
...
|---|---:|---:|---|
| **second@example.com** | 27,409,719,148 | 16,621 | claude 24.78B, gemini 2.60B _file_, claude → DeepSeek 36.16M |
| **third@example.com** | 13,752,720,364 | 58 | claude 13.75B |
| **owner@example.com** | 2,837,977,700 | 75 | claude 2.84B |
| **fourth@example.com** | 76,724,862 | 5 | grok 76.72M _owner_ |
| **All attributed** | **44,077,142,074** | | |
...
|---|---|---|---|---|---|---|
| second@example.com | 17.48B | 5.55B | 1.51B | 266.15M | 2.13M | **24,812,094,399** |
| third@example.com | 10.44B | 3.21B | 26.78M | — | — | **13,672,715,264** |
| owner@example.com | 571.75M | 83.21M | 2.18B | — | — | **2,835,737,509** |
...
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **28.49B** | **10.25B** | **3.73B** | **266.15M** | **2.13M** | **42,738,054,280** |

---

## second@example.com

**24,812,094,399 tokens** (58.1%) · 16,583 sessions · 157,328 turns · 61 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 17,484,791,342 | 70.5% |
...
|---:|---:|---:|---:|
| 335,499,696 | 1,076,062,437 | 23,292,380,692 | 108,151,574 |
...
**13,672,715,264 tokens** (32.0%) · 63 sessions · 45,088 turns · 40 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 10,435,790,468 | 76.3% |
| HP Laptop Linux | 3,210,148,732 | 23.5% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 13,672,715,264 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,244,905 |
| `claude-opus-5` | 3,982,930,783 |
| `claude-fable-5` | 1,151,574,924 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,666,545 | 495,570,420 | 13,122,966,693 | 49,511,606 |
...
**2,835,737,509 tokens** (6.6%) · 75 sessions · 11,912 turns · 31 active days
