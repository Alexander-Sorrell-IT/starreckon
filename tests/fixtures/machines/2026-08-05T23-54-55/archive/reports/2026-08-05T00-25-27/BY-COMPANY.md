...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 41,292,102,264 | 96.6% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,454 | 661h 57m | 41,816,464,213 | claude 41.37B, copilot 442.12M |
...
**41,292,102,264 tokens** (96.6% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 17,494,721,474 |
| `claude-opus-5` | 14,534,993,805 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,250,311,521 |
...
| Account | Tokens |
|---|---:|
| second@example.com | 24,775,930,006 |
| third@example.com | 13,672,715,264 |
| owner@example.com | 2,835,737,509 |
