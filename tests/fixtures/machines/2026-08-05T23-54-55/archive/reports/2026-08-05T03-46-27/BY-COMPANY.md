...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 42,216,224,207 | 96.7% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,454 | 663h 44m | 41,922,696,713 | claude 41.48B, copilot 442.12M |
...
**42,216,224,207 tokens** (96.7% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 18,220,180,407 |
| `claude-opus-5` | 14,565,722,150 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,413,747,115 |
...
| third@example.com | 13,778,947,764 |
