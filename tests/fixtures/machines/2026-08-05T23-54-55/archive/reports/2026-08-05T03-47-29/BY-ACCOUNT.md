...
|---|---:|---:|---:|---:|---:|---|
| **second@example.com** | 25,629,983,842 | 58.7% | 5 | 19,189 | 165,426 | ████████████████············ |
| **third@example.com** | 13,778,947,764 | 31.6% | 3 | 63 | 45,571 | █████████··················· |
| **owner@example.com** | 2,835,737,509 | 6.5% | 3 | 75 | 11,912 | ██·························· |
...
|---|---|---|---|---|---|---|
| second@example.com | 17.48B | 6.37B | 1.51B | 266.15M | 2.13M | **25,629,983,842** |
| third@example.com | 10.44B | 3.32B | 26.78M | — | — | **13,778,947,764** |
...
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **28.49B** | **11.18B** | **3.73B** | **266.15M** | **2.13M** | **43,662,176,223** |

---

## second@example.com

**25,629,983,842 tokens** (58.7%) · 19,189 sessions · 165,426 turns · 66 active days
...
**13,778,947,764 tokens** (31.6%) · 63 sessions · 45,571 turns · 40 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 10,435,790,468 | 75.7% |
| HP Laptop Linux | 3,316,381,232 | 24.1% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 13,778,947,764 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,244,905 |
| `claude-opus-5` | 4,013,659,128 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,667,440 | 500,211,959 | 13,224,043,685 | 50,024,680 |
...
**2,835,737,509 tokens** (6.5%) · 75 sessions · 11,912 turns · 31 active days
