...
|---|---:|---:|---:|---:|---:|---|
| **second@example.com** | 25,630,284,187 | 58.6% | 5 | 19,189 | 165,427 | ████████████████············ |
| **third@example.com** | 13,836,657,412 | 31.6% | 3 | 63 | 45,726 | █████████··················· |
...
|---|---|---|---|---|---|---|
| second@example.com | 17.48B | 6.37B | 1.51B | 266.15M | 2.13M | **25,630,284,187** |
| third@example.com | 10.44B | 3.37B | 26.78M | — | — | **13,836,657,412** |
...
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **28.49B** | **11.23B** | **3.73B** | **266.15M** | **2.13M** | **43,720,186,216** |

---

## second@example.com

**25,630,284,187 tokens** (58.6%) · 19,189 sessions · 165,427 turns · 66 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 17,484,791,342 | 68.2% |
| HP Laptop Linux | 6,365,868,577 | 24.8% |
...
| Company | Tokens |
|---|---:|
| Anthropic | 25,594,119,794 |
| DeepSeek | 36,164,393 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 10,105,282,049 |
...
|---:|---:|---:|---:|
| 338,161,483 | 1,132,867,252 | 24,046,722,555 | 112,532,897 |
...
**13,836,657,412 tokens** (31.6%) · 63 sessions · 45,726 turns · 40 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 10,435,790,468 | 75.4% |
| HP Laptop Linux | 3,374,090,880 | 24.4% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 13,836,657,412 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,244,905 |
| `claude-opus-5` | 4,044,391,739 |
| `claude-fable-5` | 1,254,056,116 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,667,727 | 500,503,784 | 13,281,317,112 | 50,168,789 |
