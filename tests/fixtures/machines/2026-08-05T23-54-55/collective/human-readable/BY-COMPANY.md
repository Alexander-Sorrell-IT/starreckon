...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 42,539,966,760 | 96.7% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,476 | 680h 30m | 43,064,328,709 | claude 42.62B, copilot 442.12M |
...
**42,539,966,760 tokens** (96.7% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 18,220,180,407 |
| `claude-opus-5` | 14,861,035,048 |
...
| HP Laptop Linux | 10,053,177,926 |
...
| third@example.com | 14,102,690,317 |
