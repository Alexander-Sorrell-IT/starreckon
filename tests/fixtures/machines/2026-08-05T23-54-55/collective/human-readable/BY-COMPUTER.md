...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 3 | 28,492,335,565 | 64.8% | 2026-08-04 20:44:23 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,499,129,942 | 26.1% | 2026-08-05 23:39:34 |
...
```
Claude Code, per account (totals.json)  :   43,985,918,776
Claude Code, per session (sessions.json):   44,068,164,067
...
`macbook-air-m1/` · 3 account(s) · 53 sessions · 132,114 turns · **28,492,335,565 tokens** (64.8% of all Claude Code)
...
scanned **2026-08-05 23:39:34** · sessions 2026-08-05 23:39:58

`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,249 turns · **11,499,129,942 tokens** (26.1% of all Claude Code)
...
| Account | Tokens | Share of machine |
|---|---:|---:|
| broodierchip@gmail.com | 6,365,568,232 | 55.4% |
| codehunterextreme@gmail.com | 3,640,123,785 | 31.7% |
| DeepSeek backend (~/.my-claude) | 1,409,787,623 | 12.3% |
...
| Company | Tokens | Share |
|---|---:|---:|
| Anthropic | 10,053,177,926 | 87.4% |
| DeepSeek | 1,445,952,016 | 12.6% |
| — (no API call) | 0 | 0.0% |
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 155 | 250h 42m | 11,499,129,942 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 155 | 11,499,129,942 | 2026-05-04 → 2026-08-06 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 51,133,898,746 of the 51,134,071,679 total was billed to someone.

---

## The floor: the most defensible figure per machine

**117,408,113,605 tokens across 5 scanned computer(s).**
...
| HP Laptop Linux | 30,380,457,963 | 1,799,769,968 | **32,180,227,931** | 13,298,899,910 |
...
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 2,873,374,359 | 14,314,292,702 |
...
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 3,640,123,785 |
...
| HP Laptop Linux | 10.05B | 1.45B | **11,499,129,942** |
...
| **All** | **42.54B** | **1.45B** | **43,985,918,776** |
...
| HP Laptop Linux | 11.50B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **13,298,899,910** |
| MacBook Air M1 | 28.57B | 995.36M | 1.63B | 497.70M | 135.11M | 76.72M | — | 53.16K | **31,910,491,627** |
| **All** | **44.07B** | **2.60B** | **2.31B** | **1.86B** | **215.30M** | **76.72M** | **7.07M** | **172.93K** | **51,134,071,679** |

---

## Sessions

17,116 sessions · 1,108h 36m active · 51,134,071,679 tokens
...
| 2026-07-30 | HP Laptop Linux | claude | 17h 40m | 1,460,870,150 | 4,323 | `claude-opus-5` |
...
| 2026-07-30 | 1,463,932,879 | 18h 01m |
