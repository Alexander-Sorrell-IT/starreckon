...
_Generated 2026-08-05T00:24:51-05:00_

## Total for this computer: 3,726,175,980 tokens (3.73B)

Across 5 account(s), 16,515 sessions, 41,509 assistant turns.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| alexander.sorrell.it@gmail.com | 70 | 8,697 | 479.83K | 94.68M | 2.07B | 12.28M | **2.18B** |
...
**Anthropic-only total: 3,726,175,980 tokens (3.73B)**
...
**2,180,771,071 tokens** (2.18B) — `/home/phantom-orchestrator/.claude-it`
...
| claude-opus-5 | 447.08M |
| claude-opus-4-7 | 17.48M |
| <synthetic> | 0 |

Active 2026-07-04 → 2026-08-05 (25 days). Busiest day 2026-07-23 at 278.30M.

| Project | Total |
|---|---:|
| `-home-phantom-orchestrator` | 1.36B |
