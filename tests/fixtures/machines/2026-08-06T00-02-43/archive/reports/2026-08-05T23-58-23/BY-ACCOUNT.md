...
|---|---:|---:|---:|---:|---:|---|
| **second@example.com** | 25,629,983,842 | 58.2% | 5 | 19,189 | 165,426 | ████████████████············ |
| **third@example.com** | 14,159,376,532 | 32.1% | 3 | 63 | 46,320 | █████████··················· |
| **owner@example.com** | 2,835,737,509 | 6.4% | 3 | 75 | 11,912 | ██·························· |
...
|---|---:|---:|---|
| **second@example.com** | 28,227,608,591 | 16,643 | claude 25.59B, gemini 2.60B _file_, claude → DeepSeek 36.16M |
| **third@example.com** | 14,239,381,632 | 58 | claude 14.24B |
| **owner@example.com** | 2,837,977,700 | 75 | claude 2.84B |
| **fourth@example.com** | 76,724,862 | 5 | grok 76.72M _owner_ |
| **All attributed** | **45,381,692,785** | | |
...
| third@example.com | 10.44B | 3.70B | 26.78M | — | — | **14,159,376,532** |
...
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **28.49B** | **11.56B** | **3.73B** | **266.15M** | **2.13M** | **44,042,604,991** |

---

## second@example.com

**25,629,983,842 tokens** (58.2%) · 19,189 sessions · 165,426 turns · 66 active days
...
**14,159,376,532 tokens** (32.1%) · 63 sessions · 46,320 turns · 41 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 10,435,790,468 | 73.7% |
| HP Laptop Linux | 3,696,810,000 | 26.1% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 14,159,376,532 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,536,244,905 |
| `claude-opus-5` | 4,365,658,241 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 4,668,754 | 506,643,726 | 13,597,264,322 | 50,799,730 |
