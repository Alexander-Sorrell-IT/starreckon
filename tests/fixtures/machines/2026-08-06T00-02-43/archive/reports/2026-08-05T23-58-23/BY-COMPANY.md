...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 42,596,652,975 | 96.7% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,476 | 680h 48m | 43,121,014,924 | claude 42.68B, copilot 442.12M |
...
**42,596,652,975 tokens** (96.7% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 18,220,180,407 |
| `claude-opus-5` | 14,917,721,263 |
| `claude-opus-4-7` | 5,747,588,911 |
| `claude-fable-5` | 3,442,176,770 |
...
| HP Laptop Linux | 10,109,864,141 |
...
| Account | Tokens |
|---|---:|
| second@example.com | 25,593,819,449 |
| third@example.com | 14,159,376,532 |
