...
_Generated 2026-08-06T00:50:55-05:00 by `stats_page.py`. Do not edit by hand._

**11,842,972,213** tokens of Claude Code across 2 scanned computer(s) · **13,651,322,625** across every CLI on the 2 that ran `sessions.py`.
...
_scans taken 2026-08-06 00:06:37 .. 2026-08-06 00:50:35_
...
|---|---|---:|---:|---:|---|
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,576,825,537 | 97.8% | 2026-08-06 00:06:37 |
| **ASUS Laptop Linux** | `asus-laptop-linux/` | 1 | 266,146,676 | 2.2% | 2026-08-06 00:50:35 |
| **All** | | | **11,842,972,213** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   11,842,972,213
Claude Code, per session (sessions.json):   11,842,972,213
difference                              :               +0
non-Claude-Code CLIs, additional        :    1,808,350,412
```
...
`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,349 turns · **11,576,825,537 tokens** (97.8% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 13,651,202,851 of the 13,651,322,625 total was billed to someone.

---

## The floor: the most defensible figure per machine

**32,681,034,520 tokens across 2 scanned computer(s).**
...
**575 Claude Code sessions have existed across the scanned machines. 460 of them — 80% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| second@example.com | 320 | 275 | 2026-01-14 → 2026-07-06 |
...
| **All** | **10.40B** | **1.45B** | **11,842,972,213** |
...
| **All** | **11.84B** | **1.47B** | **295.83M** | **30.00M** | **7.07M** | **2.12M** | **119.77K** | **0** | **13,651,322,625** |

---

## Sessions

300 sessions · 393h 08m active · 13,651,322,625 tokens
...
**The 15 minutes is a judgement call.** On the 300 session(s) measured both ways, counting only gaps under one minute gives **140h 47m** against **393h 08m**. The 252h 22m between is where reading output and walking away look identical. Read it as a range.
