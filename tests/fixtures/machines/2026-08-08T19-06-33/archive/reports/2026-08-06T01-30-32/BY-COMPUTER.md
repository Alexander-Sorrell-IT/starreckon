...
|---|---|---:|---:|---:|---|
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,725,240,493 | 97.8% | 2026-08-06 01:29:54 |
...
```
Claude Code, per account (totals.json)  :   11,993,517,782
Claude Code, per session (sessions.json):   11,993,517,782
difference                              :               +0
...
scanned **2026-08-06 01:29:54** · sessions 2026-08-06 01:30:18

`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,516 turns · **11,725,240,493 tokens** (97.8% of all Claude Code)
...
|---|---:|---:|---:|
| claude | 155 | 251h 57m | 11,725,240,493 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 155 | 11,725,240,493 | 2026-05-04 → 2026-08-06 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 13,811,167,841 of the 13,811,287,615 total was billed to someone.

---

## The floor: the most defensible figure per machine

**32,876,719,550 tokens across 3 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| HP Laptop Linux | 30,606,568,514 | 1,799,769,968 | **32,406,338,482** | 13,525,010,461 |
...
|---|---:|---|---:|---:|
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 2,283,190,813 | 14,573,676,150 |
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 3,098,536,096 | 14,539,454,439 |
...
|---|---|---:|---|---:|
| `.claude` | broodierchip@gmail.com | 12,290,485,337 | 2026-01-14 → 2026-05-17 | 6,366,517,046 |
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 3,865,285,522 |
...
| HP Laptop Linux | 11.73B | 1.47B | 295.83M | 26.93M | 7.07M | 1.45M | 119.77K | — | **13,525,010,461** |
| **All** | **11.99B** | **1.47B** | **295.83M** | **39.02M** | **7.07M** | **2.12M** | **119.77K** | **0** | **13,811,287,615** |

---

## Sessions

308 sessions · 395h 18m active · 13,811,287,615 tokens
...
**The 15 minutes is a judgement call.** On the 308 session(s) measured both ways, counting only gaps under one minute gives **141h 52m** against **395h 18m**. The 253h 26m between is where reading output and walking away look identical. Read it as a range.

### Twenty longest

| When | Computer | CLI | Active | Tokens | Turns | Model |
|---|---|---|---:|---:|---:|---|
| 2026-07-30 | HP Laptop Linux | claude | 18h 55m | 1,686,980,701 | 4,590 | `claude-opus-5` |
...
| 2026-07-30 | 1,686,980,701 | 18h 55m |
