...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 4 | 29,170,327,621 | 70.9% | 2026-08-06 03:30:07 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 9 | 11,725,240,493 | 28.5% | 2026-08-06 01:29:54 |
...
```
Claude Code, per account (totals.json)  :   41,163,845,403
Claude Code, per session (sessions.json):   41,166,300,771
difference                              :       -2,455,368
non-Claude-Code CLIs, additional        :    5,169,806,179
```

**These should agree and differ by 2,455,368.** The usual innocent cause is a session still being written during the scan; anything larger is a bug worth finding before quoting these.
...
`macbook-air-m1/` · 4 account(s) · 2,180 sessions · 134,345 turns · **29,170,327,621 tokens** (70.9% of all Claude Code)
...
`hp-laptop-linux/` · 9 account(s) · 2,739 sessions · 63,516 turns · **11,725,240,493 tokens** (28.5% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 46,335,934,017 of the 46,336,106,950 total was billed to someone.

---

## The floor: the most defensible figure per machine

**88,158,691,581 tokens across 4 scanned computer(s).**
...
**812 Claude Code sessions have existed across the scanned machines. 643 of them — 79% — no longer have a transcript on disk.**
...
|---|---:|---:|---|
| second@example.com | 494 | 413 | 2026-01-14 → 2026-08-06 |
| third@example.com | 277 | 213 | 2026-02-11 → 2026-08-06 |
| user:73ae64bf180b | 31 | 14 | 2026-05-12 → 2026-07-18 |
| owner@example.com | 9 | 3 | 2026-06-09 → 2026-08-06 |
...
| **All** | **39.72B** | **1.45B** | **41,163,845,403** |
...
| HP Laptop Linux | 11.73B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **13,525,010,461** |
| MacBook Air M1 | 29.17B | 995.36M | 1.63B | 497.70M | 135.11M | 90.21M | — | 53.16K | **32,524,819,335** |
| **All** | **41.17B** | **2.47B** | **1.64B** | **793.53M** | **174.13M** | **90.21M** | **7.07M** | **172.93K** | **46,336,106,950** |

---

## Sessions

572 sessions · 942h 54m active · 46,336,106,950 tokens
...
**The 15 minutes is a judgement call.** On the 572 session(s) measured both ways, counting only gaps under one minute gives **379h 23m** against **942h 54m**. The 563h 31m between is where reading output and walking away look identical. Read it as a range.
...
| 2026-07-05 | 4,205,832,981 | 67h 18m |
...
| 2026-07-30 | 1,690,444,358 | 19h 16m |
| 2026-08-04 | 1,660,310,846 | 28h 04m |
