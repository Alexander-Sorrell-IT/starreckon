...
| unknown (.my-claude) | — | — | — | — | — | **0** |
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **29.17B** | **14.29B** | **5.32B** | **266.15M** | **2.13M** | **49,054,249,323** |
...
| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 11,040,991,167 | 64.6% |
| HP Laptop Linux | 6,034,535,356 | 35.3% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 17,102,302,587 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,160,200,883 |
| `claude-opus-5` | 7,633,082,540 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 3,265,053 | 589,617,152 | 16,452,290,751 | 57,129,631 |
...
**14,291,033,857 tokens** across 9 login(s)
