...
_Generated 2026-08-08T04:17:26-05:00 by `stats_page.py`. Do not edit by hand._

**49,054,249,323** tokens of Claude Code across 5 scanned computer(s) · **56,336,211,504** across every CLI on the 5 that ran `sessions.py`.
...
_scans taken 2026-08-06 00:50:35 .. 2026-08-08 04:16:55_
...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 4 | 29,170,327,621 | 59.5% | 2026-08-06 03:30:07 |
| **HP Laptop Linux** | `hp-laptop-linux/` | 14 | 14,291,033,857 | 29.1% | 2026-08-08 04:16:55 |
| **Dell Latitude 7480 Linux** | `dell-latitude-7480-linux/` | 6 | 5,324,610,556 | 10.9% | 2026-08-06 06:17:15 |
...
| **All** | | | **49,054,249,323** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   49,054,249,323
Claude Code, per session (sessions.json):   49,056,919,819
...
`macbook-air-m1/` · 4 account(s) · 2,180 sessions · 134,345 turns · **29,170,327,621 tokens** (59.5% of all Claude Code)
...
scanned **2026-08-08 04:16:55** · sessions 2026-08-08 04:17:23

`hp-laptop-linux/` · 14 account(s) · 2,846 sessions · 78,433 turns · **14,291,033,857 tokens** (29.1% of all Claude Code)
...
| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 162 | 275h 00m | 14,291,033,857 |
...
| Tool | Kind | Counted | Sessions | Tokens | Usage |
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 162 | 14,291,033,857 | 2026-05-04 → 2026-08-08 |
...
`dell-latitude-7480-linux/` · 6 account(s) · 16,549 sessions · 61,252 turns · **5,324,610,556 tokens** (10.9% of all Claude Code)
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 56,336,038,571 of the 56,336,211,504 total was billed to someone.

---

## The floor: the most defensible figure per machine

**121,652,183,962 tokens across 5 scanned computer(s).**
...
| HP Laptop Linux | 33,569,854,222 | 1,799,769,968 | **35,369,624,190** | 16,090,803,825 |
...
| Account | Counter | Counter ends | Transcripts after | Floor |
|---|---:|---|---:|---:|
| codehunterextreme@gmail.com | 11,440,918,343 | 2026-07-11 | 5,665,278,274 | 17,106,196,617 |
| broodierchip@gmail.com | 12,290,485,337 | 2026-05-17 | 2,679,734,343 | 14,970,219,680 |
...
| `.claude` | broodierchip@gmail.com | 12,290,485,337 | 2026-01-14 → 2026-05-17 | 6,763,060,576 |
| `.claude-alt` | codehunterextreme@gmail.com | 11,440,918,343 | 2026-06-09 → 2026-07-11 | 6,034,535,356 |
...
| HP Laptop Linux | 12.85B | 1.45B | **14,291,033,857** |
...
| **All** | **47.61B** | **1.45B** | **49,054,249,323** |
...
| HP Laptop Linux | 14.29B | 1.47B | 1.45M | 295.83M | 26.93M | — | 7.07M | 119.77K | **16,090,803,825** |
| MacBook Air M1 | 29.17B | 995.36M | 1.63B | 497.70M | 135.11M | 90.21M | — | 53.16K | **32,524,819,335** |
| **All** | **49.06B** | **2.79B** | **2.31B** | **1.86B** | **222.72M** | **90.21M** | **7.07M** | **172.93K** | **56,336,211,504** |

---

## Sessions

17,194 sessions · 1,257h 52m active · 56,336,211,504 tokens
...
**The 15 minutes is a judgement call.** On the 17,194 session(s) measured both ways, counting only gaps under one minute gives **516h 06m** against **1,257h 52m**. The 741h 45m between is where reading output and walking away look identical. Read it as a range.
...
| 2026-07-30 | HP Laptop Linux | claude | 35h 36m | 3,853,828,024 | 16,481 | `claude-opus-5` |
...
| 2026-07-30 | 3,857,291,681 | 35h 58m |
