...
| **codehunterextreme@gmail.com** | 17,185,781,419 | 35.0% | 3 | 2,176 | 58,651 | ██████████·················· |
...
| codehunterextreme@gmail.com | 11.04B | 6.12B | 26.78M | — | — | **17,185,781,419** |
...
| unknown (.my-claude) | — | — | — | — | — | **0** |
| user:283b8e5b8e48 | — | — | — | — | — | **0** |
| **All** | **29.17B** | **14.37B** | **5.32B** | **266.15M** | **2.13M** | **49,137,728,155** |
...
**17,185,781,419 tokens** (35.0%) · 2,176 sessions · 58,651 turns · 35 active days

| Computer | Tokens | Share of this account |
|---|---:|---:|
| MacBook Air M1 | 11,040,991,167 | 64.2% |
| HP Laptop Linux | 6,118,014,188 | 35.6% |
| Dell Latitude 7480 Linux | 26,776,064 | 0.2% |

| Company | Tokens |
|---|---:|
| Anthropic | 17,185,781,419 |
| — (no API call) | 0 |

| Model | Tokens |
|---|---:|
| `claude-opus-4-8` | 8,160,200,883 |
| `claude-opus-5` | 7,716,561,372 |
...
| Input | Cache write | Cache read | Output |
|---:|---:|---:|---:|
| 3,265,254 | 589,808,171 | 16,535,454,262 | 57,253,732 |
...
**14,374,512,689 tokens** across 9 login(s)

| Account | Tokens | Share |
|---|---:|---:|
| broodierchip@gmail.com | 6,763,060,576 |  47.0% |
| codehunterextreme@gmail.com | 6,118,014,188 |  42.6% |
