...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 47,772,296,032 | 97.1% | ███████████████████████████· |
...
|---|---:|---:|---:|---|
| Anthropic | 13,527 | 812h 43m | 48,217,083,186 | claude 47.77B, copilot 442.12M |
...
**47,772,296,032 tokens** (97.1% of all Claude Code)

| Model | Tokens |
|---|---:|
| `claude-opus-5` | 18,420,342,855 |
...
| HP Laptop Linux | 13,009,080,566 |
...
| third@example.com | 17,266,301,312 |
...
**14,455,032,582 tokens** from 3 company(s)
