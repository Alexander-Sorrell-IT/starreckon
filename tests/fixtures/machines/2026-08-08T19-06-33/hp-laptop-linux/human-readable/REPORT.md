...
| Project | Total |
|---|---:|
| `-media-testuser-AI-DRIVE-AI-Shit-mining-Quest-coder-Claude-Code` | 2.30B |
...
**936,209 tokens** (936.21K) — `/home/testuser/.ai-logs-archive/claude/.claude-alt`
...
| Project | Total |
|---|---:|
| `-media-testuser-AI-DRIVE-AI-Shit-mining-Quest-coder-Claude-Code` | 936.21K |
