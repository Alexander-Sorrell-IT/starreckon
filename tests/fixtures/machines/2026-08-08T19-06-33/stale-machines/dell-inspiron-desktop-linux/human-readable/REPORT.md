...
_Generated 2026-08-06T01:00:55-05:00_

## Total for this computer: 2,130,613 tokens (2.13M)

Across 1 account(s), 1 sessions, 68 assistant turns.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| second@example.com | 1 | 68 | 15.20K | 476.57K | 1.64M | 252 | **2.13M** |
...
**Anthropic-only total: 2,130,613 tokens (2.13M)**
...
|---|---|---:|---|
| Gemini CLI | `/home/phantom-gramps/.gemini` | 44 | **no — not countable** |
...
**2,130,613 tokens** (2.13M) — `/home/phantom-gramps/.claude`
...
|---|---:|---:|---:|
| main | 1 | 0 | 0% |
| subagent | 2 | 2.13M | 100% |

| Model | Total |
|---|---:|
| claude-haiku-4-5-20251001 | 2.13M |
| <synthetic> | 0 |

Active 2026-01-21 → 2026-08-04 (2 days). Busiest day 2026-01-21 at 2.13M.

| Project | Total |
|---|---:|
| `-media-phantom-gramps-2TB-Storage-VS-code-projects-custom-wifi-router-mesh-The-Un-Ending` | 2.13M |
| `-home-phantom-gramps` | 0 |
