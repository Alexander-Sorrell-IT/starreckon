...
|---|---|---:|---:|---|
| **Anthropic** | `anthropic` | 6,199,629,801 | 92.1% | ██████████████████████████·· |
...
|---|---:|---:|---:|---|
| Anthropic | 112 | 205h 17m | 6,200,446,123 | claude 6.20B |
...
| — (no API call) | 8 | 21h 15m | 5,989,247 | copilot 5.94M, claude 49.99K |
...
**6,199,629,801 tokens** (92.1% of all Claude Code)
...
| `claude-haiku-4-5-20251001` | 6,285,477 |
...
| second@example.com | 2,570,784,490 |
