...
_Generated 2026-08-09T00:54:52-05:00 by `stats_page.py`. Do not edit by hand._

**6,734,300,954** tokens of Claude Code across 1 scanned computer(s) · **8,534,937,239** across every CLI on the 1 that ran `sessions.py`.
...
_scans taken 2026-08-09 00:54:17_
...
| **All** | | | **6,734,300,954** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :    6,734,300,954
Claude Code, per session (sessions.json):    6,735,167,271
difference                              :         -866,317
non-Claude-Code CLIs, additional        :    1,799,769,968
```
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 8,534,817,465 of the 8,534,937,239 total was billed to someone.

---

## The floor: the most defensible figure per machine

**30,077,288,067 tokens across 1 scanned computer(s).**
...
**567 Claude Code sessions have existed across the scanned machines. 456 of them — 80% — no longer have a transcript on disk.**
...
| **All** | **6.20B** | **534.67M** | **6,734,300,954** |
...
| **All** | **6.74B** | **1.47B** | **295.83M** | **26.93M** | **7.07M** | **1.45M** | **119.77K** | **0** | **8,534,937,239** |

---

## Sessions

271 sessions · 409h 41m active · 8,534,937,239 tokens
...
**The 15 minutes is a judgement call.** On the 271 session(s) measured both ways, counting only gaps under one minute gives **153h 36m** against **409h 41m**. The 256h 05m between is where reading output and walking away look identical. Read it as a range.
