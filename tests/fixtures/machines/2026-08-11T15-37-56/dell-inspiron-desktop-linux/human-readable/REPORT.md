# Claude Code token usage — Dell Inspiron Desktop Linux

_Generated 2026-08-09T02:26:58-05:00_

## Total for this computer: 824,886 tokens (824.89K)

Across 2 account(s), 2 sessions, 26 assistant turns.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| second@example.com | 1 | 26 | 3.81K | 148.54K | 672.38K | 145 | **824.89K** |
| unknown (claude) | 1 | 0 | 0 | 0 | 0 | 0 | **0** |
...
**Anthropic-only total: 824,886 tokens (824.89K)**
...
|---|---|---:|---|
| Gemini CLI | `/home/phantom-gramps/.gemini` | 48 | **no — not countable** |
| GitHub Copilot CLI | `/home/phantom-gramps/.copilot` | 132 | **no — not countable** |
...
**824,886 tokens** (824.89K) — `/home/phantom-gramps/.claude`

userID `c27b4a9d126ec2d32ffc8f20d6ec0ee4496d81705319298a5d7361b510c1c9c8`

| Transcript | Files | Tokens | Share |
|---|---:|---:|---:|
| subagent | 2 | 824.89K | 100% |

| Model | Total |
|---|---:|
| claude-haiku-4-5-20251001 | 824.89K |

Active 2026-01-21 → 2026-01-21 (1 days). Busiest day 2026-01-21 at 824.89K.

| Project | Total |
|---|---:|
| `-media-phantom-gramps-2TB-Storage-VS-code-projects-custom-wifi-router-mesh-The-Un-Ending` | 824.89K |

### unknown (claude)

**0 tokens** (0) — `/home/phantom-gramps/.ai-logs-archive/claude/claude`
