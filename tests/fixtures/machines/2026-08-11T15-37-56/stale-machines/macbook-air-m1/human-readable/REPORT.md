...
|---|---:|---:|---:|---:|---:|---:|---:|
| broodierchip@gmail.com | 31 | 46,646 | 3.71M | 253.18M | 8.13B | 47.91M | **8.43B** |
| codehunterextreme@gmail.com | 24 | 12,911 | 433.65K | 159.14M | 5.09B | 15.80M | **5.27B** |
...
| codehunterextreme@gmail.com | 2,126 | 0 | 0 | 0 | 0 | 0 | **0** |
...
**8,431,493,209 tokens** (8.43B) — `/Users/broodierchip-m1air/.claude-main`
...
| Project | Total |
|---|---:|
| `-Users-broodierchip-m1air` | 6.79B |
| `-Users-broodierchip-m1air-Desktop-vulcan-delta-tests` | 1.64B |

### codehunterextreme@gmail.com

**5,269,752,187 tokens** (5.27B) — `/Users/broodierchip-m1air/.claude`
...
| Project | Total |
|---|---:|
| `-Users-broodierchip-m1air` | 5.23B |
...
**6,062,632 tokens** (6.06M) — `/Users/broodierchip-m1air/.ai-logs-archive/claude/Documents`
...
**3,952,282 tokens** (3.95M) — `/Users/broodierchip-m1air/.ai-logs-archive/claude/Desktop_standout_sandbox_.claude`
...
**113,746 tokens** (113.75K) — `/Users/broodierchip-m1air/.ai-logs-archive/claude/claude-main`
...
| Project | Total |
|---|---:|
| `-Users-broodierchip-m1air` | 113.75K |
...
**0 tokens** (0) — `/Users/broodierchip-m1air/Desktop/standout_sandbox/.claude`
