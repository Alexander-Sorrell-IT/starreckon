...
|---|---|---:|---:|---:|---|
| **MacBook Air M1** | `macbook-air-m1/` | 8 | 14,766,838,204 | 100.0% | 2026-08-11 15:39:21 |
| **All** | | | **14,766,838,204** | 100% | |

### The two scopes, reconciled

```
Claude Code, per account (totals.json)  :   14,766,838,204
Claude Code, per session (sessions.json):   15,941,263,181
difference                              :   -1,174,424,977
non-Claude-Code CLIs, additional        :    3,360,889,901
```
...
scanned **2026-08-11 15:39:21** · sessions 2026-08-11 16:04:12

`macbook-air-m1/` · 8 account(s) · 4,481 sessions · 64,598 turns · **14,766,838,204 tokens** (100.0% of all Claude Code)
...
|---|---:|---:|
| Anthropic | 14,766,838,204 | 100.0% |

### CLIs on this computer

| CLI | Sessions | Active | Tokens |
|---|---:|---:|---:|
| claude | 82 | 478h 13m | 15,941,263,181 |
...
|---|---|---|---:|---:|---|
| Claude Code | cli | yes | 63 | 14,766,838,204 | 2026-05-26 → 2026-08-11 |
...
Every figure elsewhere includes these. To read spend rather than volume, subtract them: 19,302,099,923 of the 19,302,153,082 total was billed to someone.

---

## The floor: the most defensible figure per machine

**48,838,209,954 tokens across 1 scanned computer(s).**
...
|---|---:|---:|---:|---:|
| MacBook Air M1 | 45,477,320,053 | 3,360,889,901 | **48,838,209,954** | 19,302,153,082 |
| **All** | | | **48,838,209,954** | |
...
|---|---|---|
| MacBook Air M1 | 14.77B | **14,766,838,204** |
| **All** | **14.77B** | **14,766,838,204** |

### Computer x CLI

| Computer | claude | codex | gemini | copilot | antigravity | grok | lmstudio | kilocode | clawspring | copilot-chat | claude-orphans | Total |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| MacBook Air M1 | 15.94B | 1.63B | 995.36M | 497.70M | 135.11M | 99.06M | 53.16K | — | — | — | — | **19,302,153,082** |
| **All** | **15.94B** | **1.63B** | **995.36M** | **497.70M** | **135.11M** | **99.06M** | **53.16K** | **0** | **0** | **0** | **0** | **19,302,153,082** |

---

## Sessions

292 sessions · 620h 49m active · 19,302,153,082 tokens
...
**The 15 minutes is a judgement call.** On the 292 session(s) measured both ways, counting only gaps under one minute gives **271h 23m** against **620h 49m**. The 349h 26m between is where reading output and walking away look identical. Read it as a range.
...
| 2026-08-08 | MacBook Air M1 | claude | 33h 43m | 1,273,512,147 | 5,818 | `claude-opus-5` |
...
| 2026-08-08 | 1,282,321,391 | 34h 21m |
